...
class ArrayBase {
 public:
  ...
  size_t ndim() const { return ndimen_p; }

  // How many elements does this array have? Product of all axis lengths.
  // <group>
  size_t nelements() const { return nels_p; }
  size_t size() const { return nels_p; }
  // </group>

  // Is the array empty (i.e. no elements)?
  bool empty() const { return nels_p == 0; }
  ...
  const IPosition& steps() const { return steps_p; }
  ...
  static unsigned arrayVersion() { return 3; }
 ...
 protected:
  ...
  bool reformOrResize(const IPosition& newShape, bool resizeIfNeeded, size_t nReferences,
                      long long nElementsAllocated, bool copyDataIfNeeded, size_t resizePercentage);
  ...
  bool conform2(const ArrayBase& other) const { return length_p.isEqual(other.length_p); }
...
// <group>
// # Implemented in Array2.cc.
size_t ArrayIndexOffset(size_t Ndim, const ssize_t* Shape, const ssize_t* Origin,
                        const ssize_t* Inc, const IPosition& Index);
size_t ArrayIndexOffset(size_t Ndim, const ssize_t* Shape, const ssize_t* Inc,
...
inline void checkArrayShapes(const ArrayBase& left, const ArrayBase& right, const char* name) {
