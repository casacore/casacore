...
class Cube : public Array<T> {
 public:
  ...
  T &operator()(size_t i1, size_t i2, size_t i3) { return this->begin_p[index(i1, i2, i3)]; }
  ...
  size_t nplane() const { return this->length_p(2); }
 ...
 private:
  ...
  size_t zinc() const {
    return this->inc_p(2) * this->originalLength_p(0) * this->originalLength_p(1);
  }
  size_t index(size_t i1, size_t i2, size_t i3) const {
    return xinc() * i1 +
           this->originalLength_p(0) *
               (this->inc_p(1) * i2 + this->inc_p(2) * this->originalLength_p(1) * i3);
  }
  size_t index_continuous(size_t i1, size_t i2, size_t i3) const {
    return i1 + this->originalLength_p(0) *
                    (this->inc_p(1) * i2 + this->inc_p(2) * this->originalLength_p(1) * i3);
  }
};
