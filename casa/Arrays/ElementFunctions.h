...
inline bool near(float val1, double val2, double tol) { return near(double(val1), val2, tol); }

inline bool near(double val1, float val2, double tol) { return near(val1, double(val2), tol); }

inline bool near(const std::complex<float> &val1, const std::complex<float> &val2,
                 double tol = 1.0e-5) {
...
inline bool near(const std::complex<double> &val1, const std::complex<double> &val2,
                 double tol = 1.0e-13) {
  if (tol <= 0) return val1 == val2;
  if (val1 == val2) return true;
  if (std::abs(val1) == 0)
...
inline bool nearAbs(const std::complex<float> &val1, const std::complex<float> &val2,
                    double tol = 1.0e-5) {
  return std::abs(val2 - val1) <= tol;
}

inline bool nearAbs(const std::complex<double> &val1, const std::complex<double> &val2,
                    double tol = 1.0e-13) {
  return std::abs(val2 - val1) <= tol;
}
...
inline bool nearAbs(double val1, double val2, double tol) { return (tol >= std::abs(val2 - val1)); }
