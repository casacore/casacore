...
// <reviewed reviewer="UNKNOWN" date="before2004/08/25" tests="tMaskArrMath0 tMaskArrMath1
// tMaskArrMath2 tMaskArrExcp">
//
// <prerequisite>
...
// </motivation>
//
// <linkfrom anchor="MaskedArray mathematical operations" classes="MaskedArray Array Vector Matrix
// Cube">
...
// <group>
template <class T>
inline T madfm(const MaskedArray<T> &a, bool sorted = false) {
...
class MaskedMedianFunc {
 public:
  ...
  T operator()(const MaskedArray<T> &arr) const { return median(arr, itsSorted, itsTakeEvenMean); }
...
Array<T> slidingArrayMath(const MaskedArray<T> &array, const IPosition &halfBoxSize,
                          const FuncType &funcObj, bool fillEdge = true);
