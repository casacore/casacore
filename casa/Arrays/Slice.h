...
inline Slice::Slice(size_t Start, size_t Length, size_t Inc)
...
inline Slice::Slice(size_t Start, size_t End, size_t Inc, bool endIsLength)
...
inline bool Slice::all() const { return incp < 0; }

inline size_t Slice::start() const { return startp; }

inline size_t Slice::length() const { return lengthp; }
