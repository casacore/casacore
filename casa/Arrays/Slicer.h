...
class Slicer {
 public:
  ...
  // <group>
  Slicer(const IPosition& start, const IPosition& end, const IPosition& stride,
  ...
  //   <li> ArraySlicerError
  // </thrown>
  IPosition inferShapeFromSource(const IPosition& shape, IPosition& startResult,
  ...
  // <group>
  void setStart(const IPosition& start) { start_p = start; }
  void setEnd(const IPosition& end) { end_p = end; }
  // </group>
...
inline size_t Slicer::ndim() const { return start_p.nelements(); }

inline const IPosition& Slicer::start() const { return start_p; }

inline const IPosition& Slicer::end() const { return end_p; }

inline const IPosition& Slicer::stride() const { return stride_p; }

inline const IPosition& Slicer::length() const { return len_p; }

inline bool Slicer::isFixed() const { return fixed_p; }
