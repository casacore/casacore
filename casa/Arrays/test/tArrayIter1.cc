...
void checkIter(const Array<int>& array, const IPosition& blc, const IPosition& trc,
               const IPosition& inc) {
  Array<int> a(array);
...
BOOST_AUTO_TEST_CASE(iterate_5d_array) {
...

  {
    ...
    {
      Cube<int> a1 = acube(IPosition(3, 0, 0, 0), IPosition(3, 7, 7, 7), IPosition(3, 2, 2, 2));
      Vector<int> b(4);
      indgen(b, 0, 2);
      int count = 0;
      VectorIterator<int> ai(a1);
    ...
    {
      Cube<int> a1 = acube(IPosition(3, 4, 4, 4), IPosition(3, 11, 11, 11), IPosition(3, 2, 2, 2));
      Vector<int> b(4);
    ...
    {
      Cube<int> a1 = acube(IPosition(3, 4, 4, 4), IPosition(3, 11, 4, 11), IPosition(3, 2, 2, 2));
      Vector<int> b(4);
      indgen(b, 4 * 256 + 4 * 16 + 4, 2);
      VectorIterator<int> ai(a1);
      while (!ai.pastEnd()) {
  ...
  // Now test a 5D array.
  {
    ...
    checkIter(array, IPosition(5, 1, 2, 3, 4, 5), IPosition(5, 5, 7, 9, 11, 13),
    ...
    checkIter(array, IPosition(5, 1, 2, 3, 4, 5), IPosition(5, 5, 7, 9, 11, 13),
              IPosition(5, 2, 1, 3, 1, 2));
    checkIter(array, IPosition(5, 1, 2, 3, 4, 5), IPosition(5, 5, 7, 3, 11, 13),
              IPosition(5, 1, 2, 1, 1, 1));
    checkIter(array, IPosition(5, 1, 2, 3, 4, 5), IPosition(5, 5, 7, 3, 4, 13),
              IPosition(5, 1, 1, 1, 1, 1));
    checkIter(array, IPosition(5, 1, 2, 3, 4, 5), IPosition(5, 5, 7, 3, 11, 5),
              IPosition(5, 1, 1, 1, 1, 1));
    checkIter(array, IPosition(5, 1, 2, 3, 4, 5), IPosition(5, 5, 2, 9, 11, 13),
              IPosition(5, 1, 1, 1, 1, 1));
    checkIter(array, IPosition(5, 5, 2, 3, 4, 5), IPosition(5, 5, 2, 9, 11, 13),
              IPosition(5, 1, 1, 1, 1, 1));
  }
}
