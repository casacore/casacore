...
void testMakeComplex() {
  ...
  IPosition start(3, 0, 1, 2);
  IPosition end(3, 2, 3, 4);
  BOOST_CHECK(allNear(makeComplex(a(start, end), b(start, end)), e(start, end), 1e-13));
}
...
TestBinary(+, testPlusInt, int, int) TestBinary(-, testMinusInt, int,
                                                int) TestBinary(*, testTimesInt, int, int)
    TestBinary(/, testDivideInt, int, int) TestBinary(%, testModuloInt, int, int) TestBinary(
        |, testOrInt, int, int) TestBinary(&, testAndInt, int,
                                           int) TestBinary(^, testXorInt, int,
                                                           int) TestBinary(*, testTimesDComplex,
                                                                           std::complex<double>,
                                                                           std::complex<double>)
        TestBinary(*, testTimesComplex, std::complex<float>, std::complex<float>) TestBinary(
            /, testDivideCF, std::complex<float>,
            float) TestBinary(*, testTimesCF, std::complex<float>,
                              float) TestBinary(/, testDivideCD, std::complex<double>, double)
            TestBinary(*, testTimesCD, std::complex<double>, double) TestUnary(+, testUPlusInt, int) TestUnary(
                -, testUMinusInt,
                int) TestUnary(~, testUNegateInt,
                               int) TestReduce(sum, +=, testSumInt, int)
                TestReduce(product, *=, testProductInt, int) TestMinMax(min, testMinInt, int) TestMinMax(
                    max, testMaxInt,
                    int) TestFunc1(sin, testSinDouble, double,
                                   1e-13) TestFunc1(sinh, testSinhDouble, double, 1e-13)
                    TestFunc1(cos, testCosfloat, float, 1e-6) TestFunc1(
                        cosh, testCoshfloat,
                        float, 1e-6) TestFunc1(square, testSqrDouble, double,
                                               1e-13) TestFunc1(cube, testCubeDouble, double, 1e-13)
                        TestFunc1(sqrt, testSqrtDouble, double, 1e-13) TestFunc1(
                            exp, testExpDouble,
                            double,
                            1e-13) TestFunc1(log, testLogDouble, double,
                                             1e-13) TestFunc1(log10, testLog10Double, double, 1e-13)
                            TestFunc1(sin, testSinComplex, std::complex<float>, 1e-6) TestFunc1(
                                sinh, testSinhComplex,
                                std::complex<float>,
                                1e-6) TestFunc1(cos, testCosComplex, std::complex<double>, 1e-13)
                                TestFunc1(cosh, testCoshComplex, std::complex<double>, 1e-13) TestFunc1(
                                    square,
                                    testSqrComplex,
                                    std::complex<float>,
                                    1e-6) TestFunc1(cube, testCubeComplex, std::complex<float>, 1e-6)
                                    TestFunc1(sqrt, testSqrtComplex, std::complex<float>, 1e-6) TestFunc1(
                                        exp, testExpComplex,
                                        std::complex<float>,
                                        1e-6) TestFunc1(log, testLogComplex, std::complex<float>, 1e-6)
                                        TestFunc1(log10, testLog10Complex, std::complex<float>, 1e-6) TestFunc1(
                                            tan, testTanDouble,
                                            double,
                                            1e-13) TestFunc1(tanh, testTanhDouble, double,
                                                             1e-13) TestFunc1(asin, testAsinDouble, double, 1e-13)
                                            TestFunc1(acos, testAcosDouble, double, 1e-13) TestFunc1(
                                                atan, testAtanDouble,
                                                double,
                                                1e-13) TestFunc1(ceil, testCeilDouble, double,
                                                                 1e-13)
                                                TestFunc1(fabs, testFabsDouble, double, 1e-13) TestFunc1(
                                                    abs, testAbsDouble,
                                                    double,
                                                    1e-13) TestFunc1(floor, testFloorDouble, double,
                                                                     1e-13)
                                                    TestFunc2(atan2, testAtan2Double, double) TestFunc2(
                                                        pow, testPowDouble,
                                                        double) TestFunc2(fmod, testFmodDouble, double)
                                                        TestFunc2(min, testMin2Double, double) TestFunc2(
                                                            max, testMax2Int,
                                                            int) TestComplex(amplitude,
                                                                             abs, testComplexAbs,
                                                                             std::complex<float>,
                                                                             float)
                                                            TestComplex(
