...
BOOST_AUTO_TEST_CASE(test) {
  ...
  BOOST_CHECK(allEQ(exp1, arrayTransformResult(arr1, arr2, std::plus<int>())));
  BOOST_CHECK(allEQ(exp2, arrayTransformResult(arr1, 20, std::plus<int>())));
  BOOST_CHECK(allEQ(exp2, arrayTransformResult(20, arr1, std::plus<int>())));
  BOOST_CHECK(allEQ(expa, arrayTransformResult(arr1, [](int a) { return std::abs(a); })));
  ...
  Slicer slicer(IPosition(3, 1, 2, 3), IPosition(3, 7, 8, 9), IPosition(3, 2), Slicer::endIsLast);
  ...
  BOOST_CHECK(allEQ(exp1sl, arrayTransformResult(arr1sl, arr2sl, std::plus<int>())));
  BOOST_CHECK(allEQ(exp2sl, arrayTransformResult(arr1sl, 20, std::plus<int>())));
  BOOST_CHECK(allEQ(exp2sl, arrayTransformResult(20, arr1sl, std::plus<int>())));
  BOOST_CHECK(allEQ(expasl, arrayTransformResult(arr1sl, [](int a) { return std::abs(a); })));
