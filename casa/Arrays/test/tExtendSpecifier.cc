...
BOOST_AUTO_TEST_CASE(erroneous_constructions) {
  BOOST_CHECK_THROW(ExtendSpecifier(IPosition(1, 1), IPosition(1, 1), IPosition(), IPosition()),
                    std::runtime_error);
  BOOST_CHECK_THROW(ExtendSpecifier(IPosition(1, 1), IPosition(1, 1), IPosition(), IPosition(1, 0)),
                    std::runtime_error);
  BOOST_CHECK_THROW(
      ExtendSpecifier(IPosition(2, 2, 1), IPosition(2, 1, 1), IPosition(), IPosition(1, 0)),
      std::runtime_error);
  BOOST_CHECK_THROW(
      ExtendSpecifier(IPosition(2, 1, 2), IPosition(2, 2, 3), IPosition(), IPosition(1, 0)),
      std::runtime_error);
  BOOST_CHECK_THROW(
      ExtendSpecifier(IPosition(2, 1, 2), IPosition(2, 2, 2), IPosition(), IPosition(2, 0, 0)),
      std::runtime_error);
  BOOST_CHECK_THROW(ExtendSpecifier spec(IPosition(2, 1, 2), IPosition(2, 2, 2), IPosition(1, 0),
                                         IPosition(1, 0)),
                    std::runtime_error);
  BOOST_CHECK_THROW(
      ExtendSpecifier spec(IPosition(2, 1, 2), IPosition(2, 2, 2), IPosition(1, 0), IPosition()),
      std::runtime_error);
  BOOST_CHECK_THROW(
      ExtendSpecifier spec(IPosition(2, 1, 2), IPosition(2, 2, 2), IPosition(), IPosition(1, -1)),
      std::runtime_error);
  BOOST_CHECK_THROW(
      ExtendSpecifier spec(IPosition(2, 1, 2), IPosition(2, 2, 2), IPosition(), IPosition(1, 2)),
      std::runtime_error);
}
