...
BOOST_AUTO_TEST_CASE(all) {
  ...
  BOOST_CHECK(allEQ(foo_float3, crossProduct(foo_float1, foo_float2)));
  ...
  BOOST_CHECK(allEQ(foo_double3, crossProduct(foo_double1, foo_double2)));
  ...
  BOOST_CHECK(allEQ(foo_double3, product(Foo_double, foo_double1)));
  ...
  BOOST_CHECK(allEQ(foo_Complex3, crossProduct(foo_Complex1, foo_Complex2)));
  ...
  BOOST_CHECK(allEQ(Foo_Complex, conj(transpose(Foo_Complex_bar))));
  ...
  BOOST_CHECK(allEQ(foo_Complex3, product(Foo_Complex, foo_Complex1)));
  ...
  BOOST_CHECK(allEQ(foo_DComplex3, crossProduct(foo_DComplex1, foo_DComplex2)));
  ...
  BOOST_CHECK(allEQ(Foo_DComplex, conj(transpose(Foo_DComplex_bar))));
  ...
  BOOST_CHECK(allEQ(foo_DComplex3, product(Foo_DComplex, foo_DComplex1)));
