...
BOOST_AUTO_TEST_CASE(test) {
  ...
  Vector<float> ref{0,    1,    2,    3,    3,    1.01, 1.01, 2.01, 3.01, 3.01, 1.02, 1.02, 2.02,
                    3.02, 3.02, 1.03, 1.03, 2.03, 3.03, 3.03, 1.04, 1.04, 2.04, 3.04, 3.04, 1.05,
                    1.05, 2.05, 3.05, 3.05, 1.06, 1.06, 2.06, 3.06, 3.06, 1.07, 1.07, 2.07, 3.07,
                    3.07, 1.08, 1.08, 2.08, 3.08, 3.08, 1.09, 1.09, 2.09, 3.09, 0};
