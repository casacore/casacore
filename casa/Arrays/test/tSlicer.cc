...
BOOST_FIXTURE_TEST_CASE(define, Fixture) {
  ...
  Slicer ns1(IPosition(2, 3, 5), IPosition(2, 13, 21), Slicer::endIsLast);
  check(ns1.inferShapeFromSource(shape, blc, trc, inc), {11, 17});
  check(blc, {3, 5});
  check(trc, {13, 21});
  check(inc, {1, 1});

  Slicer ns2(IPosition(2, 3, 5), IPosition(2, 13, 21), IPosition(2, 3, 2), Slicer::endIsLast);
...
BOOST_FIXTURE_TEST_CASE(undetermined_blc_trc, Fixture) {
  ...
  Slicer ns21(IPosition(2, 3, 5), IPosition(2, 13, Slicer::MimicSource), Slicer::endIsLast);
  check(ns21.inferShapeFromSource(shape, blc, trc, inc), {11, 25});
  check(blc, {3, 5});
  check(trc, {13, 29});
  check(inc, {1, 1});

  Slicer ns22(IPosition(2, Slicer::MimicSource, 5), IPosition(2, 13, 21), IPosition(2, 3, 2),
              Slicer::endIsLast);
...
BOOST_FIXTURE_TEST_CASE(undetermined_blc_length, Fixture) {
  ...
  Slicer ns32(IPosition(2, Slicer::MimicSource, 5), IPosition(2, 5, 11), IPosition(2, 3, 2));
...
BOOST_AUTO_TEST_CASE(errors) {
  ...
  BOOST_CHECK_THROW(Slicer(IPosition(2, 0, 0), IPosition(3, 0, 0, 0), Slicer::endIsLast),
                    ArrayError);
  // trc < blc
  BOOST_CHECK_THROW(Slicer(IPosition(2, 0, 1), IPosition(2, 0, 0), Slicer::endIsLast), ArrayError);
  // length < 0
  BOOST_CHECK_THROW(Slicer(IPosition(2, 0, 1), IPosition(2, 0, -1), Slicer::endIsLength),
                    ArrayError);
  // inc <= 0
  BOOST_CHECK_THROW(Slicer(IPosition(2, 0, 1), IPosition(2, 1, 1), IPosition(2, -1, 0)),
                    ArrayError);
