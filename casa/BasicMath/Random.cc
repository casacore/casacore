...
static Int randomStateTable[][3] = {
    ...
    {3, 41, 256},  {9, 49, 256},  {3, 52, 256},  {24, 55, 256}, {7, 57, 256},  {19, 58, 256},
    {38, 89, 512}, {17, 95, 512}, {6, 97, 512},  {11, 98, 512}, {-1, -1, -1}};
...
static uInt seedTable[SEED_TABLE_SIZE] = {
    ...
    0x4ec7c92d, 0x7f187521, 0x2cf346b4, 0xad13310f, 0xb89cff2b, 0x12164de1, 0xa865168d, 0x32b56cdf};
...
uInt ACG::asuInt() {
  ...
  result |= *(perm++) & ((auxACG << 8) | ((auxACG >> 24) & 0xff));
  return result;
}
