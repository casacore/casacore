...
double sumsqr(double l, double r) { return l + r * r; }
...
void testCompare() {
  ...
  indgen(arr1);
  indgen(arr2);
  AlwaysAssertExit(compareAll(arr1.begin(), arr1.end(), arr2.begin(), Near<T>()));
  AlwaysAssertExit(compareAny(arr1.begin(), arr1.end(), arr2.begin(), Near<T>()));
  AlwaysAssertExit(compareAll(arr1s.begin(), arr1s.end(), arr2s.begin(), Near<T>()));
  AlwaysAssertExit(compareAny(arr1s.begin(), arr1s.end(), arr2s.begin(), Near<T>()));
