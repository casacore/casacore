...
inline DComplex operator+(const DComplex &d, const Complex &c) { return (DComplex)c + d; }

inline DComplex operator+(const Complex &c, const DComplex &d) { return (DComplex)c + d; }

inline DComplex operator-(const DComplex &d, const Complex &c) { return d - (DComplex)c; }
...
// </reviewed>
// <group name=maxmin>
inline Complex max(const Complex &x, const Complex &y) { return x >= y ? x : y; }
inline DComplex max(const DComplex &x, const DComplex &y) { return x >= y ? x : y; }

inline Complex min(const Complex &x, const Complex &y) { return x <= y ? x : y; }
inline DComplex min(const DComplex &x, const DComplex &y) { return x <= y ? x : y; }
...
inline Complex ceil(const Complex &x) { return Complex(std::ceil(x.real()), std::ceil(x.imag())); }
