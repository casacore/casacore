...
public:
    ...
    uint32_t addField (const String& fieldName, DataType dataType);
    ...
    uint32_t mergeField (const RecordDesc& other, int32_t whichFieldFromOther,
    ...
    // It returns the new number of fields.
    uint32_t removeField (int32_t whichField);
    ...
    RecordDesc& rwSubRecord (int32_t whichField);
    // </group>
...
inline uint32_t RecordDesc::addField (const String& fieldName, DataType dataType)
{
    return desc_p.rwRef().addField (fieldName, dataType);
}

inline uint32_t RecordDesc::addField (const String& fieldName,
...
inline uint32_t RecordDesc::addTable (const String& fieldName,
				  const String& tableDescName)
{
    return desc_p.rwRef().addTable (fieldName, tableDescName);
}

inline const String& RecordDesc::comment (int32_t whichField) const
{
    return desc_p.ref().comment (whichField);
}

inline void RecordDesc::setComment (int32_t whichField, const String& comment)
{
    desc_p.rwRef().setComment (whichField, comment);
}

inline void RecordDesc::setShape (int32_t whichField, const IPosition& shape)
{
    desc_p.rwRef().setShape (whichField, shape);
}

inline uint32_t RecordDesc::mergeField (const RecordDesc& other,
...
inline uint32_t RecordDesc::merge (const RecordDesc& other,
			       RecordInterface::DuplicatesFlag duplicateAction)
{
    return desc_p.rwRef().merge (other.desc_p.ref(), duplicateAction);
}
    
inline uint32_t RecordDesc::removeField (int32_t whichField)
{
    return desc_p.rwRef().removeField (whichField);
}

inline void RecordDesc::renameField (const String& newName, int32_t whichField)
{
    desc_p.rwRef().renameField (newName, whichField);
}
 
inline int32_t RecordDesc::fieldNumber (const String& fieldName) const
{
    return desc_p.ref().fieldNumber (fieldName);
}

inline uint32_t RecordDesc::nfields() const
{
    return desc_p.ref().nfields();
}

inline DataType RecordDesc::type (int32_t whichField) const
{
...
inline String RecordDesc::makeName (int32_t whichField) const
{
    return desc_p.ref().makeName (whichField);
}

inline const String& RecordDesc::name (int32_t whichField) const
{
    return desc_p.ref().name (whichField);
}

inline bool RecordDesc::isArray (int32_t whichField) const
{
    return desc_p.ref().isArray (whichField);
}

inline bool RecordDesc::isScalar (int32_t whichField) const
{
    return desc_p.ref().isScalar (whichField);
}

inline bool RecordDesc::isSubRecord (int32_t whichField) const
{
    return desc_p.ref().isSubRecord (whichField);
}

inline bool RecordDesc::isTable (int32_t whichField) const
{
    return desc_p.ref().isTable (whichField);
}

inline const IPosition& RecordDesc::shape (int32_t whichField) const
{
    return desc_p.ref().shape (whichField);
}

inline const String& RecordDesc::tableDescName (int32_t whichField) const
{
    return desc_p.ref().tableDescName (whichField);
}

inline const RecordDesc& RecordDesc::subRecord (int32_t whichField) const
{
    return desc_p.ref().subRecord (whichField);
}

inline RecordDesc& RecordDesc::rwSubRecord (int32_t whichField)
{
