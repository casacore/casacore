...
class RecordInterface {
 public:
  ...
  // <group>
  friend inline std::ostream& operator<<(std::ostream& os, const RecordInterface& rec) {
    rec.print(os, 25, "  ");
    return os;
  }
...
inline RecordInterface::RecordType RecordInterface::recordType() const { return type_p; }
