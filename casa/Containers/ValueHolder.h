...
class ValueHolder {
 public:
  ...
  bool operator<(const ValueHolder& right) const { return itsRep->operator<(*right.itsRep); }
...
inline DataType ValueHolder::dataType() const { return itsRep->dataType(); }
...
inline const Array<String> ValueHolder::asArrayString() const { return itsRep->asArrayString(); }
inline const Record& ValueHolder::asRecord() const { return itsRep->asRecord(); }
