...
void doIt(Bool doExcp) {
  ...
  AlwaysAssertExit(a.nfields() == 2 && a.name(0) == "a" && a.name(1) == "b" &&
                   a.type(0) == TpString && a.type(1) == TpArrayDComplex && !a.isArray(0) &&
                   a.isArray(1) && a.isScalar(0) && !a.isScalar(1) && !a.isSubRecord(0) &&
                   !a.isSubRecord(1) && !a.isTable(0) && !a.isTable(1) &&
                   a.tableDescName(0).empty() && a == a && !(a != a) && a.fieldNumber("a") == 0 &&
                   a.fieldNumber("b") == 1 && a.fieldNumber("c") == -1 &&
                   a.shape(0) == IPosition(1, 1) && a.shape(1) == IPosition(1, -1));
  ...
  AlwaysAssertExit(b.subRecord(3) == a && b.isSubRecord(3) && !b.isScalar(3) && !b.isArray(3));
...

  {
    ...
    cd.addField("d", ab);
    ab.merge(cd);
    AlwaysAssertExit(ab.nfields() == 4 && ab.fieldNumber("c") == 2 && ab.fieldNumber("d") == 3);
    ...
    ab.mergeField(cd, cd.fieldNumber("a"), RecordInterface::OverwriteDuplicates);
