...
class HDF5Group : public HDF5Object {
 public:
  ...
  // <group>
  HDF5Group(const HDF5Object& parentHid, const String& name, bool mustExist = false,
            bool mustNotExist = false) {
    init(parentHid, parentHid.getName(), name, mustExist, mustNotExist);
  }
  HDF5Group(hid_t parentHid, const String& name, bool mustExist = false,
            bool mustNotExist = false) {
 ...
 private:
  ...
  void init(hid_t parentHid, const String& parentName, const String& name, bool mustExist = false,
            bool mustNotExist = false);
};
