...
HDF5HidDataType::HDF5HidDataType(const HDF5HidDataType& that) : itsHid(H5Tcopy(that.itsHid)) {}
...
HDF5HidDataType& HDF5HidDataType::operator=(const HDF5HidDataType&) { return *this; }
