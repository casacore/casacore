...
class HDF5Record {
 public:
  ...
  static void writeRecord(const HDF5Object& parentHid, const String& recordName,
 ...
 private:
  ...
  static void readArray(hid_t attrId, hid_t dtid, const IPosition&, const String& name,
                        RecordInterface& rec);
  ...
  static void writeScalar(hid_t parentHid, const String& name, const void* value,
                          const HDF5DataType& dtype);

  // Write an array of fixed length values as attribute.
  static void writeArray(hid_t parentHid, const String& name, const void* value,
