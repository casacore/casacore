...
size_t CanonicalIO::read(size_t nvalues, Complex* value) { return TypeIO::read(nvalues, value); }

size_t CanonicalIO::read(size_t nvalues, DComplex* value) { return TypeIO::read(nvalues, value); }

size_t CanonicalIO::read(size_t nvalues, String* value) { return TypeIO::read(nvalues, value); }
