...
CanonicalIO::CanonicalIO (ByteIO* byteIO, uint32_t bufferLength, bool takeOver)
...
size_t CanonicalIO::write (size_t nvalues, const int16_t* value)
{
...
size_t CanonicalIO::write (size_t nvalues, const uint16_t* value)
{
...
size_t CanonicalIO::write(size_t nvalues, const int32_t* value)
{
    if (CONVERT_CAN_INT) {
...
size_t CanonicalIO::write(size_t nvalues, const uint32_t* value)
{
    if (CONVERT_CAN_UINT) {
...
size_t CanonicalIO::read (size_t nvalues, int16_t* value)
{
    if (CONVERT_CAN_SHORT) {
	if (nvalues * SIZE_CAN_SHORT <= itsBufferLength) {
...
size_t CanonicalIO::read (size_t nvalues, uint16_t* value)
{
    if (CONVERT_CAN_USHORT) {
	if (nvalues * SIZE_CAN_USHORT <= itsBufferLength) {
...
size_t CanonicalIO::read (size_t nvalues, int32_t* value)
{
    if (CONVERT_CAN_INT) {
	if (nvalues * SIZE_CAN_INT <= itsBufferLength) {
...
size_t CanonicalIO::read (size_t nvalues, uint32_t* value)
{
    if (CONVERT_CAN_UINT) {
	if (nvalues * SIZE_CAN_UINT <= itsBufferLength) {
