...
class AipsIOCarrayEx1 {
 public:
  ...
  friend AipsIO& operator<<(AipsIO& ios, const AipsIOCarrayEx1& a) { return ios << a.a_p << a.b_p; }
  friend AipsIO& operator>>(AipsIO& ios, AipsIOCarrayEx1& a) { return ios >> a.a_p >> a.b_p; }
