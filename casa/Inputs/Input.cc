...
void Input::create(const String& key) { createPar(0, key, "", "", "", "", ""); }
...
void Input::create(const String& key, const String& value, const String& help, const String& type) {
...
void Input::createPar(Int system, const String& key, const String& value, const String& help,
  ...
  if (debug(5)) {
    cout << "Input::CreatePar: Creating new keyword " << key << "=" << value << "\n" << flush;
  }
