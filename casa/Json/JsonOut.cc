...
JsonOut::JsonOut() : itsStream(cout), itsLevel(0) {}

JsonOut::JsonOut(const String& name) : itsFile(name.c_str()), itsStream(itsFile), itsLevel(0) {}

JsonOut::JsonOut(ostream& os) : itsStream(os), itsLevel(0) {}

// Close the stream.
JsonOut::~JsonOut() {}

void JsonOut::start(const String& commentStart, const String& commentEnd, const String& indent) {
...
void JsonOut::put(const char* value) { itsStream << '"' << escapeString(value) << '"'; }
void JsonOut::put(const String& value) { itsStream << '"' << escapeString(value) << '"'; }
