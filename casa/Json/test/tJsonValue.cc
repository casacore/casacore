...
void doValueHolder() {
  ...
  AlwaysAssertExit(JsonValue(vector<JsonValue>(1, JsonValue(1.))).getValueHolder().dataType() ==
                   TpArrayDouble);
  AlwaysAssertExit(
      JsonValue(vector<JsonValue>(1, JsonValue(Complex()))).getValueHolder().dataType() ==
      TpArrayDComplex);
  ...
  AlwaysAssertExit(
      JsonValue(vector<JsonValue>(1, JsonValue(2.5))).getValueHolder().asArrayDouble().data()[0] ==
      2.5);
  AlwaysAssertExit(JsonValue(vector<JsonValue>(1, JsonValue(DComplex(1, 2))))
                       .getValueHolder()
                       .asArrayDComplex()
                       .data()[0] == DComplex(1, 2));
  AlwaysAssertExit(
      JsonValue(vector<JsonValue>(1, JsonValue("bc"))).getValueHolder().asArrayString().data()[0] ==
      "bc");
}
