...
LogMessage::Priority LogIO::priority() { return msg_p.priority(); }

void LogIO::sourceLocation(const SourceLocation *where) { msg_p.sourceLocation(where); }

void LogIO::origin(const LogOrigin &OR) { msg_p.origin(OR); }
...
LogIO &operator<<(LogIO &os, LogIO::Command item) {
  switch (item) {
    case LogIO::POST:
      os.post();
      break;
    case LogIO::EXCEPTION:
      os.postThenThrow(AipsError());
      break;
    case LogIO::SEVERE:
      os.priority(LogMessage::SEVERE);
      break;
    case LogIO::WARN:
      os.priority(LogMessage::WARN);
      break;
    case LogIO::NORMAL:
      os.priority(LogMessage::NORMAL);
      break;
    case LogIO::NORMAL1:
      os.priority(LogMessage::NORMAL1);
      break;
    case LogIO::NORMAL2:
      os.priority(LogMessage::NORMAL2);
      break;
    case LogIO::NORMAL3:
      os.priority(LogMessage::NORMAL3);
      break;
    case LogIO::NORMAL4:
      os.priority(LogMessage::NORMAL4);
      break;
    case LogIO::NORMAL5:
      os.priority(LogMessage::NORMAL5);
      break;
    case LogIO::DEBUG1:
      os.priority(LogMessage::DEBUG1);
      break;
    case LogIO::DEBUG2:
      os.priority(LogMessage::DEBUG2);
      break;
    case LogIO::DEBUGGING:
      os.priority(LogMessage::DEBUGGING);
      break;
    default:
...
LogIO &operator<<(LogIO &os, const SourceLocation &item) {
  if (os.priority() < LogMessage::NORMAL1 || os.priority() > LogMessage::WARN)
