...
String LogSinkInterface::localId() { return String("LogSinkInterface"); }

LogSinkInterface::LogSinkInterface() : filter_p(new LogFilter()) {
  // Nothing
}

LogSinkInterface::LogSinkInterface(const LogFilterInterface &filter) : filter_p(filter.clone()) {
  // Nothing
}
...
uInt LogSinkInterface::nelements() const { return 0; }
...
const LogFilterInterface &LogSinkInterface::filter() const { return *filter_p; }
...
void LogSinkInterface::writeLocally(Double, const String &, const String &, const String &,
                                    const String &) {}
