...
String NullLogSink::localId() { return String("NullLogSink"); }

String NullLogSink::id() const { return String("NullLogSink"); }

NullLogSink::NullLogSink() {
  // Nothing
}

NullLogSink::NullLogSink(LogMessage::Priority filter) : LogSinkInterface(LogFilter(filter)) {
  // Nothing
}

NullLogSink::NullLogSink(const LogFilterInterface &filter) : LogSinkInterface(filter) {
  // Nothing
}
