...
inline void CanonicalConversion::move2(void* to, const void* from) { memcpy(to, from, 2); }

inline void CanonicalConversion::move4(void* to, const void* from) { memcpy(to, from, 4); }
...
inline size_t CanonicalConversion::toLocal(unsigned char& to, const void* from) {
...
inline size_t CanonicalConversion::toLocal(unsigned short& to, const void* from) {
...
inline size_t CanonicalConversion::toLocal(unsigned int& to, const void* from) {
...
inline size_t CanonicalConversion::fromLocal(void* to, const char& from) {
  *(char*)to = from;
  return SIZE_CAN_CHAR;
}
inline size_t CanonicalConversion::fromLocal(void* to, const unsigned char& from) {
  *(unsigned char*)to = from;
  return SIZE_CAN_UCHAR;
}

inline size_t CanonicalConversion::fromLocal(void* to, const short& from) {
#if defined(AIPS_LITTLE_ENDIAN)
  reverse2(to, &from);
#else
...
inline size_t CanonicalConversion::fromLocal(void* to, const unsigned short& from) {
#if defined(AIPS_LITTLE_ENDIAN)
  reverse2(to, &from);
#else
...
inline size_t CanonicalConversion::fromLocal(void* to, const int& from) {
#if defined(AIPS_LITTLE_ENDIAN)
  reverse4(to, &from);
#else
...
inline size_t CanonicalConversion::fromLocal(void* to, const unsigned int& from) {
#if defined(AIPS_LITTLE_ENDIAN)
  reverse4(to, &from);
#else
...
inline size_t CanonicalConversion::fromLocal(void* to, const float& from) {
#if defined(AIPS_LITTLE_ENDIAN)
  reverse4(to, &from);
#else
  move4(to, &from);
...
inline size_t CanonicalConversion::fromLocal(void* to, const double& from) {
#if defined(AIPS_LITTLE_ENDIAN)
  reverse8(to, &from);
#else
  move8(to, &from);
...
inline size_t CanonicalConversion::toLocal(char* to, const void* from, size_t nr) {
  return toLocalChar(to, from, nr);
}
inline size_t CanonicalConversion::toLocal(unsigned char* to, const void* from, size_t nr) {
  return toLocalUChar(to, from, nr);
}
inline size_t CanonicalConversion::toLocal(short* to, const void* from, size_t nr) {
  return toLocalShort(to, from, nr);
}
inline size_t CanonicalConversion::toLocal(unsigned short* to, const void* from, size_t nr) {
  return toLocalUShort(to, from, nr);
}
inline size_t CanonicalConversion::toLocal(int* to, const void* from, size_t nr) {
...
inline size_t CanonicalConversion::toLocal(double* to, const void* from, size_t nr) {
  return toLocalDouble(to, from, nr);
}

inline size_t CanonicalConversion::fromLocal(void* to, const char* from, size_t nr) {
  return fromLocalChar(to, from, nr);
}
inline size_t CanonicalConversion::fromLocal(void* to, const unsigned char* from, size_t nr) {
  return fromLocalUChar(to, from, nr);
}
inline size_t CanonicalConversion::fromLocal(void* to, const short* from, size_t nr) {
  return fromLocalShort(to, from, nr);
}
inline size_t CanonicalConversion::fromLocal(void* to, const unsigned short* from, size_t nr) {
  return fromLocalUShort(to, from, nr);
}
inline size_t CanonicalConversion::fromLocal(void* to, const int* from, size_t nr) {
...
inline size_t CanonicalConversion::fromLocal(void* to, const double* from, size_t nr) {
  return fromLocalDouble(to, from, nr);
}

inline Conversion::ValueFunction* CanonicalConversion::getToLocal(const char*) {
  return toLocalChar;
}
inline Conversion::ValueFunction* CanonicalConversion::getToLocal(const unsigned char*) {
  return toLocalUChar;
}
inline Conversion::ValueFunction* CanonicalConversion::getToLocal(const short*) {
  return toLocalShort;
}
inline Conversion::ValueFunction* CanonicalConversion::getToLocal(const unsigned short*) {
  return toLocalUShort;
}
inline Conversion::ValueFunction* CanonicalConversion::getToLocal(const int*) { return toLocalInt; }
...
inline Conversion::ValueFunction* CanonicalConversion::getToLocal(const double*) {
  return toLocalDouble;
}

inline Conversion::ValueFunction* CanonicalConversion::getFromLocal(const char*) {
  return fromLocalChar;
}
inline Conversion::ValueFunction* CanonicalConversion::getFromLocal(const unsigned char*) {
  return fromLocalUChar;
}
inline Conversion::ValueFunction* CanonicalConversion::getFromLocal(const short*) {
  return fromLocalShort;
}
inline Conversion::ValueFunction* CanonicalConversion::getFromLocal(const unsigned short*) {
  return fromLocalUShort;
}
inline Conversion::ValueFunction* CanonicalConversion::getFromLocal(const int*) {
  return fromLocalInt;
}
...
inline Conversion::ValueFunction* CanonicalConversion::getFromLocal(const double*) {
  return fromLocalDouble;
}

inline unsigned int CanonicalConversion::canonicalSize(const char*) { return SIZE_CAN_CHAR; }
inline unsigned int CanonicalConversion::canonicalSize(const unsigned char*) {
  return SIZE_CAN_UCHAR;
}
inline unsigned int CanonicalConversion::canonicalSize(const short*) { return SIZE_CAN_SHORT; }
inline unsigned int CanonicalConversion::canonicalSize(const unsigned short*) {
  return SIZE_CAN_USHORT;
}
inline unsigned int CanonicalConversion::canonicalSize(const int*) { return SIZE_CAN_INT; }
