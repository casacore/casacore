...
size_t CanonicalDataConversion::toLocal(char& to, const void* from) const {
  return CanonicalConversion::toLocal(to, from);
}
size_t CanonicalDataConversion::toLocal(unsigned char& to, const void* from) const {
  return CanonicalConversion::toLocal(to, from);
}
size_t CanonicalDataConversion::toLocal(short& to, const void* from) const {
  return CanonicalConversion::toLocal(to, from);
}
size_t CanonicalDataConversion::toLocal(unsigned short& to, const void* from) const {
  return CanonicalConversion::toLocal(to, from);
}
size_t CanonicalDataConversion::toLocal(int& to, const void* from) const {
  return CanonicalConversion::toLocal(to, from);
}
...
size_t CanonicalDataConversion::toLocal(double& to, const void* from) const {
  return CanonicalConversion::toLocal(to, from);
}

size_t CanonicalDataConversion::toLocal(char* to, const void* from, size_t nr) const {
  return CanonicalConversion::toLocal(to, from, nr);
}
size_t CanonicalDataConversion::toLocal(unsigned char* to, const void* from, size_t nr) const {
  return CanonicalConversion::toLocal(to, from, nr);
}
size_t CanonicalDataConversion::toLocal(short* to, const void* from, size_t nr) const {
  return CanonicalConversion::toLocal(to, from, nr);
}
size_t CanonicalDataConversion::toLocal(unsigned short* to, const void* from, size_t nr) const {
  return CanonicalConversion::toLocal(to, from, nr);
}
size_t CanonicalDataConversion::toLocal(int* to, const void* from, size_t nr) const {
  return CanonicalConversion::toLocal(to, from, nr);
}
...
size_t CanonicalDataConversion::toLocal(double* to, const void* from, size_t nr) const {
  return CanonicalConversion::toLocal(to, from, nr);
}

size_t CanonicalDataConversion::fromLocal(void* to, char from) const {
  return CanonicalConversion::fromLocal(to, from);
}
size_t CanonicalDataConversion::fromLocal(void* to, unsigned char from) const {
  return CanonicalConversion::fromLocal(to, from);
}
size_t CanonicalDataConversion::fromLocal(void* to, short from) const {
  return CanonicalConversion::fromLocal(to, from);
}
size_t CanonicalDataConversion::fromLocal(void* to, unsigned short from) const {
  return CanonicalConversion::fromLocal(to, from);
}
size_t CanonicalDataConversion::fromLocal(void* to, int from) const {
  return CanonicalConversion::fromLocal(to, from);
}
...
size_t CanonicalDataConversion::fromLocal(void* to, double from) const {
  return CanonicalConversion::fromLocal(to, from);
}

size_t CanonicalDataConversion::fromLocal(void* to, const char* from, size_t nr) const {
  return CanonicalConversion::fromLocal(to, from, nr);
}
size_t CanonicalDataConversion::fromLocal(void* to, const unsigned char* from, size_t nr) const {
  return CanonicalConversion::fromLocal(to, from, nr);
}
size_t CanonicalDataConversion::fromLocal(void* to, const short* from, size_t nr) const {
  return CanonicalConversion::fromLocal(to, from, nr);
}
size_t CanonicalDataConversion::fromLocal(void* to, const unsigned short* from, size_t nr) const {
  return CanonicalConversion::fromLocal(to, from, nr);
}
size_t CanonicalDataConversion::fromLocal(void* to, const int* from, size_t nr) const {
  return CanonicalConversion::fromLocal(to, from, nr);
}
...
size_t CanonicalDataConversion::fromLocal(void* to, const double* from, size_t nr) const {
  return CanonicalConversion::fromLocal(to, from, nr);
}
...
unsigned int CanonicalDataConversion::externalSize(const short*) const { return SIZE_CAN_SHORT; }
unsigned int CanonicalDataConversion::externalSize(const unsigned short*) const {
  return SIZE_CAN_USHORT;
}
unsigned int CanonicalDataConversion::externalSize(const int*) const { return SIZE_CAN_INT; }
