...
// It contains functions to convert data from/to the canonical format
// using the static functions in class <linkto class=CanonicalConversion>
// CanonicalConversion</linkto>.
// </synopsis>
...
// <motivation>
// This class is an addition to <linkto class=CanonicalConversion>
// CanonicalConversion</linkto>
...
inline CanonicalDataConversion::CanonicalDataConversion()
{}
