...
static inline uInt64 get_cgroup_limit(std::string group, std::string value,
...
void HostMachineInfo::update_info() {
  ...
  {
    char *p;
    unsigned long sys_mem_total, sys_mem_free, sys_mem_cached, sys_mem_avail, sys_swap_total,
        sys_swap_free;
