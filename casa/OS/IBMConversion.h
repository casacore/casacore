...
public:
    ...
    static void fromLocal (void* to, const unsigned int*   from,
			   size_t nr);
    static void fromLocal (void* to, const int64_t*          from,
			   size_t nr);
    static void fromLocal (void* to, const uint64_t*         from,
			   size_t nr);
...
inline void IBMConversion::toLocal (int64_t& to, const void* from)
{
    if (sizeof(int64_t) != 4) {
...
#else
    CanonicalConversion::move4 (((char*)&to)+sizeof(int64_t)-4, from);
#endif
}

inline void IBMConversion::toLocal (uint64_t& to, const void* from)
{
    ...
    CanonicalConversion::reverse4 (&to, from);
#else
    CanonicalConversion::move4 (((char*)&to)+sizeof(uint64_t)-4, from);
#endif
}
...
inline void IBMConversion::fromLocal (void* to, int64_t from)
{
#if defined(AIPS_LITTLE_ENDIAN)
    CanonicalConversion::reverse4 (to, &from);
#else
    CanonicalConversion::move4 (to, ((char*)&from)+sizeof(int64_t)-4);
#endif
}

inline void IBMConversion::fromLocal (void* to, uint64_t from)
{
#if defined(AIPS_LITTLE_ENDIAN)
    CanonicalConversion::reverse4 (to, &from);
#else
    CanonicalConversion::move4 (to,((char*)&from)+sizeof(uint64_t)-4);
#endif
}
