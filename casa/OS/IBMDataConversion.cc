...
size_t IBMDataConversion::toLocal(char& to, const void* from) const {
  IBMConversion::toLocal(to, from);
  return SIZE_IBM_CHAR;
}
size_t IBMDataConversion::toLocal(unsigned char& to, const void* from) const {
  IBMConversion::toLocal(to, from);
  return SIZE_IBM_UCHAR;
}
size_t IBMDataConversion::toLocal(short& to, const void* from) const {
  IBMConversion::toLocal(to, from);
  return SIZE_IBM_SHORT;
}
size_t IBMDataConversion::toLocal(unsigned short& to, const void* from) const {
  IBMConversion::toLocal(to, from);
  return SIZE_IBM_USHORT;
}
size_t IBMDataConversion::toLocal(int& to, const void* from) const {
  IBMConversion::toLocal(to, from);
  return SIZE_IBM_INT;
}
size_t IBMDataConversion::toLocal(unsigned int& to, const void* from) const {
  IBMConversion::toLocal(to, from);
...
size_t IBMDataConversion::toLocal(float& to, const void* from) const {
  IBMConversion::toLocal(to, from);
  return SIZE_IBM_FLOAT;
}
size_t IBMDataConversion::toLocal(double& to, const void* from) const {
  IBMConversion::toLocal(to, from);
  return SIZE_IBM_DOUBLE;
}

size_t IBMDataConversion::toLocal(char* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
  return nr * SIZE_IBM_CHAR;
}
size_t IBMDataConversion::toLocal(unsigned char* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
  return nr * SIZE_IBM_UCHAR;
}
size_t IBMDataConversion::toLocal(short* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
  return nr * SIZE_IBM_SHORT;
}
size_t IBMDataConversion::toLocal(unsigned short* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
  return nr * SIZE_IBM_USHORT;
}
size_t IBMDataConversion::toLocal(int* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
  return nr * SIZE_IBM_INT;
}
size_t IBMDataConversion::toLocal(unsigned int* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
...
size_t IBMDataConversion::toLocal(float* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
  return nr * SIZE_IBM_FLOAT;
}
size_t IBMDataConversion::toLocal(double* to, const void* from, size_t nr) const {
  IBMConversion::toLocal(to, from, nr);
...
size_t IBMDataConversion::fromLocal(void* to, const char* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_CHAR;
}
size_t IBMDataConversion::fromLocal(void* to, const unsigned char* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_UCHAR;
}
size_t IBMDataConversion::fromLocal(void* to, const short* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_SHORT;
}
size_t IBMDataConversion::fromLocal(void* to, const unsigned short* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_USHORT;
}
size_t IBMDataConversion::fromLocal(void* to, const int* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_INT;
}
size_t IBMDataConversion::fromLocal(void* to, const unsigned int* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_UINT;
}
...
size_t IBMDataConversion::fromLocal(void* to, const float* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_FLOAT;
}
size_t IBMDataConversion::fromLocal(void* to, const double* from, size_t nr) const {
  IBMConversion::fromLocal(to, from, nr);
  return nr * SIZE_IBM_DOUBLE;
}
...
unsigned int IBMDataConversion::externalSize(const short*) const { return SIZE_IBM_SHORT; }
