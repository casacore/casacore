// # LECanonicalConversion.h: A class with static functions to convert little endian canonical
// format # Copyright (C) 2002 # Associated Universities, Inc. Washington DC, USA.
// #
...
#else
  xsw = ((x & 0xffULL) << 56ULL) | ((x & 0xff00ULL) << 40ULL) | ((x & 0xff0000ULL) << 24ULL) |
        ((x & 0xff000000ULL) << 8ULL) | ((x & 0xff00000000ULL) >> 8ULL) |
        ((x & 0xff0000000000ULL) >> 24ULL) | ((x & 0xff000000000000ULL) >> 40ULL) | (x >> 56ULL);
#endif
  memcpy(to, &xsw, 8);
}

inline void LECanonicalConversion::move2(void* to, const void* from) { memcpy(to, from, 2); }

inline void LECanonicalConversion::move4(void* to, const void* from) { memcpy(to, from, 4); }
...
inline size_t LECanonicalConversion::toLocal(char& to, const void* from) {
  to = *(char*)from;
  return SIZE_LECAN_CHAR;
}

inline size_t LECanonicalConversion::toLocal(unsigned char& to, const void* from) {
  to = *(unsigned char*)from;
  return SIZE_LECAN_UCHAR;
}

inline size_t LECanonicalConversion::toLocal(short& to, const void* from) {
  if (sizeof(short) != 2) {
...
inline size_t LECanonicalConversion::toLocal(unsigned short& to, const void* from) {
...
inline size_t LECanonicalConversion::toLocal(int& to, const void* from) {
  if (sizeof(int) != 4) {
    if (((signed char*)from)[0] < 0) {
      to = -1;
    } else {
...
inline size_t LECanonicalConversion::toLocal(unsigned int& to, const void* from) {
...
inline size_t LECanonicalConversion::toLocal(float& to, const void* from) {
#if !defined(AIPS_LITTLE_ENDIAN)
...
inline size_t LECanonicalConversion::toLocal(double& to, const void* from) {
#if !defined(AIPS_LITTLE_ENDIAN)
...
inline size_t LECanonicalConversion::fromLocal(void* to, const char& from) {
  *(char*)to = from;
  return SIZE_LECAN_CHAR;
}
inline size_t LECanonicalConversion::fromLocal(void* to, const unsigned char& from) {
  *(unsigned char*)to = from;
  return SIZE_LECAN_UCHAR;
}

inline size_t LECanonicalConversion::fromLocal(void* to, const short& from) {
#if !defined(AIPS_LITTLE_ENDIAN)
  reverse2(to, &from);
#else
...
inline size_t LECanonicalConversion::fromLocal(void* to, const unsigned short& from) {
#if !defined(AIPS_LITTLE_ENDIAN)
  reverse2(to, &from);
#else
...
inline size_t LECanonicalConversion::fromLocal(void* to, const int& from) {
#if !defined(AIPS_LITTLE_ENDIAN)
  reverse4(to, &from);
#else
...
inline size_t LECanonicalConversion::fromLocal(void* to, const unsigned int& from) {
#if !defined(AIPS_LITTLE_ENDIAN)
  reverse4(to, &from);
#else
...
inline size_t LECanonicalConversion::fromLocal(void* to, const float& from) {
#if !defined(AIPS_LITTLE_ENDIAN)
  reverse4(to, &from);
#else
  move4(to, &from);
...
inline size_t LECanonicalConversion::fromLocal(void* to, const double& from) {
#if !defined(AIPS_LITTLE_ENDIAN)
  reverse8(to, &from);
#else
  move8(to, &from);
...
inline size_t LECanonicalConversion::toLocal(char* to, const void* from, size_t nr) {
  return toLocalChar(to, from, nr);
}
inline size_t LECanonicalConversion::toLocal(unsigned char* to, const void* from, size_t nr) {
  return toLocalUChar(to, from, nr);
}
inline size_t LECanonicalConversion::toLocal(short* to, const void* from, size_t nr) {
  return toLocalShort(to, from, nr);
}
inline size_t LECanonicalConversion::toLocal(unsigned short* to, const void* from, size_t nr) {
  return toLocalUShort(to, from, nr);
}
inline size_t LECanonicalConversion::toLocal(int* to, const void* from, size_t nr) {
...
inline size_t LECanonicalConversion::toLocal(double* to, const void* from, size_t nr) {
  return toLocalDouble(to, from, nr);
}

inline size_t LECanonicalConversion::fromLocal(void* to, const char* from, size_t nr) {
  return fromLocalChar(to, from, nr);
}
inline size_t LECanonicalConversion::fromLocal(void* to, const unsigned char* from, size_t nr) {
  return fromLocalUChar(to, from, nr);
}
inline size_t LECanonicalConversion::fromLocal(void* to, const short* from, size_t nr) {
  return fromLocalShort(to, from, nr);
}
inline size_t LECanonicalConversion::fromLocal(void* to, const unsigned short* from, size_t nr) {
  return fromLocalUShort(to, from, nr);
}
inline size_t LECanonicalConversion::fromLocal(void* to, const int* from, size_t nr) {
...
inline size_t LECanonicalConversion::fromLocal(void* to, const double* from, size_t nr) {
  return fromLocalDouble(to, from, nr);
}

inline Conversion::ValueFunction* LECanonicalConversion::getToLocal(const char*) {
  return toLocalChar;
}
inline Conversion::ValueFunction* LECanonicalConversion::getToLocal(const unsigned char*) {
  return toLocalUChar;
}
inline Conversion::ValueFunction* LECanonicalConversion::getToLocal(const short*) {
  return toLocalShort;
}
inline Conversion::ValueFunction* LECanonicalConversion::getToLocal(const unsigned short*) {
  return toLocalUShort;
}
inline Conversion::ValueFunction* LECanonicalConversion::getToLocal(const int*) {
  return toLocalInt;
}
...
inline Conversion::ValueFunction* LECanonicalConversion::getToLocal(const double*) {
  return toLocalDouble;
}

inline Conversion::ValueFunction* LECanonicalConversion::getFromLocal(const char*) {
  return fromLocalChar;
}
inline Conversion::ValueFunction* LECanonicalConversion::getFromLocal(const unsigned char*) {
  return fromLocalUChar;
}
inline Conversion::ValueFunction* LECanonicalConversion::getFromLocal(const short*) {
  return fromLocalShort;
}
inline Conversion::ValueFunction* LECanonicalConversion::getFromLocal(const unsigned short*) {
  return fromLocalUShort;
}
inline Conversion::ValueFunction* LECanonicalConversion::getFromLocal(const int*) {
  return fromLocalInt;
}
...
inline Conversion::ValueFunction* LECanonicalConversion::getFromLocal(const double*) {
  return fromLocalDouble;
}

inline unsigned int LECanonicalConversion::canonicalSize(const char*) { return SIZE_LECAN_CHAR; }
inline unsigned int LECanonicalConversion::canonicalSize(const unsigned char*) {
  return SIZE_LECAN_UCHAR;
}
inline unsigned int LECanonicalConversion::canonicalSize(const short*) { return SIZE_LECAN_SHORT; }
inline unsigned int LECanonicalConversion::canonicalSize(const unsigned short*) {
  return SIZE_LECAN_USHORT;
}
inline unsigned int LECanonicalConversion::canonicalSize(const int*) { return SIZE_LECAN_INT; }
