// # LECanonicalDataConversion.cc: A class with virtual functions to convert little endian canonical
...
size_t LECanonicalDataConversion::toLocal(char& to, const void* from) const {
  return LECanonicalConversion::toLocal(to, from);
}
size_t LECanonicalDataConversion::toLocal(unsigned char& to, const void* from) const {
  return LECanonicalConversion::toLocal(to, from);
}
size_t LECanonicalDataConversion::toLocal(short& to, const void* from) const {
  return LECanonicalConversion::toLocal(to, from);
}
size_t LECanonicalDataConversion::toLocal(unsigned short& to, const void* from) const {
  return LECanonicalConversion::toLocal(to, from);
}
size_t LECanonicalDataConversion::toLocal(int& to, const void* from) const {
  return LECanonicalConversion::toLocal(to, from);
}
...
size_t LECanonicalDataConversion::toLocal(double& to, const void* from) const {
  return LECanonicalConversion::toLocal(to, from);
}

size_t LECanonicalDataConversion::toLocal(char* to, const void* from, size_t nr) const {
  return LECanonicalConversion::toLocal(to, from, nr);
}
size_t LECanonicalDataConversion::toLocal(unsigned char* to, const void* from, size_t nr) const {
  return LECanonicalConversion::toLocal(to, from, nr);
}
size_t LECanonicalDataConversion::toLocal(short* to, const void* from, size_t nr) const {
  return LECanonicalConversion::toLocal(to, from, nr);
}
size_t LECanonicalDataConversion::toLocal(unsigned short* to, const void* from, size_t nr) const {
  return LECanonicalConversion::toLocal(to, from, nr);
}
size_t LECanonicalDataConversion::toLocal(int* to, const void* from, size_t nr) const {
  return LECanonicalConversion::toLocal(to, from, nr);
}
...
size_t LECanonicalDataConversion::toLocal(double* to, const void* from, size_t nr) const {
  return LECanonicalConversion::toLocal(to, from, nr);
}

size_t LECanonicalDataConversion::fromLocal(void* to, char from) const {
  return LECanonicalConversion::fromLocal(to, from);
}
size_t LECanonicalDataConversion::fromLocal(void* to, unsigned char from) const {
  return LECanonicalConversion::fromLocal(to, from);
}
size_t LECanonicalDataConversion::fromLocal(void* to, short from) const {
  return LECanonicalConversion::fromLocal(to, from);
}
size_t LECanonicalDataConversion::fromLocal(void* to, unsigned short from) const {
  return LECanonicalConversion::fromLocal(to, from);
}
size_t LECanonicalDataConversion::fromLocal(void* to, int from) const {
  return LECanonicalConversion::fromLocal(to, from);
}
...
size_t LECanonicalDataConversion::fromLocal(void* to, double from) const {
  return LECanonicalConversion::fromLocal(to, from);
}

size_t LECanonicalDataConversion::fromLocal(void* to, const char* from, size_t nr) const {
  return LECanonicalConversion::fromLocal(to, from, nr);
}
size_t LECanonicalDataConversion::fromLocal(void* to, const unsigned char* from, size_t nr) const {
  return LECanonicalConversion::fromLocal(to, from, nr);
}
size_t LECanonicalDataConversion::fromLocal(void* to, const short* from, size_t nr) const {
  return LECanonicalConversion::fromLocal(to, from, nr);
}
size_t LECanonicalDataConversion::fromLocal(void* to, const unsigned short* from, size_t nr) const {
  return LECanonicalConversion::fromLocal(to, from, nr);
}
size_t LECanonicalDataConversion::fromLocal(void* to, const int* from, size_t nr) const {
  return LECanonicalConversion::fromLocal(to, from, nr);
}
...
size_t LECanonicalDataConversion::fromLocal(void* to, const double* from, size_t nr) const {
  return LECanonicalConversion::fromLocal(to, from, nr);
}
...
unsigned int LECanonicalDataConversion::externalSize(const int*) const { return SIZE_LECAN_INT; }
