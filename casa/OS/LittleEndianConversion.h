...
inline void LittleEndianConversion::toLocal(char& to, const void* from) { to = *(char*)from; }

inline void LittleEndianConversion::toLocal(unsigned char& to, const void* from) {
...
inline void LittleEndianConversion::toLocal(unsigned short& to, const void* from) {
...
inline void LittleEndianConversion::toLocal(unsigned int& to, const void* from) {
...
inline void LittleEndianConversion::fromLocal(void* to, char from) { *(char*)to = from; }
