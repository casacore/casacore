...
double Timer::user() const {
  ...
  tms usage1;  // current tms structure
  times(&usage1);
  return ((double)(usage1.tms_utime - usage0.tms_utime)) / ((double)sysconf(_SC_CLK_TCK));
#endif
#else
  double dsec, dusec;
  rusage usage1;  // current rusage structure
...
double Timer::system() const {
  ...
  tms usage1;  // current tms structure
  times(&usage1);
  return ((double)(usage1.tms_stime - usage0.tms_stime)) / ((double)sysconf(_SC_CLK_TCK));
#endif
#else
...
double Timer::all() const {
  ...
  tms usage1;  // current tms structure
  times(&usage1);
  return ((double)((usage1.tms_utime - usage0.tms_utime) + (usage1.tms_stime - usage0.tms_stime))) /
...
double Timer::user_usec() const {
  ...
  tms usage1;  // current tms structure
  times(&usage1);
  return 1000000.0 * ((double)(usage1.tms_utime - usage0.tms_utime)) /
         ((double)sysconf(_SC_CLK_TCK));
#endif
#else
  register double dsec, dusec;
...
double Timer::system_usec() const {
  ...
  tms usage1;  // current tms structure
  times(&usage1);
  return 1000000.0 * ((double)(usage1.tms_stime - usage0.tms_stime)) /
         ((double)sysconf(_SC_CLK_TCK));
#endif
#else
  register double dsec, dusec;
...
double Timer::all_usec() const {
  ...
  times(&usage1);
  return 1000000.0 *
         ((double)((usage1.tms_utime - usage0.tms_utime) + (usage1.tms_stime - usage0.tms_stime))) /
         ((double)sysconf(_SC_CLK_TCK));
#endif
#else
  register double dsec, dusec;
...
void Timer::show() const { show(cout); }

void Timer::show(const String& s) const { show(cout, s); }

void Timer::show(ostream& os) const {
  os << setw(11) << real() << " real " << setw(11) << user() << " user " << setw(11) << system()
     << " system" << endl;
}
