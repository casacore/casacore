...
inline void VAXConversion::toLocal(float& to, const void* from) { toLocal(&to, from, 1); }

inline void VAXConversion::toLocal(double& to, const void* from) { toLocal(&to, from, 1); }

inline void VAXConversion::toLocal(char* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}

inline void VAXConversion::toLocal(unsigned char* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}

inline void VAXConversion::toLocal(short* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}

inline void VAXConversion::toLocal(unsigned short* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}

inline void VAXConversion::toLocal(int* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}

inline void VAXConversion::toLocal(unsigned int* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}

inline void VAXConversion::toLocal(Int64* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}

inline void VAXConversion::toLocal(uInt64* to, const void* from, size_t nr) {
  LittleEndianConversion::toLocal(to, from, nr);
}
...
inline void VAXConversion::fromLocal(void* to, float from) { fromLocal(to, &from, 1); }

inline void VAXConversion::fromLocal(void* to, double from) { fromLocal(to, &from, 1); }

inline void VAXConversion::fromLocal(void* to, const char* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}

inline void VAXConversion::fromLocal(void* to, const unsigned char* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}

inline void VAXConversion::fromLocal(void* to, const short* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}

inline void VAXConversion::fromLocal(void* to, const unsigned short* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}

inline void VAXConversion::fromLocal(void* to, const int* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}

inline void VAXConversion::fromLocal(void* to, const unsigned int* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}

inline void VAXConversion::fromLocal(void* to, const Int64* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}

inline void VAXConversion::fromLocal(void* to, const uInt64* from, size_t nr) {
  LittleEndianConversion::fromLocal(to, from, nr);
}
