...
size_t VAXDataConversion::toLocal(char& to, const void* from) const {
  VAXConversion::toLocal(to, from);
  return SIZE_VAX_CHAR;
}
size_t VAXDataConversion::toLocal(unsigned char& to, const void* from) const {
  VAXConversion::toLocal(to, from);
  return SIZE_VAX_UCHAR;
}
size_t VAXDataConversion::toLocal(short& to, const void* from) const {
  VAXConversion::toLocal(to, from);
  return SIZE_VAX_SHORT;
}
size_t VAXDataConversion::toLocal(unsigned short& to, const void* from) const {
  VAXConversion::toLocal(to, from);
  return SIZE_VAX_USHORT;
}
size_t VAXDataConversion::toLocal(int& to, const void* from) const {
  VAXConversion::toLocal(to, from);
  return SIZE_VAX_INT;
}
size_t VAXDataConversion::toLocal(unsigned int& to, const void* from) const {
  VAXConversion::toLocal(to, from);
...
size_t VAXDataConversion::toLocal(float& to, const void* from) const {
  VAXConversion::toLocal(to, from);
  return SIZE_VAX_FLOAT;
}
size_t VAXDataConversion::toLocal(double& to, const void* from) const {
  VAXConversion::toLocal(to, from);
  return SIZE_VAX_DOUBLE;
}

size_t VAXDataConversion::toLocal(char* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
  return nr * SIZE_VAX_CHAR;
}
size_t VAXDataConversion::toLocal(unsigned char* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
  return nr * SIZE_VAX_UCHAR;
}
size_t VAXDataConversion::toLocal(short* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
  return nr * SIZE_VAX_SHORT;
}
size_t VAXDataConversion::toLocal(unsigned short* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
  return nr * SIZE_VAX_USHORT;
}
size_t VAXDataConversion::toLocal(int* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
  return nr * SIZE_VAX_INT;
}
size_t VAXDataConversion::toLocal(unsigned int* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
...
size_t VAXDataConversion::toLocal(float* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
  return nr * SIZE_VAX_FLOAT;
}
size_t VAXDataConversion::toLocal(double* to, const void* from, size_t nr) const {
  VAXConversion::toLocal(to, from, nr);
...
size_t VAXDataConversion::fromLocal(void* to, const char* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_CHAR;
}
size_t VAXDataConversion::fromLocal(void* to, const unsigned char* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_UCHAR;
}
size_t VAXDataConversion::fromLocal(void* to, const short* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_SHORT;
}
size_t VAXDataConversion::fromLocal(void* to, const unsigned short* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_USHORT;
}
size_t VAXDataConversion::fromLocal(void* to, const int* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_INT;
}
size_t VAXDataConversion::fromLocal(void* to, const unsigned int* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_UINT;
}
...
size_t VAXDataConversion::fromLocal(void* to, const float* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_FLOAT;
}
size_t VAXDataConversion::fromLocal(void* to, const double* from, size_t nr) const {
  VAXConversion::fromLocal(to, from, nr);
  return nr * SIZE_VAX_DOUBLE;
}
...
unsigned int VAXDataConversion::externalSize(const short*) const { return SIZE_VAX_SHORT; }
