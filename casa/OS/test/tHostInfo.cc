...
int main() {
  ...
  cout << "Physical Memory: " << HostInfo::memoryTotal() << "K [ " << HostInfo::memoryUsed()
       << " used, " << HostInfo::memoryFree() << " free ]" << endl;
  ...
  unlink("aipsrc");
  cout << "Swap Space: " << HostInfo::swapTotal() << "K [ " << HostInfo::swapUsed() << " used, "
