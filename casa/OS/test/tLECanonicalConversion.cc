...
void checkFlags(int& error) {
  ...
  if ((flag ^ CONVERT_LECAN_CHAR) != 0) {
    cout << "invalid CONVERT_LECAN_CHAR definition" << endl;
    error = 1;
  }
  flag = sizeof(unsigned char) != SIZE_LECAN_UCHAR;
  if ((flag ^ CONVERT_LECAN_UCHAR) != 0) {
    cout << "invalid CONVERT_LECAN_UCHAR definition" << endl;
    error = 1;
  }
  if (sizeof(char) != 1) {
  ...
  if ((flag ^ CONVERT_LECAN_SHORT) != 0) {
    cout << "invalid CONVERT_LECAN_SHORT definition" << endl;
    error = 1;
  }
#if defined(AIPS_LITTLE_ENDIAN)
  ...
  if ((flag ^ CONVERT_LECAN_USHORT) != 0) {
    cout << "invalid CONVERT_LECAN_USHORT definition" << endl;
    error = 1;
  }
  if (sizeof(short) < 2) {
  ...
  if ((flag ^ CONVERT_LECAN_INT) != 0) {
    cout << "invalid CONVERT_LECAN_INT definition" << endl;
    error = 1;
  }
#if defined(AIPS_LITTLE_ENDIAN)
  ...
  if ((flag ^ CONVERT_LECAN_UINT) != 0) {
    cout << "invalid CONVERT_LECAN_UINT definition" << endl;
    error = 1;
  }
  if (sizeof(int) < 4) {
  ...
  if ((flag ^ CONVERT_LECAN_FLOAT) != 0) {
    cout << "invalid CONVERT_LECAN_FLOAT definition" << endl;
    error = 1;
  }
#if defined(AIPS_LITTLE_ENDIAN)
  ...
  if ((flag ^ CONVERT_LECAN_DOUBLE) != 0) {
    cout << "invalid CONVERT_LECAN_DOUBLE definition" << endl;
    error = 1;
  }
  if (sizeof(float) != 4) {
