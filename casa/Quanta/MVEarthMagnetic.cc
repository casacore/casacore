...
// # Constructors
MVEarthMagnetic::MVEarthMagnetic() : MVPosition() {}
...
MVEarthMagnetic::MVEarthMagnetic(const Quantity &l, const Quantity &angle0, const Quantity &angle1)
    : MVPosition() {
  static const UnitVal testUnit = UnitVal::MASS / UnitVal::TIME / UnitVal::TIME / UnitVal::CURRENT;
  l.assure(testUnit);
...
Quantity MVEarthMagnetic::earthMagneticAngle(const MVEarthMagnetic &other, const Unit &unit) const {
...
Quantity MVEarthMagnetic::separation(const MVEarthMagnetic &other, const Unit &unit) const {
...
void MVEarthMagnetic::print(ostream &os) const { os << getValue(); }
