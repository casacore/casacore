...
Bool near(const Quantum<Qtype> &left, const Quantum<Qtype> &other) {
  if (left.getFullUnit().getValue() == other.getFullUnit().getValue()) {
    return QMakeBool(near(left.getValue(), other.get(left.getFullUnit()).getValue()));
  }
  return False;
}
...
Bool nearAbs(const Quantum<Qtype> &left, const Quantum<Qtype> &other) {
  if (left.getFullUnit().getValue() == other.getFullUnit().getValue()) {
    return QMakeBool(nearAbs(left.getValue(), other.get(left.getFullUnit()).getValue()));
  }
  return False;
}
...
Bool nearAbs(const Quantum<Qtype> &left, const Quantum<Qtype> &other, const Quantum<Qtype> &tol) {
  if (left.getFullUnit().getValue() == tol.getFullUnit().getValue()) {
    return nearAbs(left.get(tol.getUnit()), other.get(tol.getUnit()), tol.getValue());
  }
  return False;
}
...
Bool operator<(const Quantum<Qtype> &left, const Quantum<Qtype> &other) {
  if (left.getFullUnit().getValue() != other.getFullUnit().getValue()) {
    throw(AipsError("Quantum::operator< unequal units '" + left.getUnit() + ", '" +
                    other.getUnit() + "'"));
  } else {
    return QMakeBool(QMakeBool(left.getValue() < other.get(left.getFullUnit()).getValue()));
  }
  return False;
}
...
Bool operator>(const Quantum<Qtype> &left, const Quantum<Qtype> &other) {
  if (left.getFullUnit().getValue() != other.getFullUnit().getValue()) {
    ...
    return QMakeBool(left.getValue() > other.get(left.getFullUnit()).getValue());
  }
  return False;
}
