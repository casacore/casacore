...
Quantum<Qtype> sin(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::ANGLE) {
    throw(AipsError("Quantum::sin illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
...
Quantum<Qtype> cos(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::ANGLE) {
    throw(AipsError("Quantum::cos illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> tan(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::ANGLE) {
    throw(AipsError("Quantum::tan illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> asin(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::NODIM) {
    throw(AipsError("Quantum::asin illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> acos(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::NODIM) {
    throw(AipsError("Quantum::acos illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> atan(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::NODIM) {
    throw(AipsError("Quantum::atan illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> atan2(const Quantum<Qtype> &left, const Quantum<Qtype> &other) {
  if ((left.getFullUnit().getValue() != UnitVal::NODIM) ||
    ...
    throw(AipsError("Quantum::atan2 illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  Qtype tmp;
  tmp = other.getBaseValue();
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> log(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::NODIM) {
    throw(AipsError("Quantum::log illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> log10(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::NODIM) {
    throw(AipsError("Quantum::log10 illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
...
Quantum<Qtype> exp(const Quantum<Qtype> &left) {
  if (left.getFullUnit().getValue() != UnitVal::NODIM) {
    throw(AipsError("Quantum::exp illegal unit type '" + left.getUnit() + "'"));
  }
  Quantum<Qtype> res;
  res.setValue(left.getBaseValue());
