...
template <class T>
QVector<T>::QVector() : Quantum<Vector<T>>() {}

template <class T>
QVector<T>::QVector(const Vector<T>& v, const Unit& u) : Quantum<Vector<T>>(v, u) {}
...
template <class T>
size_t QVector<T>::size() const {
  return this->getValue().size();
}

template <class T>
size_t QVector<T>::nelements() const {
  return this->getValue().nelements();
}

template <class T>
void QVector<T>::scale(T d) {
  this->setValue(d * this->getValue());
}

template <class T>
QVector<T> QVector<T>::operator+(const QVector<T>& that) const {
