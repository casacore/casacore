...
const String &UnitDim::dimName(uInt which) {
  static const String Nlist[UnitDim::Dnumber] = {"m",  "kg",  "s",   "A",  "K",
                                                 "cd", "mol", "rad", "sr", "_"};
  return Nlist[which];
}

const String &UnitDim::dimFull(uInt which) {
  static const String Flist[UnitDim::Dnumber] = {"metre",     "kilogram",     "second", "ampere",
                                                 "kelvin",    "candela",      "mole",   "radian",
                                                 "steradian", "undimensioned"};
  return Flist[which];
}
