...
UnitName::UnitName() : basicKind(), basicTag(""), basicName("") {}

UnitName::UnitName(const UnitName &other)
    : basicKind(other.basicKind), basicTag(other.basicTag), basicName(other.basicName) {}

UnitName::UnitName(const String &tag, const UnitVal &kind, const String &name)
    : basicKind(kind), basicTag(tag), basicName(name) {}

UnitName::UnitName(const Unit &tag, const String &name) : basicKind(), basicTag(), basicName(name) {
