...
int main() {
  try {
    ...
    cout << "'k' prefix = " << UnitMap::getPref("k", localName) << " ( " << localName << ")"
         << endl;
    cout << "'K' prefix = " << UnitMap::getPref("K", localName) << " ( " << localName << ")"
         << endl;
    ...
    localVal = UnitVal();
    cout << "'Jy/beam' = " << UnitMap::getCache("Jy/beam", localVal) << " ( " << localVal << ")"
         << endl;
    cout << "'Jy/beam' = " << UnitMap::getCache("Jy/beam", localVal) << " ( " << localVal << ")"
         << endl;
    localVal = UnitVal();
    ...
    cout << "'Jy' = " << UnitMap::getUnit("Jy", localName) << " ( " << localName << ")" << endl;
    cout << "'JY' = " << UnitMap::getUnit("JY", localName) << " ( " << localName << ")" << endl;

    cout << endl << "--------------------------" << endl;
    cout << "Get value and name from a unit name" << endl << endl;

    cout << "Jypb: Value = " << jypb.getVal() << " Name = " << jypb.getName() << endl;
    ...
    cout << "it translates to:         " << UnitMap::fromFITS(Fstr).getName() << endl;
    cout << "or:                       " << Fstr.getValue() << endl;
    Unit Fstr2(UnitMap::fromFITS(Fstr));
    cout << "and back to:              " << UnitMap::toFITS(Fstr2).getName() << endl;
