...
PGPlotter::PGPlotter(const String &device, uInt mincolors, uInt maxcolors, uInt sizex, uInt sizey) {
...
PGPlotter PGPlotter::create(const String &device, uInt mincolors, uInt maxcolors, uInt sizex,
                            uInt sizey) {
  if (creator_p == 0) {
