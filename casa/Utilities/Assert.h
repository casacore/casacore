...
#define AlwaysAssert(expr, exception)                                                             \
  {                                                                                               \
    casacore::assert_<exception>(static_cast<bool>(expr), "Failed AlwaysAssert " #expr, __FILE__, \
                                 static_cast<int>(__LINE__));                                     \
  }
#define AlwaysAssertExit(expr)                                                                  \
  {                                                                                             \
    casacore::assert_<casacore::AbortError>(static_cast<bool>(expr),                            \
                                            "Unrecoverable AlwaysAssertExit: " #expr, __FILE__, \
                                            static_cast<int>(__LINE__));                        \
  }
...
#define DebugAssert(expr, exception)                                                            \
  {                                                                                             \
    casacore::assert_<exception>(static_cast<bool>(expr), "Failed Assertion: " #expr, __FILE__, \
                                 static_cast<int>(__LINE__));                                   \
  }
#define DebugAssertExit(expr)                                                            \
  {                                                                                      \
    casacore::assert_<casacore::AbortError>(static_cast<bool>(expr),                     \
                                            "Unrecoverable Assertion: " #expr, __FILE__, \
                                            static_cast<int>(__LINE__));                 \
  }
