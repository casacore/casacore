...
void objmove(T* to, const T* from, size_t n, size_t toStride, size_t fromStride) {
  ...
  objtestmv(nLeft, startLeft, startRight, to, from, n, toStride, fromStride, to + n * toStride,
            from + n * fromStride, fromMto, toMfrom);
  n -= nLeft;
  if (nLeft) {
