...
inline void ValType::getUndef(DComplex* val) { *val = undefdcomplex; }
...
inline DataType ValType::getType(const DComplex*) { return TpDComplex; }
inline DataType ValType::getType(const String*) { return TpString; }
...
inline const String& ValType::getTypeStr(const DComplex*) { return strdcomplex(); }
inline const String& ValType::getTypeStr(const String*) { return strstring(); }
...
inline void ValType::put(AipsIO& ios, const DComplex* value) { ios << *value; }
...
inline void ValType::get(AipsIO& ios, DComplex* value) { ios >> *value; }
...
inline void ValType::put(ostream& ios, const DComplex* value) { ios << *value; }
...
inline int ValType::isDefined(const String* value, const String* undef) { return *value != *undef; }
inline int ValType::isDefined(const void*, const void*) { return 1; }
