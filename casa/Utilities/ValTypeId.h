...
inline String valDataTypeId(const DComplex* obj) { return ValType::getTypeStr(obj); }
inline String valDataTypeId(const String* obj) { return ValType::getTypeStr(obj); }
inline String valDataTypeId(const TableRecord* obj) { return ValType::getTypeStr(obj); }
