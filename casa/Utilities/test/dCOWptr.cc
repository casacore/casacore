...
int main() {
  ...
  cout << "Modifying array 1 modifies the original array also:" << arr1 << endl;
  cout << "Or accessing it via the COWptr gives the same answer:" << *arrptr << endl;
  ...
  cout << "Array 1 has been modified using COWptr functions:" << *arrptr << endl;
  cout << "But the normally accessed Array 1 is unchanged:" << arr1 << endl;
  cout << "As is the original array:" << arr << endl;
