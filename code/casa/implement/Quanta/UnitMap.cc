...
uShort UnitMap_init::count = 0; 


UnitMap_init::~UnitMap_init() {
    if (--count == 0) {
	UnitMap::mapPref->clear();
	UnitMap::mapDef->clear();
	UnitMap::mapSI->clear();
	UnitMap::mapCust->clear();
	UnitMap::mapUser->clear();
	UnitMap::mapCache->clear();
	delete UnitMap::mapPref;
	delete UnitMap::mapDef;
	delete UnitMap::mapSI;
	delete UnitMap::mapCust;
	delete UnitMap::mapUser;
	delete UnitMap::mapCache;
    }
}
