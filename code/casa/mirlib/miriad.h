/*
    miriad.h: Interface to miriad I/O for miriad library.
...
//               cproto uvio.c hio.c dio.c bug.c pack.c headio.c maskio.c 
//               > miriad.h and edited to please the C++ compiler and the eye:
//
...
//		 cproto -I$MIRINC -p -fARGS hio.c headio.c uvio.c xyio.c
//               xyzio.c bug.c
// 22-jan-97 pjt added key.c
//                (although I can't reproduce rjs's cproto example)
*/

#if !defined(BIMA_MIRIAD_H)
#define BIMA_MIRIAD_H
