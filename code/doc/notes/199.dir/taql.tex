...
\begin{description}
  ...
  \item[ORDERBY sort\_list]
       ...
       DateTime. See \htmlref{below}{TAQL:EXPRESSIONS} for a discussion
...
\\
As explained \htmlref{in the beginning}{TAQL:TABLE_LIST},
keywords from the primary table and from secondary tables can be used. When used
...
\subsection{Array Index Operator}
\label{TAQL:INDEXING}
...
\begin{itemize}
\item
  The TaQL interface in Glish is formed by the \texttt{query}
  function in the script \texttt{table.g}. The function can be used
