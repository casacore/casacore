...
Apart from the aforementioned abilities, TaQL can
...
number of flags set in a measurement set). It could even be used as a
desk calculator.

\section{Syntax}
TaQL contains five commands.
...
key in the ORDERBY clause, in the set in the GIVING clause, or as
a value in the INSERT and UPDATE command.
...
\begin{itemize}
  ...
  \item Add a function INCONE(RA\_column,DEC\_column,RA,DEC,radius)
	to do a cone search in a circle around a position.
