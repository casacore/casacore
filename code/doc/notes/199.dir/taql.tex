...
\item
  ...
  \\Since substitute uses the eval function of glish, care has to
  be taken when used in a function. Eval looks first in the global
  scope and one may get surprised by that. So when using a local function
  variable in substitution, its name should be very specific by e.g.
  giving it a unique prefix.
