...
has a \htmladdnormallink{local patch}{path-to-patch file} applied to it to
enable longtables.  
...
\item bug() (from glish).
\end{enumerate} 
Most \aips2 users will use bug or the cern-wwwgnats interface to submit problem
reports.
\subsection{GNATS}
...
and document titles for \aips2 use..
...
\end{enumerate}
More details on \aips2 mailing lists may be found in the
\htmlref{\aips2 System Manual} {email exploders}.
...
% LocalWords:  betasearch homepages reportbug whatsnew Bridle's
