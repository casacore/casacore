...
\item Propagation of \htmlref{masks}{LEL:PROPMASKS} through an expression.
...
It is fully explained in a \htmlref{later section}{LEL:PROPMASKS}.
...
\begin{description}
  ...
  \item[ \texttt{anytype IIF(Bool, anytype, anytype)}]
    ...
    section about \htmlref{mask propagation}{LEL:PROPMASKS}.
\end{description}
...
\subsection{\label{LEL:PROPMASKS}Mask Propagation}
...
or a mask giving a \htmlref{region}{LEL:REGIONS} in its bounding box.
