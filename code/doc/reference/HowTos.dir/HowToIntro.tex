...
\item[Brian Glendenning (\htmladdnormallink{bglenden@nrao.edu}{mailto:bgleden@nrao.edu})]
Class libraries and coding.
\item[Darrell Schiebel (\htmladdnormallink{drs@nrao.edu}{mailto:drs@nrao.edu})]
Glish programming.
\item[Mark Calabretta (\htmladdnormallink{mcalabre@atnf.csiro.au}{mailto:mcalabre@atnf.csiro.au})]
...
in AIPS++}{../../user/synthesis/synthesis.html}}
under the
...
\htmladdnormallink{"On-line programmer documentation"}{../online/online.html}
...
You may also \htmladdnormallink{search}{../../html/aips2search.html} the
AIPS++ documentation tree from the URL \htmladdnormallink{
http://aips2.nrao.edu/aips++/doc/html/aips2search.html}
