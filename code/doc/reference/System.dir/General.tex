\chapter{General}
\label{General}
\index{general utilities}
\index{utilities -- general}
...
\section{\exe{affirm}}
\label{affirm}
\index{environment -- Boolean value}
\index{general -- Boolean value}
\index{affirm}
...
\index{general - directory creation}
\index{amkdir}
...
\section{\exe{dox}}
\label{dox}
\index{documentation - select and view}
