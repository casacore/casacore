...
\begin{itemize}
\item \htmladdnormallinkfoot{GNU make}{http://www.gnu.org/software/make/make.html}
...
\item \htmladdnormallinkfoot{LAPACK}{http://www.netlib.org/lapack/}
...
\subsection{Updating the Code Repository}
\label{developer release code repository}
\index{developer release!code repository}
