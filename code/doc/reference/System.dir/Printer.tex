...
\section{\exe{lwf\_a}}
\label{lwfa}
\index{PostScript -- filter}
\index{printer -- PostScript filter}
\index{lwf\_a}
...
\section{\exe{pra}}
\label{pra}
\index{C++ -- class printer}
\index{printer -- C++ classes}
\index{pra}
...
on stdout.  If the \code{PRINTER} environment variable is defined \exe{prd}
...
\section{\exe{pri}}
\label{pri}
\index{printer -- ASCII file}
\index{printer -- PostScript file}
\index{ASCII -- print}
\index{PostScript -- print}
\index{pri}
...
\section{\exe{prm}}
\label{prm}
\index{printer -- delete queue entry}
\index{prm}
