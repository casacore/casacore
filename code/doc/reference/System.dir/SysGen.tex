...
\index{compilation -- object libraries}
\index{libraries -- object}
\index{library control variables}
\index{object libraries}
\index{variables -- library control}
...
\index{compilation -- templates}
\index{instantiation -- templates}
\index{specialization -- templates}
\index{system generation -- templates}
...
information is recorded as a one-line entry in the \file{templates} file as
...
\index{makefile.scr}
\index{makefile.tst}
\index{perl scripts -- installation}
