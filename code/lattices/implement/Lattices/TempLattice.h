...
#if defined(_AIX)
#pragma implementation ("TempLattice.cc")
#endif
...
// <summary>A Lattice that can be used for temporary storage</summary>
...
public:
  ...
  virtual void putSlice(const Array<T> & sourceBuffer, const IPosition &
			where);
  // </group>   
...
private:
  CountedPtr<Lattice<T> > theLatticePtr;
};
#endif
