...
data(other.data), ref(other.ref), unit(other.unit) {}

template <class Mv, class Mr>
MeasBase<Mv,Mr> &MeasBase<Mv,Mr>::operator=
(const MeasBase<Mv,Mr> &other) {
    if (this != &other) {
	data = other.data;
	ref = other.ref;
	unit = other.unit;
...
template <class Mv, class Mr>
const void *const MeasBase<Mv,Mr>::getData() const {
    return (void *)&data;
}
