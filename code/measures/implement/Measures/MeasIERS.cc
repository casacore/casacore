...
Int MeasIERS::mjd0[N_Files] = {0, 0};
Int MeasIERS::mjdl[N_Files] = {0, 0};
Double MeasIERS::ldat[2*N_Files][N_Types];
Bool MeasIERS::msgDone = False;
const String MeasIERS::tp[N_Files] = {"IERSeop97", "IERSpredict"};
