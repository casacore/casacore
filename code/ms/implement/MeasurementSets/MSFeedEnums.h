//# NewMSFeedEnums.h: Definitions for the NewMeasurementSet FEED table
...
#if !defined(AIPS_NewMSFEEDENUNewMS_H)
#define AIPS_NewMSFEEDENUNewMS_H

#include <aips/aips.h>

// <use visibility=export>

// <summary> Enums for the NewMeasurementSet FEED table </summary>
// <etymology>
// This class contains the enums for the NewMeasurementSet FEED table
// </etymology>
// <synopsis>
// This class does nothing.  It is merely a container for the enumerations
// used by the NewMSFeed class.  These enumerations define the
