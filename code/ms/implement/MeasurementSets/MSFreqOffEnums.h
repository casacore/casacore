//# NewMSFreqOffsetEnums.h: Defs for the NewMS FREQ_OFFSET table
...
#if !defined(AIPS_NewMSFREQOFFSETENUNewMS_H)
#define AIPS_NewMSFREQOFFSETENUNewMS_H

#include <aips/aips.h>

// <use visibility=export>

// <summary> Enums for the NewMeasurementSet FREQ_OFFSET table </summary>
// <etymology>
// This class contains the enums for the NewMeasurementSet FREQ_OFFSET table
// </etymology>
// <synopsis>
// This class does nothing.  It is merely a container for the enumerations
// used by the NewMSFreqOffset class.  These enumerations define the
