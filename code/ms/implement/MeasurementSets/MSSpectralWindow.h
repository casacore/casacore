//# NewMSSpectralWindow.h: The NewMeasurementSet SPECTRALWINDOW Table
...
#if !defined(AIPS_NewMSSPECTRALWINDOW_H)
#define AIPS_NewMSSPECTRALWINDOW_H

#include <aips/aips.h>
#include <aips/MeasurementSets/NewMSTable.h>
#include <aips/MeasurementSets/NewMSSpWindowEnums.h>

// <summary> 
// A Table intended to hold a NewMeasurementSet SPECTRAL_WINDOW table.
// </summary>
...
//
// <etymology>
// NewMSSpectralWindow stands for the NewMeasurementSet Spectral Window table.
// </etymology>
//
// <synopsis> 
// An NewMSSpectralWindow is a table intended to hold the SPECTRAL_WINDOW table for
...
class NewMSSpectralWindow:public NewMSSpectralWindowEnums,
                  public NewMSTable<NewMSSpectralWindowEnums::PredefinedColumns,
		                 NewMSSpectralWindowEnums::PredefinedKeywords>
{
public:

    // This constructs an empty NewMSSpectralWindow.
    NewMSSpectralWindow ();

    // These constructors mirror the Table ones with additional checking
    // on validity (verifying that the NewMSSpectralWindow will have the required columns
    // and keywords)
    // An exception is thrown if the constructed Table is not a valid NewMSSpectralWindow
    // <thrown>
    //   <li> AipsError
    // </thrown>
    // <group name=tableLikeConstructors>
    NewMSSpectralWindow (const String &tableName, TableOption = Table::Old);
    NewMSSpectralWindow (const String &tableName, const String &tableDescName,
		    TableOption = Table::Old);
    NewMSSpectralWindow (SetupNewTable &newTab, uInt nrrow = 0,
		    Bool initialize = False);
    NewMSSpectralWindow (const Table &table);
    NewMSSpectralWindow (const NewMSSpectralWindow &other);
    // </group>
    ...
    NewMSSpectralWindow& operator=(const NewMSSpectralWindow&);
    ...
    NewMSSpectralWindow referenceCopy(const String& newTableName,
