//# NewMSState.h: The NewMeasurementSet STATE Table
...
#if !defined(AIPS_NewMSSTATE_H)
#define AIPS_NewMSSTATE_H

#include <aips/aips.h>
#include <aips/MeasurementSets/NewMSTable.h>
#include <aips/MeasurementSets/NewMSStateEnums.h>

// <summary> 
// A Table intended to hold a NewMeasurementSet STATE table.
// </summary>
...
//
// <etymology>
// NewMSState stands for the NewMeasurementSet State table.
// </etymology>
//
// <synopsis> 
// An NewMSState is a table intended to hold the STATE table for
...
class NewMSState:public NewMSStateEnums,
                public NewMSTable<NewMSStateEnums::PredefinedColumns,
		               NewMSStateEnums::PredefinedKeywords>
{
public:
    // This constructs an empty NewMSState
    NewMSState ();
    //
    // These constructors mirror the Table ones with additional checking
    // on validity (verifying that the NewMSState will have the required columns
    // and keywords).
    // An exception is thrown if the constructed Table is not a valid NewMSState
    // <thrown>
    //   <li> AipsError
    // </thrown>
    // <group name=tableLikeConstructors>
    NewMSState (const String &tableName, TableOption = Table::Old);
    NewMSState (const String &tableName, const String &tableDescName,
		    TableOption = Table::Old);
    NewMSState (SetupNewTable &newTab, uInt nrrow = 0,
		    Bool initialize = False);
    NewMSState (const Table &table);
    NewMSState (const NewMSState &other);
    // </group>
    ...
    NewMSState& operator=(const NewMSState&);
    ...
    NewMSState referenceCopy(const String& newTableName,
