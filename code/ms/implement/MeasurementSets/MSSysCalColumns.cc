...
{
  if (!isNull()) {
    antennaId_p.attach(msSysCal,NewMSSysCal::columnName(NewMSSysCal::ANTENNA_ID));
    feedId_p.attach(msSysCal,NewMSSysCal::columnName(NewMSSysCal::FEED_ID));
    interval_p.attach(msSysCal,NewMSSysCal::columnName(NewMSSysCal::INTERVAL));
    spectralWindowId_p.attach(msSysCal,NewMSSysCal::columnName(NewMSSysCal::SPECTRAL_WINDOW_ID));
    ...
    intervalQuant_p.attach(msSysCal,NewMSSysCal::columnName(NewMSSysCal::INTERVAL));
    ...
    const String& phaseDiffFlag=NewMSSysCal::columnName(NewMSSysCal::PHASE_DIFF_FLAG);
    if (cds.isDefined(phaseDiffFlag)) phaseDiffFlag_p.attach(msSysCal,phaseDiffFlag);
    ...
    const String& tantSpectrum=NewMSSysCal::columnName(NewMSSysCal::TANT_SPECTRUM);
    ...
    const String& tantTsysFlag=NewMSSysCal::columnName(NewMSSysCal::TANT_TSYS_FLAG);
    if (cds.isDefined(tantTsysFlag)) tantTsysFlag_p.attach(msSysCal,tantTsysFlag);
    const String& tantTsysSpectrum=NewMSSysCal::columnName(NewMSSysCal::TANT_TSYS_SPECTRUM);
    if (cds.isDefined(tantTsysSpectrum)) tantTsysSpectrum_p.attach(msSysCal,tantTsysSpectrum);
    ...
    const String& tcalSpectrum=NewMSSysCal::columnName(NewMSSysCal::TCAL_SPECTRUM);
    ...
    const String& trxSpectrum=NewMSSysCal::columnName(NewMSSysCal::TRX_SPECTRUM);
    ...
    const String& tskySpectrum=NewMSSysCal::columnName(NewMSSysCal::TSKY_SPECTRUM);
    ...
    const String& tsysSpectrum=NewMSSysCal::columnName(NewMSSysCal::TSYS_SPECTRUM);
