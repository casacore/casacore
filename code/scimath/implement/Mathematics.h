...
//         (this class is tagged for an update in the future)
//    <li> <linkto file="Random.h">Random</linkto> numbers in a wide 
//         variety of distributions. 
//    <li> <linkto class="Primes">Prime</linkto> numbers
//    <li> <linkto class="Interp">Interpolation</linkto> in one dimension
//         This class is largely superseded by the 
...
//         <linkto module="Functionals">Functional</linkto> 
//         classes eventually).
// </ol>
// </synopsis>
