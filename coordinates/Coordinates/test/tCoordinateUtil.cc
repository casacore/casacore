...
void test0() {
  ...
  AlwaysAssertExit(CoordinateUtil::findExtendAxes(newAxes, stretchAxes, IPosition(4, 5, 6, 1, 5),
                                                  IPosition(4, 5, 1, 1, 1), csys4, csys4));
  AlwaysAssertExit(newAxes.isEqual(IPosition()));
  AlwaysAssertExit(stretchAxes.isEqual(IPosition(2, 1, 3)));
  AlwaysAssertExit(CoordinateUtil::findExtendAxes(newAxes, stretchAxes, IPosition(3, 5, 6, 3),
                                                  IPosition(2, 5, 6), csys3, csys2));
  AlwaysAssertExit(newAxes.isEqual(IPosition(1, 2)));
  AlwaysAssertExit(stretchAxes.isEqual(IPosition()));
  AlwaysAssertExit(CoordinateUtil::findExtendAxes(newAxes, stretchAxes, IPosition(4, 5, 6, 3, 4),
                                                  IPosition(2, 5, 6), csys4, csys2));
  AlwaysAssertExit(newAxes.isEqual(IPosition(2, 2, 3)));
  AlwaysAssertExit(stretchAxes.isEqual(IPosition()));
  AlwaysAssertExit(CoordinateUtil::findExtendAxes(newAxes, stretchAxes, IPosition(4, 5, 6, 3, 4),
                                                  IPosition(3, 5, 6, 1), csys4, csys3));
  AlwaysAssertExit(newAxes.isEqual(IPosition(1, 2)));
...
void test1() {
  IPosition newAxes, stretchAxes;
  {
    ...
    AlwaysAssertExit(!CoordinateUtil::findExtendAxes(newAxes, stretchAxes, IPosition(2, 5, 6),
                                                     IPosition(1, 8), csys1, csys2));

    CoordinateUtil::addDirAxes(csys2);
    AlwaysAssertExit(CoordinateUtil::findExtendAxes(newAxes, stretchAxes, IPosition(3, 8, 5, 6),
                                                    IPosition(2, 1, 1), csys2, csys1));
...
void test2() {
  ...
  }
  {
    ...
    if (c0 != 0 || cSys.type(c0) != Coordinate::DIRECTION || c1 != 1 ||
        cSys.type(c1) != Coordinate::STOKES) {
  ...
  }
  {
    ...
    if (c0 != 0 || cSys.type(c0) != Coordinate::DIRECTION || c1 != 1 ||
        cSys.type(c1) != Coordinate::STOKES || c2 != 2 || cSys.type(c2) != Coordinate::SPECTRAL) {
  ...
  }
  {
    ...
    if (c0 != 0 || cSys.type(c0) != Coordinate::DIRECTION || c1 != 1 ||
        cSys.type(c1) != Coordinate::SPECTRAL || c2 != 2 || cSys.type(c2) != Coordinate::STOKES) {
