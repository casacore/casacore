...
int main() {
  ...
  oi.setTelescope("telescope")
      .setObserver("observer")
      .setObsDate(MVEpoch(1234.0))
      .setPointingCenter(MVDirection(0.01, 0.02));
  AlwaysAssertExit(oi.telescope() == "telescope" && oi.observer() == "observer" &&
  ...
  AlwaysAssertExit(oi.isTelescopePositionSet());
  MPosition mpos1 = MPosition::Convert(oi.telescopePosition(), MPosition::WGS84)();
  ...
  ObsInfo oi2(oi);
  AlwaysAssertExit(oi2.telescope() == "telescope" && oi2.observer() == "observer" &&
  ...
  oi2a.setTelescope("telescope2")
      ...
      .setPointingCenter(MVDirection(0.03, 0.04));
  oi = oi2a;
  AlwaysAssertExit(oi.telescope() == "telescope2" && oi.observer() == "observer2" &&
  ...
  AlwaysAssertExit(oi3.telescope() == "telescope2" && oi3.observer() == "observer2" &&
  ...
  MPosition mpos3 = MPosition::Convert(oi.telescopePosition(), MPosition::WGS84)();
  ...
  AlwaysAssertExit(near(oi4.obsDate().get("d").getValue(), oi.obsDate().get("d").getValue()));
  AlwaysAssertExit(near(oi4.pointingCenter().get()(0), oi.pointingCenter().get()(0)));
  AlwaysAssertExit(near(oi4.pointingCenter().get()(1), oi.pointingCenter().get()(1)));
  AlwaysAssertExit(oi4.isTelescopePositionSet());
  MPosition mpos = MPosition::Convert(oi4.telescopePosition(), MPosition::WGS84)();
  ...
  AlwaysAssertExit(vs(0) == "telescop" && vs(1) == "observer" && vs(2) == "date-obs" &&
                   vs(3) == "timesys" && vs(4) == "obsra" && vs(5) == "obsdec" &&
                   vs(6) == "obsgeo-x" && vs(7) == "obsgeo-y" && vs(8) == "obsgeo-z");
