  ...
  try {
    ...
    // Test the conversions to and from spectral type
    {
      ...
      if (spcType != SpectralCoordinate::FREQ || !rval)
        throw(
            AipsError(String("Can not convert string 'frequency ' to the correct spectral type!")));
      ...
      if (spcType != SpectralCoordinate::WAVE || !rval)
        throw(
            AipsError(String("Can not convert string 'wavelength' to the correct spectral type!")));
      rval = SpectralCoordinate::stringtoSpecType(spcType, String("air wavelength"));
      if (spcType != SpectralCoordinate::AWAV || !rval)
        throw(AipsError(
            String("Can not convert string 'air wavelength' to the correct spectral type!")));
    }
    ...
    //
    {
      ...
      if (!lc.pixelToVelocity(vel, pix)) {
        throw(
            AipsError(String("pixelToVelocity 1 conversion failed because ") + lc.errorMessage()));
      }
      if (!near(vel, 0.0)) {
      ...
      if (!lc.velocityToPixel(pix2, vel)) {
        throw(
            AipsError(String("velocityToPixel 1 conversion failed because ") + lc.errorMessage()));
      }
      if (!near(pix2, pix)) {
      ...
      if (!lc.pixelToVelocity(vel, pix)) {
        throw(
            AipsError(String("pixelToVelocity 2 conversion failed because ") + lc.errorMessage()));
      }
      if (!near(vel, dVel)) {
      ...
      if (!lc.velocityToPixel(pix2, vel)) {
        throw(
            AipsError(String("velocityToPixel 2 conversion failed because ") + lc.errorMessage()));
      }
      if (!near(pix2, pix)) {
      ...
      if (!lc.pixelToVelocity(velocities, pixels)) {
        throw(
            AipsError(String("pixelToVelocity 3 conversion failed because ") + lc.errorMessage()));
      }
      ...
      if (!lc.velocityToPixel(pixels2, velocities)) {
        throw(
            AipsError(String("velocityToPixel 3 conversion failed because ") + lc.errorMessage()));
      }
      ...
      if (!lc.pixelToVelocity(velQ, pix)) {
        throw(
            AipsError(String("pixelToVelocity 4 conversion failed because ") + lc.errorMessage()));
      }
      ...
      if (!lc.velocityToPixel(pix2, velQ.getValue())) {
        throw(
            AipsError(String("velocityToPixel 4 conversion failed because ") + lc.errorMessage()));
      }
      if (!near(pix2, pix)) {
      ...
      if (!lc.velocityToFrequency(freq, vel)) {
        throw(AipsError(String("velocityToFrequency 1 conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(freq, f0)) {
      ...
      if (!lc.frequencyToVelocity(velocities, frequencies)) {
        throw(AipsError(String("frequencyToVelocity 2 conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(velocities(0), 0.0) || !near(velocities(1), dVel)) {
      ...
      if (!lc.velocityToFrequency(frequencies2, velocities)) {
        throw(AipsError(String("velocityToFrequency 2 conversion failed because ") +
                        lc.errorMessage()));
      }
      ...
      if (!lc.frequencyToVelocity(velocities, frequencies)) {
        throw(AipsError(String("frequencyToVelocity 2b conversion failed because ") +
                        lc.errorMessage()));
      }
      ...
      if (!lc.velocityToFrequency(frequencies2, velocities)) {
        throw(AipsError(String("velocityToFrequency 2b conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(frequencies2(0), frequencies(0)) || !near(frequencies2(1), frequencies(1))) {
      ...
      if (!lc.frequencyToVelocity(velQ, f0 + finc)) {
        throw(AipsError(String("frequencyToVelocity 3 conversion failed because ") +
                        lc.errorMessage()));
      }
      ...
      if (!lc.frequencyToVelocity(velQ, f0)) {
        throw(AipsError(String("frequencyToVelocity 4 conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(velQ.getValue(), 0.0)) {
      ...
      if (!lc.frequencyToVelocity(velQ, f0 + finc)) {
        throw(AipsError(String("frequencyToVelocity 5 conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(velQ.getValue(), dVel)) {
      ...
      if (!lc.frequencyToVelocity(velQ, mf)) {
        throw(AipsError(String("frequencyToVelocity 7 conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(velQ.getValue(), 0.0)) {
      ...
      mf = MFrequency(mvf);
      if (!lc.frequencyToVelocity(velQ, mf)) {
        throw(AipsError(String("frequencyToVelocity 8 conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(velQ.getValue(), dVel)) {
      ...
      if (!lc.frequencyToVelocity(velQ, mvf)) {
        throw(AipsError(String("frequencyToVelocity 9 conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(velQ.getValue(), 0.0)) {
      ...
      if (!lc.wavelengthToFrequency(frequencies2, wavelengths)) {
        throw(AipsError(String("wavelengthToFrequency conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(frequencies2(0), frequencies(0)) || !near(frequencies2(1), frequencies(1))) {
      ...
      lc.setWavelengthUnit(String("m"));
      if (!lc.frequencyToWavelength(wavelengths, frequencies)) {
        throw(AipsError(String("frequencyToWavelength b conversion failed because ") +
                        lc.errorMessage()));
      }
      ...
      if (!lc.wavelengthToFrequency(frequencies2, wavelengths)) {
        throw(AipsError(String("wavelengthToFrequency b conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(frequencies2(0), frequencies(0)) || !near(frequencies2(1), frequencies(1))) {
      ...
      if (!lc.airWavelengthToFrequency(frequencies2, airWavelengths)) {
        throw(AipsError(String("airWavelengthToFrequency conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(frequencies2(0), frequencies(0), 5E-9) ||
          !near(frequencies2(1), frequencies(1), 5E-9)) {
        cout << frequencies2(0) << " " << frequencies(0) << " " << frequencies2(1) << " "
             << frequencies(1) << endl;
      ...
      lc.setWavelengthUnit(String("m"));
      if (!lc.frequencyToAirWavelength(airWavelengths, frequencies)) {
        throw(AipsError(String("frequencyToAirWavelength b conversion failed because ") +
                        lc.errorMessage()));
      }
      ...
      if (!lc.airWavelengthToFrequency(frequencies2, airWavelengths)) {
        throw(AipsError(String("airWavelengthToFrequency b conversion failed because ") +
                        lc.errorMessage()));
      }
      if (!near(frequencies2(0), frequencies(0), 5E-9) ||
          !near(frequencies2(1), frequencies(1), 5E-9)) {
    ...
    }
    {
      ...
      if (!plc->near(lc, 1e-6)) {
        throw(
            AipsError("Non-linear SpectralCoordinate reflection through record interface failed"));
      }
      delete plc;
    }
    //
...
//
{
  {  // on a linear coordinate
    ...
    //
    if (!lc.toWorld(world, pixel)) {
      throw(AipsError(String("toWorld + reference conversion (1) failed because ") +
                      lc.errorMessage()));
    }
    //
    Vector<Double> pixel2;
  ...
  {  // on a non-linear coordinate
    ...
    //
    if (!lc.toWorld(world, pixel)) {
      throw(AipsError(String("toWorld + reference conversion (2) failed because ") +
                      lc.errorMessage()));
    }
    //
    Vector<Double> pixel2;
