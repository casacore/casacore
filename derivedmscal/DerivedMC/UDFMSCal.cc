...
UDFBase* UDFMSCal::makeHA(const String&) { return new UDFMSCal(HA, -1); }
UDFBase* UDFMSCal::makeHA1(const String&) { return new UDFMSCal(HA, 0); }
UDFBase* UDFMSCal::makeHA2(const String&) { return new UDFMSCal(HA, 1); }
UDFBase* UDFMSCal::makeHADEC(const String&) { return new UDFMSCal(HADEC, -1); }
UDFBase* UDFMSCal::makeHADEC1(const String&) { return new UDFMSCal(HADEC, 0); }
UDFBase* UDFMSCal::makeHADEC2(const String&) { return new UDFMSCal(HADEC, 1); }
UDFBase* UDFMSCal::makePA1(const String&) { return new UDFMSCal(PA, 0); }
UDFBase* UDFMSCal::makePA2(const String&) { return new UDFMSCal(PA, 1); }
UDFBase* UDFMSCal::makeLAST(const String&) { return new UDFMSCal(LAST, -1); }
UDFBase* UDFMSCal::makeLAST1(const String&) { return new UDFMSCal(LAST, 0); }
UDFBase* UDFMSCal::makeLAST2(const String&) { return new UDFMSCal(LAST, 1); }
UDFBase* UDFMSCal::makeAZEL(const String&) { return new UDFMSCal(AZEL, -1); }
UDFBase* UDFMSCal::makeAZEL1(const String&) { return new UDFMSCal(AZEL, 0); }
UDFBase* UDFMSCal::makeAZEL2(const String&) { return new UDFMSCal(AZEL, 1); }
UDFBase* UDFMSCal::makeITRF(const String&) { return new UDFMSCal(ITRF, -1); }
UDFBase* UDFMSCal::makeUvwWvl(const String&) { return new UDFMSCal(UVWWVL, -1); }
UDFBase* UDFMSCal::makeUvwWvls(const String&) { return new UDFMSCal(UVWWVLS, -1); }
UDFBase* UDFMSCal::makeUvwJ2000(const String&) { return new UDFMSCal(NEWUVW, 0); }
UDFBase* UDFMSCal::makeWvlJ2000(const String&) { return new UDFMSCal(NEWUVWWVL, 0); }
UDFBase* UDFMSCal::makeWvlsJ2000(const String&) { return new UDFMSCal(NEWUVWWVLS, 0); }
UDFBase* UDFMSCal::makeUvwAPP(const String&) { return new UDFMSCal(NEWUVW, 1); }
UDFBase* UDFMSCal::makeWvlAPP(const String&) { return new UDFMSCal(NEWUVWWVL, 1); }
UDFBase* UDFMSCal::makeWvlsAPP(const String&) { return new UDFMSCal(NEWUVWWVLS, 1); }
UDFBase* UDFMSCal::makeDelay(const String&) { return new UDFMSCal(DELAY, -1); }
UDFBase* UDFMSCal::makeDelay1(const String&) { return new UDFMSCal(DELAY, 0); }
UDFBase* UDFMSCal::makeDelay2(const String&) { return new UDFMSCal(DELAY, 1); }
UDFBase* UDFMSCal::makeStokes(const String&) { return new UDFMSCal(STOKES, -1); }
UDFBase* UDFMSCal::makeBaseline(const String&) { return new UDFMSCal(SELECTION, BASELINE); }
UDFBase* UDFMSCal::makeCorr(const String&) { return new UDFMSCal(SELECTION, CORR); }
UDFBase* UDFMSCal::makeTime(const String&) { return new UDFMSCal(SELECTION, TIME); }
UDFBase* UDFMSCal::makeUVDist(const String&) { return new UDFMSCal(SELECTION, UVDIST); }
UDFBase* UDFMSCal::makeSpw(const String&) { return new UDFMSCal(SELECTION, SPW); }
UDFBase* UDFMSCal::makeField(const String&) { return new UDFMSCal(SELECTION, FIELD); }
UDFBase* UDFMSCal::makeFeed(const String&) { return new UDFMSCal(SELECTION, FEED); }
UDFBase* UDFMSCal::makeArray(const String&) { return new UDFMSCal(SELECTION, ARRAY); }
UDFBase* UDFMSCal::makeScan(const String&) { return new UDFMSCal(SELECTION, SCAN); }
UDFBase* UDFMSCal::makeState(const String&) { return new UDFMSCal(SELECTION, STATE); }
UDFBase* UDFMSCal::makeObs(const String&) { return new UDFMSCal(SELECTION, OBS); }
...
UDFBase* UDFMSCal::makeSubCol(const String& funcName) { return new UDFMSCal(funcName); }
...
void UDFMSCal::setup(const Table& table, const TaQLStyle&) {
  ...
  if (itsType != STOKES && itsType != SELECTION && itsType != GETVALUE && itsType != UVWWVL &&
      itsType != UVWWVLS) {
...
void UDFMSCal::setupDir(TENShPtr& operand) {
  ...
  if (!operand->isConstant()) {
    throw AipsError(
        "Only a constant value can be given as a MSCAL "
        "function argument");
  }
  ...
  if (operand->dataType() == TableExprNodeRep::NTDouble) {
    ...
    throw AipsError(
        "Argument to MSCAL function must be double or "
        "string");
  }
}
...
void UDFMSCal::setupStokes(const Table& table, vector<TENShPtr>& operands) {
  ...
  if (operands.size() == 0 || operands.size() > 3) {
    throw AipsError(
        "1, 2, or 3 arguments must be given to "
        "MSCAL.STOKES");
  }
  ...
  if (operands[0]->valueType() != TableExprNodeRep::VTArray ||
    ...
    throw AipsError(
        "First argument of MSCAL.STOKES must be a "
  ...
  String type = "IQUV";
  if (operands.size() > 1) {
    if (!operands[1]->isConstant() || operands[1]->valueType() != TableExprNodeRep::VTScalar ||
        operands[1]->dataType() != TableExprNodeRep::NTString) {
      throw AipsError(
          "Second argument of MSCAL.STOKES must be a "
...
void UDFMSCal::setupSelection(const Table& table, vector<TENShPtr>& operands) {
  ...
  if (operands[0]->valueType() != TableExprNodeRep::VTScalar ||
      operands[0]->dataType() != TableExprNodeRep::NTString || !operands[0]->isConstant()) {
    throw AipsError(
        "Argument of MSCAL selection must be a "
        "constant string scalar");
  }
  ...
  switch (itsArg) {
    case BASELINE: {
      ...
      try {
        itsDataNode = msAntennaGramParseCommand(anttab, a1, a2, selStr, selectedAnts1,
                                                selectedAnts2, selectedBaselines);
    ...
    case FEED: {
      ...
      try {
        itsDataNode = msFeedGramParseCommand(feedtab, f1, f2, selStr, selectedFeed1, selectedFeed2,
                                             selectedFeedPairs);
      } catch (const std::exception&) {
        MSFeedParse::thisMSFErrorHandler.swap(curHandler);
        throw;
...
void UDFMSCal::setupGetValue(const Table& table, vector<TENShPtr>& operands) {
  int idinx = 0;
  ...
  for (int i = 0; i < idinx; ++i) {
    ...
    if (str.empty()) {
      throw AipsError(
          "An empty subtable name or column name given in "
          "function " +
          itsFuncName);
    }
    if (i == idinx - 1) {
  ...
  if (itsIdColName.empty()) {
    if (operands[idinx]->valueType() != TableExprNodeRep::VTScalar ||
      ...
      throw AipsError("Last argument of function " + itsFuncName + " must be an integer scalar");
    }
