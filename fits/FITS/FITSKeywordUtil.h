...
class FITSKeywordUtil {
 public:
  ...
  // <li> An array field name is too long to hold the name and the index characters.  The name is
  // truncated. <li> Too many rows or columns for a 2D array (first 999 in each are used). <li> Too
