...
LELImageCoord::LELImageCoord(const CoordinateSystem& coordinates, const ImageInfo& imageInfo,
...
LatticeExprNode LELImageCoord::makeSubLattice(const LatticeExprNode& expr,
...
LatticeExprNode LELImageCoord::makeExtendLattice(const LatticeExprNode& expr,
...
LatticeExprNode LELImageCoord::makeRebinLattice(const LatticeExprNode& expr,
  ...
  switch (expr.dataType()) {
    ...
    case TpDComplex:
      return RebinImage<DComplex>(ImageExpr<DComplex>(LatticeExpr<DComplex>(expr), ""), binning);
    default:
