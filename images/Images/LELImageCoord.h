...
class LELImageCoord : public LELLattCoord {
 public:
  ...
  LELImageCoord(const CoordinateSystem& coords, const ImageInfo& imageInfo, const Unit& unit,
  ...
  virtual LatticeExprNode makeExtendLattice(const LatticeExprNode& expr, const IPosition& newShape,
...
inline const CoordinateSystem& LELImageCoord::coordinates() const { return *coords_p; }

inline const ImageInfo& LELImageCoord::imageInfo() const { return imageInfo_p; }

inline const Unit& LELImageCoord::unit() const { return unit_p; }

inline const TableRecord& LELImageCoord::miscInfo() const { return miscInfo_p; }
