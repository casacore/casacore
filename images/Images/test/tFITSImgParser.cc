  ...
  try {
    ...
    if (isdefaultinput) {
      ...
      AlwaysAssert(fitsImg2.is_qualityimg("[IFU1.SCI,IFU1.ERR]"), AipsError)
          ...
          AlwaysAssert(fitsImg2.get_extlist_string(String("<A>"), "", "", False) !=
                           fitsImg2.get_extlist_string(String("<A>"), "", "", True),
                       AipsError);
      ...
      /*
      // this is the full call including a mask image
      fitsImg2.get_quality_data("[IFU1.SCI,IFU1.ERR,IFU1.DQ]", data_HDU, error_HDU, error_type,
      mask_HDU, mask_type, mask_value);
      // check all return values
      ...
      // retrieve all information on an extension expression
      fitsImg2.get_quality_data("[IFU1.SCI,IFU1.ERR]", data_HDU, error_HDU, error_type, mask_HDU,
                                mask_type, mask_value);
      ...
      // retrieve all information on an extension expression
      fitsImg2.get_quality_data("[SCIEXT]", data_HDU, error_HDU, error_type, mask_HDU, mask_type,
                                mask_value);
      ...
      // retrieve all information on an extension expression
      fitsImg3.get_quality_data("[IFU1.SCI,IFU1.ERR,IFU1.DQ]", data_HDU, error_HDU, error_type,
      mask_HDU, mask_type, mask_value);
      ...
      /* this would be the full call, including mask images
      // retrieve all information on an extension expression
      fitsImg4.get_quality_data("[IFU1.SCI,IFU1.ERR,IFU1.DQ]", data_HDU, error_HDU, error_type,
      mask_HDU, mask_type, mask_value);
