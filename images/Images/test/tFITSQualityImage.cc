  ...
  try {
...

    {
      ...
      if (!FITSQualityImage::qualFITSInfo(error, dataInfo, errorInfo, miscInfo)) {
        String msg =
            String("General problem to define the miscInfo for the data and error extension!");
        throw(AipsError(msg));
      }
...

    {
      ...
      if (!FITSQualityImage::qualFITSInfo(error, dataInfo, errorInfo, miscInfo)) {
        String msg = String(
            "General problem to define the miscInfo for the data and error extension: " + error);
        throw(AipsError(msg));
      }
