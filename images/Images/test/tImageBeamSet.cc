  ...
  try {
    ...
    }
    {
      ...
      }
      {
        ...
        GaussianBeam beam0(Quantity(4, "arcsec"), Quantity(3, "arcsec"), Quantity(20, "deg"));
        GaussianBeam beam1(Quantity(8, "arcsec"), Quantity(6, "arcsec"), Quantity(10, "deg"));
        GaussianBeam beam2(Quantity(5, "arcsec"), Quantity(4, "arcsec"), Quantity(20, "deg"));
        ImageBeamSet x00;
        ImageBeamSet x34(3, 4, beam0);
        x34.setBeam(1, 2, beam2);
        ImageBeamSet x14(1, 4, beam0);
        x14.setBeam(0, 1, beam2);
        ImageBeamSet x31(3, 1, beam0);
        x31.setBeam(1, 0, beam2);
...

      {
        ...
        GaussianBeam init(Quantity(4, "arcsec"), Quantity(2, "arcsec"), Quantity(0, "deg"));
        ImageBeamSet x(3, 4, init);
        AlwaysAssert(x.getMaxAreaBeam() == init, AipsError);
        AlwaysAssert(x.getMinAreaBeam() == init, AipsError);
        GaussianBeam maxBeam(Quantity(10, "arcsec"), Quantity(8, "arcsec"), Quantity(0, "deg"));
        GaussianBeam minBeam(Quantity(1, "arcsec"), Quantity(1, "arcsec"), Quantity(0, "deg"));
      ...
      }
      {
        ...
        GaussianBeam beam2(Quantity(10, "arcsec"), Quantity(5, "arcsec"), Quantity(70, "deg"));
        GaussianBeam beam3(Quantity(11, "arcsec"), Quantity(5, "arcsec"), Quantity(70, "deg"));
    ...
    }
    {
      ...
      IPosition pos;
      AlwaysAssert(beamSet.getMaxAreaBeamForPol(pos, 1) == GaussianBeam::NULL_BEAM, AipsError);
      ...
      GaussianBeam beam1(Quantity(5, "arcsec"), Quantity(3, "arcsec"), Quantity(20, "deg"));
    ...
    }
    {
      ...
      GaussianBeam beam(Quantity(4, "arcsec"), Quantity(3, "arcsec"), Quantity(40, "deg"));
      GaussianBeam beam2(Quantity(4, "arcsec"), Quantity(3, "arcsec"), Quantity(40, "deg"));
      GaussianBeam beam3(Quantity(5, "arcsec"), Quantity(3, "arcsec"), Quantity(40, "deg"));
      {
        ImageBeamSet set1;
        ImageBeamSet set2;
    ...
    }
    {
      ...
      GaussianBeam beam1(Quantity(4, "arcsec"), Quantity(2, "arcsec"), Quantity(0, "deg"));
      GaussianBeam beam2(Quantity(4, "arcsec"), Quantity(2, "arcsec"), Quantity(20, "deg"));
      GaussianBeam beam3(Quantity(4, "arcsec"), Quantity(2, "arcsec"), Quantity(40, "deg"));
      GaussianBeam beam4(Quantity(4, "arcsec"), Quantity(2, "arcsec"), Quantity(60, "deg"));
      beams(0, 0) = beam1;
      beams(0, 1) = beam2;
      beams(0, 2) = beam3;
      beams(0, 3) = beam4;
      ...
      AlwaysAssert(gotSet.nchan() == beamSet.nchan() && gotSet.nstokes() == beamSet.nstokes() &&
    ...
    }
    {
      ...
      for (uint i = 0; i < 3; ++i) {
        for (uint j = 0; j < 2; ++j) {
          AlwaysAssert(areas_as2(i, j) == beams.getBeam(i, j).getArea("arcsec2"), AipsError);
        }
      }
    }
    {
      ...
      for (uint i = 0; i < 3; ++i) {
        for (uint j = 0; j < 2; ++j) {
          ...
          AlwaysAssert(majors(i, j) == beam.getMajor(mUnit), AipsError);
