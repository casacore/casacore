...
int main() {
  try {
...

    {
      ...
      PagedImage<Float> ml3(shape2, CoordinateUtil::defaultCoords2D(), "tImageConcat_tmp3.img");
      //
      ...
      PagedImage<Float> ml4(outShape, CoordinateUtil::defaultCoords2D(), "tImageConcat_tmp4.img");
...

    {
      ...
      GaussianBeam gbeam1(Quantity(12, "arcsec"), Quantity(5, "arcsec"), Quantity(75, "deg"));
      ...
      GaussianBeam gbeam2a(Quantity(12, "arcsec"), Quantity(5, "arcsec"), Quantity(75, "deg"));
      GaussianBeam gbeam2b(Quantity(13, "arcsec"), Quantity(6, "arcsec"), Quantity(76, "deg"));
      GaussianBeam gbeam2c(Quantity(14, "arcsec"), Quantity(7, "arcsec"), Quantity(77, "deg"));
      ImageBeamSet bset2(10, 1);
      for (uInt i = 0; i < 10; ++i) {
        bset2.setBeam(i, 0,
                      GaussianBeam(Quantity(i + 5, "arcsec"), Quantity(i + 1, "arcsec"),
                                   Quantity(i + 60, "deg")));
      }
      ImageInfo in2;
      in2.setBeams(bset2);
    ...
    }
    {
      ...
      ii.setAllBeams(
          8, 1, GaussianBeam(Quantity(4, "arcsec"), Quantity(3, "arcsec"), Quantity(0, "deg")));
      i0.setImageInfo(ii);
    ...
    }
    {
      ...
      SubImage<Float> s0(i0, Slicer(IPosition(4, 0), IPosition(4, 4, 4, 0, 4), Slicer::endIsLast));
      SubImage<Float> s1(
          i0, Slicer(IPosition(4, 0, 0, 2, 0), IPosition(4, 4, 4, 2, 4), Slicer::endIsLast));
    ...
    }
    {
      ...
      CoordinateSystem csys = CoordinateUtil::defaultCoords4D();
      TempImage<Float> i0(TiledShape(IPosition(4, 5, 5, 4, 5)), csys);
      SubImage<Float> s0(i0, Slicer(IPosition(4, 0), IPosition(4, 4, 4, 3, 0), Slicer::endIsLast));
      SubImage<Float> s1(
          i0, Slicer(IPosition(4, 0, 0, 0, 1), IPosition(4, 4, 4, 3, 1), Slicer::endIsLast));
      SubImage<Float> s3(
      ...
      cout << "spec values " << std::setprecision(10)
           << concat.coordinates().spectralCoordinate().worldValues() << endl;
      AlwaysAssert(concat.coordinates().toWorld(v2)[3] == s3.coordinates().toWorld(v0)[3],
                   AipsError);
    }
...
void testLogger() {
  ...
  ImageConcat<Float> lc2(0, True);
  {
    ...
    PagedImage<Float> im1(shape, CoordinateUtil::defaultCoords2D(), "tImageConcat_tmp1.imga");
