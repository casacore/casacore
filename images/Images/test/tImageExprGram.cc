...
void makeRegionBlock(Block<const ImageRegion*>& regions, const Record&, LogIO&) {
...
int main(int argc, const char* argv[]) {
  ...
  try {
    ...
    }
    {
      ...
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      Double result = 1.0;
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("$1 + ($2 + $3)[$R1]", temps, regions));
      delete regions[0];
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(
          ImageExprParse::command("nelements(b[$R1 || $R2]) - "
                                  "length(b[$R1],0)",
                                  temps, regions));
      cout << "Images used: " << ImageExprParse::getImageNames() << endl;
      delete regions[0];
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(
          ImageExprParse::command("(3.5*b) + (cos('c')) - (10/min('c',d)*(-e)*log(b)) - (pi()) "));
      cout << "Images used: " << ImageExprParse::getImageNames() << endl;
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      Double result = 3.5 * bVal + cos(cVal) - 10 / min(cVal, dVal) * -eVal * log(bVal) - M_PI;
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(
          ImageExprParse::command("sum(e)/nelements(b) + min('c') + max('c', mean('c'+d))"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("sum(e[bBool])"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("sum((e + sum(f[b>0]*c)/d)[!bBool])"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("median(b)"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      Double result = bVal;
      if (!allNear(aArr, result, 1e-10)) {
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("fractile(b,0.2)"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      Double result = bVal;
      if (!allNear(aArr, result, 1e-10)) {
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("fractilerange(b,0.2)"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      Double result = 0.0;
      if (!allNear(aArr, result, 1e-10)) {
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("fractilerange(b,0.2,0.6)"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      Double result = 0.0;
      if (!allNear(aArr, result, 1e-10)) {
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("b+sum(kpa[indexin(0,[0:1,7,3:6:2])])"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      if (shape(0) > 7) {
        Int n = shape(1);
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(
          ImageExprParse::command("b+sum(kpa[indexnotin(1,[0:1,9,3:6:3,9])])"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      if (shape(1) > 9) {
        Int n = shape(0);
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(ImageExprParse::command("b+sum(kpa[index1 in [0:1,9,3:6:3,9]])"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      if (shape(1) > 9) {
        Int n = shape(0);
    ...
    }
    {
      ...
      LatticeExpr<Double> expr(
          ImageExprParse::command("b+sum(kpa[index1 not in [0:1,9,3:6:3,9]])"));
      a.copyData(expr);
      a.getSlice(aArr, IPosition(aArr.ndim(), 0), shape, IPosition(aArr.ndim(), 1));
      if (shape(1) > 9) {
        Int n = shape(0);
