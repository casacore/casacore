// # AipsIOReaderWriter.h: Implementation for reading/writing CASA AipsIO region files produced by
// the viewer. # Copyright (C) 2008 # Associated Universities, Inc. Washington DC, USA.
// #
