...
class ImageRegion : public LattRegionHolder {
 public:
  ...
  static ImageRegion* fromRecord(LogIO* logger, const CoordinateSystem& coords,
...
inline const LCRegion& ImageRegion::asLCRegion() const { return *asLCRegionPtr(); }

inline const LCSlicer& ImageRegion::asLCSlicer() const { return *asLCSlicerPtr(); }

inline const WCRegion& ImageRegion::asWCRegion() const { return *asWCRegionPtr(); }
