...
RFError::RFError(const String& error, bool isFatal) : error_p(error), fatal_p(isFatal) {}
...
void RFReaderWriter::setFile(const String& filename) { pFilename_p = new String(filename.c_str()); }

void RFReaderWriter::setName(const String& regionName) { pRegionName_p = new String(regionName); }
