...
WCRegion* WCComplement::cloneRegion() const { return new WCComplement(*this); }

LCRegion* WCComplement::doToLCRegion(const CoordinateSystem& cSys, const IPosition& shape,
...
String WCComplement::type() const { return className(); }
