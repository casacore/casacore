...
class WCCompound : public WCRegion {
 ...
 protected:
  ...
  // system and shape.
  void multiToLCRegion(Block<const LCRegion*>& regions, const CoordinateSystem& cSys,
...
inline const Block<const WCRegion*>& WCCompound::regions() const { return itsRegions; }
