...
WCConcatenation::WCConcatenation(const Block<const ImageRegion*>& regions, const WCBox& extendBox)
    : WCCompound(regions), itsExtendBox(extendBox) {
  fill();
}
...
WCConcatenation::WCConcatenation(const WCConcatenation& other)
    : WCCompound(other), itsExtendBox(other.itsExtendBox) {}
...
WCRegion* WCConcatenation::cloneRegion() const { return new WCConcatenation(*this); }
...
String WCConcatenation::className() { return "WCConcatenation"; }

String WCConcatenation::type() const { return className(); }
...
WCConcatenation* WCConcatenation::fromRecord(const TableRecord& rec, const String& tableName) {
