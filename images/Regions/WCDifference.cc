...
WCDifference::WCDifference(const ImageRegion& region1, const ImageRegion& region2)
...
LCRegion* WCDifference::doToLCRegion(const CoordinateSystem& cSys, const IPosition& shape,
...
String WCDifference::type() const { return className(); }
