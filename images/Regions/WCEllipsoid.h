...
class WCEllipsoid : public WCRegion {
 public:
  ...
  WCEllipsoid(const Vector<Quantity>& center, const Vector<Quantity>& radii,
  ...
  WCEllipsoid(const Vector<Quantity>& center, const Quantity& radius, const IPosition& pixelAxes,
              const CoordinateSystem& cSys, const RegionType::AbsRelType absRel = RegionType::Abs);
  ...
  LCRegion* doToLCRegion(const CoordinateSystem& csys, const IPosition& latticeShape,
