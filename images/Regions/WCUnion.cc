...
WCUnion::WCUnion(const ImageRegion& region1, const ImageRegion& region2)
    : WCCompound(region1, region2) {}

WCUnion::WCUnion(const ImageRegion* region1, const ImageRegion* region2, const ImageRegion* region3,
                 const ImageRegion* region4, const ImageRegion* region5, const ImageRegion* region6,
                 const ImageRegion* region7, const ImageRegion* region8, const ImageRegion* region9,
                 const ImageRegion* region10)
    : WCCompound(region1, region2, region3, region4, region5, region6, region7, region8, region9,
                 region10) {}
...
LCRegion* WCUnion::doToLCRegion(const CoordinateSystem& cSys, const IPosition& shape,
...
String WCUnion::type() const { return className(); }
