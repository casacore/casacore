...
LELCoordinates::LELCoordinates(LELLattCoordBase* coordinates) : coords_p(coordinates) {}

// Copy constructor
LELCoordinates::LELCoordinates(const LELCoordinates& other) : coords_p(other.coords_p) {}
