...
LELFunctionFloat::LELFunctionFloat(const LELFunctionEnums::Function function,
  ...
  switch (function_p) {
    ...
    case LELFunctionEnums::LENGTH: {
      ...
      if (!(exp[1].isScalar() && (exp[1].dataType() == TpFloat || exp[1].dataType() == TpDouble))) {
        throw(
            AipsError("LELFunctionFloat::constructor - "
...
void LELFunctionFloat::eval(LELArray<Float>& result, const Slicer& section) const {
  ...
  if (arg_p.nelements() == 1) {
    switch (function_p) {
      ...
      default:
        throw(
            AipsError("LELFunctionFloat::eval - "
                      "unknown Float function"));
    }
  } else {
    if (arg_p[0].isScalar()) {
...
void LELFunctionDouble::eval(LELArray<Double>& result, const Slicer& section) const {
  ...
  if (arg_p.nelements() == 1) {
    switch (function_p) {
      ...
      default:
        throw(
            AipsError("LELFunctionDouble::eval - "
                      "unknown Double function"));
    }
  } else {
    if (arg_p[0].isScalar()) {
...
// LELFunctionComplex
LELFunctionComplex::LELFunctionComplex(const LELFunctionEnums::Function function,
                                       const Block<LatticeExprNode>& exp)
    : function_p(function) {
  switch (function_p) {
    case LELFunctionEnums::CONJ: {
      ...
      if (exp.nelements() != 1) {
        throw(
            AipsError("LELFunctionComplex::constructor - "
                      "function can only have one argument"));
      }
      setAttr(exp[0].getAttribute());
      break;
...
void LELFunctionComplex::eval(LELArray<Complex>& result, const Slicer& section) const {
#if defined(AIPS_TRACE)
  ...
  if (arg_p.nelements() == 1) {
    switch (function_p) {
      ...
      default:
        throw(
            AipsError("LELFunctionComplex::eval - "
                      "unknown Complex function"));
    }
...
// LELFunctionDComplex
LELFunctionDComplex::LELFunctionDComplex(const LELFunctionEnums::Function function,
                                         const Block<LatticeExprNode>& exp)
    : function_p(function) {
  switch (function_p) {
    case LELFunctionEnums::CONJ: {
      ...
      if (exp.nelements() != 1) {
        throw(
            AipsError("LELFunctionDComplex::constructor - "
...
void LELFunctionDComplex::eval(LELArray<DComplex>& result, const Slicer& section) const {
#if defined(AIPS_TRACE)
  ...
  if (arg_p.nelements() == 1) {
    switch (function_p) {
      ...
      default:
        throw(
            AipsError("LELFunctionDComplex::eval - "
                      "unknown Complex function"));
    }
...
LELFunctionBool::LELFunctionBool(const LELFunctionEnums::Function function,
  ...
  switch (function_p) {
    case LELFunctionEnums::ISNAN: {
      if (exp.nelements() != 1) {
        throw(
            AipsError("LELFunctionBool::constructor - "
                      "function can only have one argument"));
      }
    ...
    case LELFunctionEnums::INDEXIN: {
      ...
      if (!(exp[0].isScalar() && (exp[0].dataType() == TpFloat || exp[0].dataType() == TpDouble))) {
        throw(
            AipsError("LELFunctionBool::constructor - "
      ...
      if (exp[1].isScalar() || exp[1].dataType() != TpBool || exp[1].shape().nelements() != 1) {
        throw(
            AipsError("LELFunctionBool::constructor - "
