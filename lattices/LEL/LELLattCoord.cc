...
LatticeExprNode LELLattCoord::makeExtendLattice(const LatticeExprNode&, const IPosition&,
...
LatticeExprNode LELLattCoord::makeRebinLattice(const LatticeExprNode& expr,
