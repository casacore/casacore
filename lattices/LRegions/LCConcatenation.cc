...
String LCConcatenation::className() { return "LCConcatenation"; }

String LCConcatenation::type() const { return className(); }
...
LCConcatenation* LCConcatenation::fromRecord(const TableRecord& rec, const String& tableName) {
  Block<const LCRegion*> regions;
