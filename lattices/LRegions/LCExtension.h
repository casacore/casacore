...
inline const LCRegion& LCExtension::region() const { return *(regions()[0]); }
inline const IPosition& LCExtension::extendAxes() const { return itsExtendAxes; }
inline const LCBox& LCExtension::extendBox() const { return itsExtendBox; }
