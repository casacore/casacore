...
LCHDF5Mask::LCHDF5Mask(const TiledShape& latticeShape, const std::shared_ptr<HDF5File>& file,
...
LCHDF5Mask::LCHDF5Mask(const TiledShape& maskShape, const LCBox& box,
  ...
  if (itsBox.shape() != maskShape.shape()) {
    throw(
        AipsError("LCHDF5Mask::LCHDF5Mask- "
...
String LCHDF5Mask::type() const { return className(); }
