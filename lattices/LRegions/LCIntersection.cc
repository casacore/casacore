...
LCIntersection::LCIntersection(const LCRegion& region1, const LCRegion& region2)
...
LCIntersection::LCIntersection(Bool takeOver, const LCRegion* region1, const LCRegion* region2,
    ...
    : LCRegionMulti(takeOver, region1, region2, region3, region4, region5, region6, region7,
...
LCIntersection::LCIntersection(const LCIntersection& other)
    : LCRegionMulti(other), itsOffsets(other.itsOffsets) {}
...
String LCIntersection::type() const { return className(); }
