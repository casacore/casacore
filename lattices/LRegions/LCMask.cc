...
void LCMask::setCacheSizeFromPath(const IPosition& sliceShape, const IPosition& windowStart,
...
void LCMask::tempClose() { itsMask->tempClose(); }
...
String LCMask::type() const { return className(); }
