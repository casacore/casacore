...
LCRegion* LCStretch::doTranslate(const Vector<Float>& translateVector,
  ...
  LCBox* boxPtr = dynamic_cast<LCBox*>(itsStretchBox.translate(boxTransVec, boxLatShape));
...
String LCStretch::className() { return "LCStretch"; }

String LCStretch::type() const { return className(); }
