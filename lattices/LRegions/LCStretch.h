...
class LCStretch : public LCRegionMulti {
 public:
  ...
  LCStretch(Bool takeOver, const LCRegion* region, const IPosition& stretchAxes,
...
inline const LCRegion& LCStretch::region() const { return *(regions()[0]); }
inline const IPosition& LCStretch::stretchAxes() const { return itsStretchAxes; }
inline const LCBox& LCStretch::stretchBox() const { return itsStretchBox; }
