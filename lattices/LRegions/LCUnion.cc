...
LCUnion::LCUnion(const LCRegion& region1, const LCRegion& region2)
...
LCUnion::LCUnion(const LCUnion& other) : LCRegionMulti(other) {}
...
String LCUnion::type() const { return className(); }
