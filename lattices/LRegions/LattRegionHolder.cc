...
LattRegionHolder* LattRegionHolder::makeUnion(const LattRegionHolder& other) const {
  return new LattRegionHolder(new LCUnion(*asLCRegionPtr(), *other.asLCRegionPtr()));
}
LattRegionHolder* LattRegionHolder::makeIntersection(const LattRegionHolder& other) const {
  return new LattRegionHolder(new LCIntersection(*asLCRegionPtr(), *other.asLCRegionPtr()));
}
LattRegionHolder* LattRegionHolder::makeDifference(const LattRegionHolder& other) const {
  return new LattRegionHolder(new LCDifference(*asLCRegionPtr(), *other.asLCRegionPtr()));
}
LattRegionHolder* LattRegionHolder::makeComplement() const {
  return new LattRegionHolder(new LCComplement(*asLCRegionPtr()));
}
