  ...
  try {
    {
      ...
      LCPixelSet mask(arr, LCBox(IPosition(2, 0), latticeShape - 1, latticeShape));
    ...
    }
    {
      ...
      LCPixelSet mask(arr, LCBox(IPosition(4, 0), latticeShape - 1, latticeShape));
    ...
    }
    {
      ...
      LCPixelSet mask1(arr, LCBox(IPosition(2, 0), latticeShape - 1, latticeShape));
      LCPixelSet mask2(mask1);
      AlwaysAssertExit(mask2 == mask1);
      arr(latticeShape - 1) = True;
      LCPixelSet mask3(arr, LCBox(IPosition(2, 0), latticeShape - 1, latticeShape));
