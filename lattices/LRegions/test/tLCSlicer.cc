...
void doIt() {
  ...
  // trc to shape).
  {
    LCSlicer sl1(IPosition(3, 5, 8, 3), IPosition(3, 10, 20, 30), IPosition(1, 2));
    AlwaysAssertExit(sl1.isComplete());
    AlwaysAssertExit(sl1.isAbsolute());
    AlwaysAssertExit(!sl1.isFractional());
    AlwaysAssertExit(sl1.isStrided());
  ...
  {
    LCSlicer sl1(IPosition(3, 5, 8, 3), IPosition(1, 10), IPosition(1, 2));
    AlwaysAssertExit(!sl1.isComplete());
    AlwaysAssertExit(sl1.isAbsolute());
    AlwaysAssertExit(!sl1.isFractional());
    AlwaysAssertExit(sl1.isStrided());
  ...
  {
    LCSlicer sl1(IPosition(3, 5, 8, 3), IPosition(1, 10), IPosition(1, 2), RegionType::RelRef);
    AlwaysAssertExit(!sl1.isComplete());
    AlwaysAssertExit(!sl1.isAbsolute());
    AlwaysAssertExit(!sl1.isFractional());
    AlwaysAssertExit(sl1.isStrided());
  ...
  {
    LCSlicer sl1(IPosition(3, 5, 8, 3), IPosition(1, 10), IPosition(1, 2), RegionType::RelCen);
    AlwaysAssertExit(!sl1.isComplete());
    AlwaysAssertExit(!sl1.isAbsolute());
    AlwaysAssertExit(!sl1.isFractional());
    AlwaysAssertExit(sl1.isStrided());
