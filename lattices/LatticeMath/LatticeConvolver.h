...
class LatticeConvolver {
 public:
  ...
  LatticeConvolver(const Lattice<T>& psf, const IPosition& modelShape, ConvEnums::ConvType type,
                   Bool doFast = False);
 ...
 private:
  ...
  static IPosition calcFFTShape(const IPosition& psfShape, const IPosition& modelShape,
