// # LatticeMathUtil.cc: defines the Lattice Utilities global functions//# Copyright (C)
// 1995,1996,1997,1999,2000,2001,2002,2003,2004 # Associated Universities, Inc. Washington DC, USA.
// #
...
template <class T>
void minMax(T& globalMin, T& globalMax, IPosition& globalMinPos, IPosition& globalMaxPos,
            const Lattice<T>& lat) {
