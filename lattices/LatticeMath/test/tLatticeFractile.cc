...
int main(int argc, const char* argv[]) {
  try {
...

    {
      ...
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.5, 0.5, 16) << endl;
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.5, 0.5, 4) << endl;
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.5, 0.5, 2) << endl;
      ...
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.40, 0.55, 2) << endl;
      cout << LatticeFractile<Float>::maskedFractiles(expr, 0.4, 0.45) << endl;
      cout << LatticeFractile<Float>::maskedFractiles(expr, 0.4, 0.45, 2) << endl;
    }

    {
      ...
      cout << LatticeFractile<Float>::maskedFractiles(expr, 0.40, 0.55, 2) << endl;
    }

    {
      ...
      cout << LatticeFractile<Float>::maskedFractiles(expr, 0.5, 0.5, 2) << endl;
    }
    ...
    cout << ">>>" << endl;
    {
      ...
      Timer timer;
      timer.mark();
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.2, 0.8, 512 * 512) << endl;
      timer.show("ArrayLattice  20% fractiles");
      timer.mark();
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.2, 0.8, 1280) << endl;
...

    {
      ...
      timer.mark();
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.2, 0.8, 4) << endl;
...

    {
      ...
      timer.mark();
      cout << LatticeFractile<Float>::unmaskedFractiles(aF, 0.5, 0.5, 1280 * 25) << endl;
