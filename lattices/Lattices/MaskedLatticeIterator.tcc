...
template <class T>
RO_MaskedLatticeIterator<T>::RO_MaskedLatticeIterator(const RO_MaskedLatticeIterator<T>& other)
    : RO_LatticeIterator<T>(other),
      itsMaskLattShrPtr(other.itsMaskLattShrPtr),
      itsMaskLattPtr(other.itsMaskLattPtr) {}

template <class T>
RO_MaskedLatticeIterator<T>::RO_MaskedLatticeIterator(const RO_LatticeIterator<T>& other,
