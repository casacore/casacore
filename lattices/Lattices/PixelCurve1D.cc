...
PixelCurve1D::PixelCurve1D(double x1, double y1, double x2, double y2, uInt npoints) {
...
PixelCurve1D::PixelCurve1D(const Function1D<float, float>& func, float x1, float x2, uInt npoints) {
...
PixelCurve1D::PixelCurve1D(const Vector<Int>& x, const Vector<Int>& y, uInt npoints) {
...
PixelCurve1D::PixelCurve1D(const Vector<float>& x, const Vector<float>& y, uInt npoints) {
  Vector<double> xd(x.nelements());
  convertArray(xd, x);
  Vector<double> yd(y.nelements());
  convertArray(yd, y);
...
PixelCurve1D::PixelCurve1D(const Vector<double>& x, const Vector<double>& y, uInt npoints) {
  init(x, y, npoints);
}

PixelCurve1D::PixelCurve1D(const PixelCurve1D& that) { operator=(that); }
...
void PixelCurve1D::init(const Vector<double>& x, const Vector<double>& y, uInt npoints) {
...
void PixelCurve1D::getPixelCoord(Vector<float>& x, Vector<float>& y, uInt start, uInt end,
                                 uInt incr) const {
