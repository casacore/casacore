...
template <class T>
void TempLattice<T>::doPutSlice(const Array<T>& sourceBuffer, const IPosition& where,
...
template <class T>
void TempLattice<T>::setCacheSizeFromPath(const IPosition& sliceShape, const IPosition& windowStart,
                                          const IPosition& windowLength,
                                          const IPosition& axisPath) {
  itsImpl->setCacheSizeFromPath(sliceShape, windowStart, windowLength, axisPath);
}
