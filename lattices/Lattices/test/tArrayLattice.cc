...
int main() {
  try {
    ...
    AlwaysAssert(al6ROIter.endPosition() == IPosition(4, 0, 0, 6, 0), AipsError);
    ...
    // Function which returns the end of the cursor (i.e. the cursor position
    // plus the cursor shape.)
    AlwaysAssert(al6Iter.endPosition() == IPosition(4, 4, 5, 0, 0), AipsError);
            ...
            if (l != k && l != j && l != i) {
              if (k != j && k != i) {
                if (j != i) {
                  ...
                  tester(2) = 0;
                  tester(3) = 0;
                  AlwaysAssert(allEQ(niyiter.vectorCursor(), tester), AipsError);
                  ...
                  tester(2) = 24;
                  AlwaysAssert(allEQ(niziter.vectorCursor(), tester), AipsError);
                  ...
                  tester(3) = 0;
                  tester(4) = 0;
                  AlwaysAssert(allEQ(nititer.vectorCursor(), tester), AipsError);
                  ...
                  AlwaysAssert(allEQ(xyiter.matrixCursor(), 24), AipsError);
                  ...
                  AlwaysAssert(allEQ(xziter.matrixCursor(), 24), AipsError);
                  ...
                  AlwaysAssert(allEQ(xtiter.matrixCursor(), 24), AipsError);
                  ...
                  AlwaysAssert(allEQ(yziter.matrixCursor(), 24), AipsError);
                  ...
                  AlwaysAssert(allEQ(ytiter.matrixCursor(), 24), AipsError);
                  ...
                  AlwaysAssert(allEQ(ztiter.matrixCursor(), 24), AipsError);
                  ...
                  test.column(2) = 0;
                  test.column(3) = 0;
                  AlwaysAssert(allEQ(ni2xyiter.matrixCursor(), test), AipsError);
                  ...
                  test.column(2) = 0;
                  test.column(3) = 0;
                  AlwaysAssert(allEQ(ni3xyiter.matrixCursor(), test), AipsError);
                  ...
                  test.set(24);
                  test.row(2) = 0;
                  AlwaysAssert(allEQ(nixziter.matrixCursor(), test), AipsError);
                  ...
                  test.set(24);
                  test.column(3) = 0;
                  AlwaysAssert(allEQ(ni2xziter.matrixCursor(), test), AipsError);
                  ...
                  test.row(2) = 0;
                  test.column(3) = 0;
                  AlwaysAssert(allEQ(ni3xziter.matrixCursor(), test), AipsError);
                  ...
                  test.set(24);
                  test.row(2) = 0;
                  AlwaysAssert(allEQ(nixtiter.matrixCursor(), test), AipsError);
                  ...
                  test.column(3) = 0;
                  test.column(4) = 0;
                  AlwaysAssert(allEQ(ni2xtiter.matrixCursor(), test), AipsError);
                  ...
                  test.column(3) = 0;
                  test.column(4) = 0;
                  AlwaysAssert(allEQ(ni3xtiter.matrixCursor(), test), AipsError);
                  ...
                  test.row(2) = 0;
                  test.row(3) = 0;
                  AlwaysAssert(allEQ(niyziter.matrixCursor(), test), AipsError);
                  ...
                  test.set(24);
                  test.column(3) = 0;
                  AlwaysAssert(allEQ(ni2yziter.matrixCursor(), test), AipsError);
                  ...
                  test.row(3) = 0;
                  test.column(3) = 0;
                  AlwaysAssert(allEQ(ni3yziter.matrixCursor(), test), AipsError);
                  ...
                  test.row(2) = 0;
                  test.row(3) = 0;
                  AlwaysAssert(allEQ(niytiter.matrixCursor(), test), AipsError);
                  ...
                  test.column(3) = 0;
                  test.column(4) = 0;
                  AlwaysAssert(allEQ(ni2ytiter.matrixCursor(), test), AipsError);
                  ...
                  test.column(3) = 0;
                  test.column(4) = 0;
                  AlwaysAssert(allEQ(ni3ytiter.matrixCursor(), test), AipsError);
                  ...
                  test.set(24);
                  test.row(3) = 0;
                  AlwaysAssert(allEQ(niztiter.matrixCursor(), test), AipsError);
                  ...
                  test.column(3) = 0;
                  test.column(4) = 0;
                  AlwaysAssert(allEQ(ni2ztiter.matrixCursor(), test), AipsError);
                  ...
                  test.column(3) = 0;
                  test.column(4) = 0;
                  AlwaysAssert(allEQ(ni3ztiter.matrixCursor(), test), AipsError);
                }
              }
            }
          }
