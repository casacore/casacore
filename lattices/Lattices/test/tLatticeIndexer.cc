  ...
  try {
    {
      ...
      l.subSection(IPosition(3, 1, 2, 3), IPosition(3, 9, 19, 29), IPosition(3, 2, 3, 4));
      ...
      AlwaysAssert(l.absolutePosition(IPosition(3, 0)).isEqual(IPosition(3, 5, 8, 7)), AipsError);
      AlwaysAssert(l.absolutePosition(IPosition(3, 1)).isEqual(IPosition(3, 9, 17, 31)), AipsError);
    ...
    }
    {
      ...
      AlwaysAssert(l.tiledCursorMove(True, point, shape, heading) == False, AipsError);
      ...
      AlwaysAssert(l.tiledCursorMove(False, point, shape, heading) == False, AipsError);
    }
    {
      // test tiledCursorMove with degenerate axes.
      LatticeIndexer l(IPosition(3, 7, 9, 1), IPosition(3, 1, 1, 0), IPosition(3, 6, 8, 0),
                       IPosition(3, 2, 2, 1));
      IPosition point(3, 0);
