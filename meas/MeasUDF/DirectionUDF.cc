...
UDFBase* DirectionUDF::makeHADEC(const String&) { return new DirectionUDF(HADEC); }
UDFBase* DirectionUDF::makeAZEL(const String&) { return new DirectionUDF(AZEL); }
UDFBase* DirectionUDF::makeAPP(const String&) { return new DirectionUDF(APP); }
UDFBase* DirectionUDF::makeJ2000(const String&) { return new DirectionUDF(J2000); }
UDFBase* DirectionUDF::makeB1950(const String&) { return new DirectionUDF(B1950); }
UDFBase* DirectionUDF::makeECL(const String&) { return new DirectionUDF(ECLIPTIC); }
...
void DirectionUDF::setup(const Table&, const TaQLStyle&) {
  ...
  itsEngine.handleDirection(operands(), argnr, itsRiseSet, itsType == DIRCOS);
