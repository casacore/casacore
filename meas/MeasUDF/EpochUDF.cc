...
EpochUDF::EpochUDF(FuncType type) : itsType(type) {}

UDFBase* EpochUDF::makeEPOCH(const String&) { return new EpochUDF(EPOCH); }
UDFBase* EpochUDF::makeLAST(const String&) { return new EpochUDF(LAST); }
