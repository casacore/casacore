...
PositionUDF::PositionUDF(FuncType type) : itsType(type) {}

UDFBase* PositionUDF::makePOS(const String&) { return new PositionUDF(POS); }
UDFBase* PositionUDF::makeITRFXYZ(const String&) { return new PositionUDF(ITRFXYZ); }
UDFBase* PositionUDF::makeITRFLLH(const String&) { return new PositionUDF(ITRFLLH); }
UDFBase* PositionUDF::makeITRFLL(const String&) { return new PositionUDF(ITRFLL); }
UDFBase* PositionUDF::makeITRFH(const String&) { return new PositionUDF(ITRFH); }
UDFBase* PositionUDF::makeWGSXYZ(const String&) { return new PositionUDF(WGSXYZ); }
UDFBase* PositionUDF::makeWGSLLH(const String&) { return new PositionUDF(WGSLLH); }
UDFBase* PositionUDF::makeWGSLL(const String&) { return new PositionUDF(WGSLL); }
UDFBase* PositionUDF::makeWGSH(const String&) { return new PositionUDF(WGSH); }
