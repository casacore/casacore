...
uInt MCBaseline::ToRef_p[N_Routes][3] = {
    ...
    {MBaseline::B1950, MBaseline::J2000, 2},       {MBaseline::B1950_VLA, MBaseline::J2000, 2},
    {MBaseline::B1950, MBaseline::B1950_VLA, 0},   {MBaseline::B1950_VLA, MBaseline::B1950, 0},
    {MBaseline::J2000, MBaseline::JMEAN, 0},       {MBaseline::B1950, MBaseline::BMEAN, 2},
    {MBaseline::JMEAN, MBaseline::J2000, 0},       {MBaseline::JMEAN, MBaseline::JTRUE, 0},
    {MBaseline::BMEAN, MBaseline::B1950, 2},       {MBaseline::BMEAN, MBaseline::BTRUE, 2},
    {MBaseline::JTRUE, MBaseline::JMEAN, 0},       {MBaseline::BTRUE, MBaseline::BMEAN, 2},
    {MBaseline::J2000, MBaseline::JNAT, 0},        {MBaseline::JNAT, MBaseline::J2000, 0},
    {MBaseline::B1950, MBaseline::APP, 2},         {MBaseline::APP, MBaseline::B1950, 2},
    {MBaseline::APP, MBaseline::TOPO, 0},          {MBaseline::HADEC, MBaseline::AZEL, 0},
    {MBaseline::HADEC, MBaseline::AZELGEO, 0},     {MBaseline::AZEL, MBaseline::HADEC, 0},
    {MBaseline::AZELGEO, MBaseline::HADEC, 0},     {MBaseline::HADEC, MBaseline::TOPO, 0},
    {MBaseline::AZEL, MBaseline::AZELSW, 0},       {MBaseline::AZELGEO, MBaseline::AZELSWGEO, 0},
    {MBaseline::AZELSW, MBaseline::AZEL, 0},       {MBaseline::AZELSWGEO, MBaseline::AZELGEO, 0},
    {MBaseline::APP, MBaseline::JNAT, 0},          {MBaseline::JNAT, MBaseline::APP, 0},
    {MBaseline::J2000, MBaseline::ECLIPTIC, 0},    {MBaseline::ECLIPTIC, MBaseline::J2000, 0},
    {MBaseline::JMEAN, MBaseline::MECLIPTIC, 0},   {MBaseline::MECLIPTIC, MBaseline::JMEAN, 0},
    {MBaseline::JTRUE, MBaseline::TECLIPTIC, 0},   {MBaseline::TECLIPTIC, MBaseline::JTRUE, 0},
    {MBaseline::GALACTIC, MBaseline::SUPERGAL, 0}, {MBaseline::SUPERGAL, MBaseline::GALACTIC, 0},
...
// # Constructors
MCBaseline::MCBaseline() : measMath() { std::call_once(theirInitOnceFlag, doFillState); }

// # Destructor
MCBaseline::~MCBaseline() { clearConvert(); }
...
void MCBaseline::doConvert(MeasValue &in, MRBase &inref, MRBase &outref, const MConvertBase &mc) {
  doConvert((MVBaseline &)in, inref, outref, mc);
}
...
String MCBaseline::showState() {
  ...
  return MCBase::showState(MCBaseline::FromTo_p[0], MBaseline::N_Types, MCBaseline::N_Routes,
                           MCBaseline::ToRef_p);
}
