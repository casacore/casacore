...
void MCPosition::doConvert(MeasValue &in, MRBase &inref, MRBase &outref, const MConvertBase &mc) {
  doConvert(*(MVPosition *)&in, inref, outref, mc);
}
    ...
    switch (mc.getMethod(i)) {
      case ITRF_WGS84: {
        ...
        *DVEC1 = in.get();
        ...
        in = MVPosition(Quantity((*DVEC1)(0), "m"), (*DVEC1)(1), (*DVEC1)(2));
      } break;
...
String MCPosition::showState() {
  ...
  return MCBase::showState(MCPosition::FromTo_p[0], MPosition::N_Types, MCPosition::N_Routes,
                           MCPosition::ToRef_p);
}
