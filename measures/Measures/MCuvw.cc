...
uInt MCuvw::ToRef_p[N_Routes][3] = {
    ...
    {Muvw::B1950, Muvw::J2000, 2},       {Muvw::B1950_VLA, Muvw::J2000, 2},
    {Muvw::B1950, Muvw::B1950_VLA, 0},   {Muvw::B1950_VLA, Muvw::B1950, 0},
    {Muvw::J2000, Muvw::JMEAN, 0},       {Muvw::B1950, Muvw::BMEAN, 2},
    {Muvw::JMEAN, Muvw::J2000, 0},       {Muvw::JMEAN, Muvw::JTRUE, 0},
    {Muvw::BMEAN, Muvw::B1950, 2},       {Muvw::BMEAN, Muvw::BTRUE, 2},
    {Muvw::JTRUE, Muvw::JMEAN, 0},       {Muvw::BTRUE, Muvw::BMEAN, 2},
    {Muvw::J2000, Muvw::JNAT, 0},        {Muvw::JNAT, Muvw::J2000, 0},
    {Muvw::B1950, Muvw::APP, 2},         {Muvw::APP, Muvw::B1950, 2},
    {Muvw::APP, Muvw::TOPO, 0},          {Muvw::HADEC, Muvw::AZEL, 0},
    {Muvw::HADEC, Muvw::AZELGEO, 0},     {Muvw::AZEL, Muvw::HADEC, 0},
    {Muvw::AZELGEO, Muvw::HADEC, 0},     {Muvw::HADEC, Muvw::TOPO, 0},
    {Muvw::AZEL, Muvw::AZELSW, 0},       {Muvw::AZELGEO, Muvw::AZELSWGEO, 0},
    {Muvw::AZELSW, Muvw::AZEL, 0},       {Muvw::AZELSWGEO, Muvw::AZELGEO, 0},
    {Muvw::APP, Muvw::JNAT, 0},          {Muvw::JNAT, Muvw::APP, 0},
    {Muvw::J2000, Muvw::ECLIPTIC, 0},    {Muvw::ECLIPTIC, Muvw::J2000, 0},
    {Muvw::JMEAN, Muvw::MECLIPTIC, 0},   {Muvw::MECLIPTIC, Muvw::JMEAN, 0},
    {Muvw::JTRUE, Muvw::TECLIPTIC, 0},   {Muvw::TECLIPTIC, Muvw::JTRUE, 0},
    {Muvw::GALACTIC, Muvw::SUPERGAL, 0}, {Muvw::SUPERGAL, Muvw::GALACTIC, 0},
...
// # Constructors
MCuvw::MCuvw() : measMath() { std::call_once(theirInitOnceFlag, doFillState); }

// # Destructor
MCuvw::~MCuvw() { clearConvert(); }
...
void MCuvw::doConvert(MeasValue &in, MRBase &inref, MRBase &outref, const MConvertBase &mc) {
  doConvert((MVuvw &)in, inref, outref, mc);
}
...
String MCuvw::showState() {
  ...
  return MCBase::showState(MCuvw::FromTo_p[0], Muvw::N_Types, MCuvw::N_Routes, MCuvw::ToRef_p);
}
...
void MCuvw::getAPP() { measMath.getAPP(MVDIR1); }

void MCuvw::getJ2000() { measMath.getJ2000(MVDIR1); }

void MCuvw::getB1950() { measMath.getB1950(MVDIR1); }

void MCuvw::toPole(MVPosition &in) {
  in *= RotMatrix(Euler(-M_PI_2 + MVDIR1.getLat(), 2u, -MVDIR1.getLong(), 3u));
}

void MCuvw::fromPole(MVPosition &in) {
  in = RotMatrix(Euler(-M_PI_2 + MVDIR1.getLat(), 2u, -MVDIR1.getLong(), 3u)) * in;
}
