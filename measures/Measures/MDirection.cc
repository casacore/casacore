...
// # Constructors
MDirection::MDirection() : MeasBase<MVDirection, MDirection::Ref>() {}
...
MDirection::MDirection(const Quantity &dt, const Quantity &dt1)
    : MeasBase<MVDirection, MDirection::Ref>(MVDirection(dt, dt1), MDirection::DEFAULT) {}

MDirection::MDirection(const Quantity &dt, const Quantity &dt1, const MDirection::Ref &rf)
...
MDirection::MDirection(const MDirection::Ref &rf) : MeasBase<MVDirection, MDirection::Ref>(rf) {}

MDirection::MDirection(MDirection::Types rf) : MeasBase<MVDirection, MDirection::Ref>(rf) {}
...
MDirection MDirection::makeMDirection(const String &sourceName) {
  ...
  if (!MeasTable::Source(md, sourceName)) {
    throw AipsError("MDirection: " + sourceName + " is an unknown source name");
  }
  return md;
}
...
const String &MDirection::tellMe() const { return MDirection::showMe(); }
...
void MDirection::assure(const Measure &in) {
  if (!dynamic_cast<const MDirection *>(&in)) {
    throw(AipsError("Illegal Measure type argument: " + MDirection::showMe()));
  }
}
...
MDirection::Types MDirection::castType(uInt tp) {
  ...
  if ((tp & MDirection::EXTRA) == 0) {
    ...
    AlwaysAssert((tp & ~MDirection::EXTRA) < (MDirection::N_Planets - MDirection::MERCURY),
                 AipsError);
  }
...
const String *MDirection::allMyTypes(Int &nall, Int &nextra, const uInt *&typ) {
  ...
  static const String tname[N_name] = {
      ...
      "AZELSWGEO", "AZELNEGEO", "JNAT",    "ECLIPTIC", "MECLIPTIC", "TECLIPTIC", "SUPERGAL",
  ...
  static const uInt oname[N_name] = {
      ...
      MDirection::AZEL,     MDirection::AZELGEO,   MDirection::AZELSWGEO, MDirection::AZELGEO,
      MDirection::JNAT,     MDirection::ECLIPTIC,  MDirection::MECLIPTIC, MDirection::TECLIPTIC,
      MDirection::SUPERGAL, MDirection::ITRF,      MDirection::TOPO,      MDirection::ICRS,
      MDirection::MERCURY,  MDirection::VENUS,     MDirection::MARS,      MDirection::JUPITER,
      MDirection::SATURN,   MDirection::URANUS,    MDirection::NEPTUNE,   MDirection::PLUTO,
      MDirection::SUN,      MDirection::MOON,      MDirection::COMET};
...
void MDirection::checkTypes() const { MDirection::checkMyTypes(); }
...
MDirection::GlobalTypes MDirection::globalType(uInt tp) {
  static const MDirection::GlobalTypes oname[MDirection::N_Types] = {
      ...
      MDirection::GRADEC,   MDirection::GRADEC,   MDirection::GRADEC,   MDirection::GRADEC,
      MDirection::GLONGLAT, MDirection::GHADEC,   MDirection::GAZEL,    MDirection::GAZEL,
      MDirection::GAZEL,    MDirection::GAZEL,    MDirection::GRADEC,   MDirection::GLONGLAT,
      MDirection::GLONGLAT, MDirection::GLONGLAT, MDirection::GLONGLAT, MDirection::GRADEC,
      MDirection::GRADEC};
...
String MDirection::toString() const {
  ...
  String output;
  if (type == J2000 || type == JMEAN || type == JTRUE || type == APP || type == B1950 ||
      type == B1950_VLA || type == BMEAN || type == BTRUE) {
