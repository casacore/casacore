...
// # Constructors
MRadialVelocity::MRadialVelocity() : MeasBase<MVRadialVelocity, MRadialVelocity::Ref>() {}

MRadialVelocity::MRadialVelocity(const MVRadialVelocity &dt)
    : MeasBase<MVRadialVelocity, MRadialVelocity::Ref>(dt, MRadialVelocity::DEFAULT) {}

MRadialVelocity::MRadialVelocity(const MVRadialVelocity &dt, const MRadialVelocity::Ref &rf)
    : MeasBase<MVRadialVelocity, MRadialVelocity::Ref>(dt, rf) {}

MRadialVelocity::MRadialVelocity(const MVRadialVelocity &dt, MRadialVelocity::Types rf)
    : MeasBase<MVRadialVelocity, MRadialVelocity::Ref>(dt, rf) {}
...
MRadialVelocity::MRadialVelocity(const Quantity &dt, MRadialVelocity::Types rf)
    : MeasBase<MVRadialVelocity, MRadialVelocity::Ref>(dt, rf) {}
...
const String &MRadialVelocity::tellMe() const { return MRadialVelocity::showMe(); }
...
void MRadialVelocity::assure(const Measure &in) {
  if (!dynamic_cast<const MRadialVelocity *>(&in)) {
    throw(AipsError("Illegal Measure type argument: " + MRadialVelocity::showMe()));
  }
}
...
const String &MRadialVelocity::showType(MRadialVelocity::Types tp) {
  static const String tname[MRadialVelocity::N_Types] = {"LSRK", "LSRD",    "BARY",   "GEO",
...
void MRadialVelocity::checkTypes() const { MRadialVelocity::checkMyTypes(); }
...
String MRadialVelocity::getRefString() const { return MRadialVelocity::showType(ref.getType()); }
...
Measure *MRadialVelocity::clone() const { return (new MRadialVelocity(*this)); }
