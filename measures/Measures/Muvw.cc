...
// # Constructors
Muvw::Muvw() : MeasBase<MVuvw, Muvw::Ref>() {}

Muvw::Muvw(const MVuvw &dt) : MeasBase<MVuvw, Muvw::Ref>(dt, Muvw::DEFAULT) {}

Muvw::Muvw(const MVuvw &dt, const Muvw::Ref &rf) : MeasBase<MVuvw, Muvw::Ref>(dt, rf) {}

Muvw::Muvw(const MVuvw &dt, Muvw::Types rf) : MeasBase<MVuvw, Muvw::Ref>(dt, rf) {}

Muvw::Muvw(const Measure *dt) : MeasBase<MVuvw, Muvw::Ref>(dt) {}

Muvw::Muvw(const MeasValue *dt) : MeasBase<MVuvw, Muvw::Ref>(*(MVuvw *)dt, Muvw::DEFAULT) {}

Muvw::Muvw(const Muvw &other) : MeasBase<MVuvw, Muvw::Ref>(other) {}
...
const String &Muvw::tellMe() const { return Muvw::showMe(); }
...
void Muvw::assure(const Measure &in) {
  if (!dynamic_cast<const Muvw *>(&in)) {
    throw(AipsError("Illegal Measure type argument: " + Muvw::showMe()));
  }
}
...
const String *Muvw::allMyTypes(Int &nall, Int &nextra, const uInt *&typ) {
  ...
  static const uInt oname[N_name] = {
      ...
      Muvw::AZELGEO,   Muvw::JNAT,   Muvw::ECLIPTIC, Muvw::MECLIPTIC, Muvw::TECLIPTIC,
      Muvw::SUPERGAL,  Muvw::ITRF,   Muvw::TOPO,     Muvw::ICRS};
...
void Muvw::checkTypes() const { Muvw::checkMyTypes(); }
