...
Stokes::StokesTypes Stokes::type(const String &stokesName) {
  ...
  if (name == "I")
    ...
    val = QQ;
  else if (name == "RCIRCULAR")
    val = RCircular;
  else if (name == "LCIRCULAR")
    val = LCircular;
  else if (name == "LINEAR")
    val = Linear;
  else if (name == "PTOTAL")
    val = Ptotal;
  else if (name == "PLINEAR")
    val = Plinear;
  else if (name == "PFTOTAL")
    val = PFtotal;
  else if (name == "PFLINEAR")
    val = PFlinear;
  else if (name == "PANGLE")
    val = Pangle;
  return val;
...
String Stokes::name(StokesTypes stokesType) {
  ...
  switch (stokesType) {
    ...
    case QQ:
      ...
      break;
    case RCircular:
      stokesName = "RCircular";
      break;
    case LCircular:
      stokesName = "LCircular";
      break;
    case Linear:
      stokesName = "Linear";
      break;
