...
int main() {
  try {
    ...
    cout << "Field      " << MeasTable::IGRF(dat.day()) << endl;
    cout << "             " << MeasTable::IGRF(dat.day()).nelements() << endl;
    ...
    cout << "+10km X:   " << ef((obs.getValue() + MVPosition(10000, 0, 0))) << endl;
    cout << "-10km X:   " << ef((obs.getValue() + MVPosition(-10000, 0, 0))) << endl;
    cout << "+10km Y:   " << ef((obs.getValue() + MVPosition(0, 10000, 0))) << endl;
    cout << "-10km Y:   " << ef((obs.getValue() + MVPosition(0, -10000, 0))) << endl;
    cout << "+10km Z:   " << ef((obs.getValue() + MVPosition(0, 0, 10000))) << endl;
    cout << "-10km Z:   " << ef((obs.getValue() + MVPosition(0, 0, -10000))) << endl;
