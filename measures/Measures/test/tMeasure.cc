...
int main() {
  try {
    ...
    cout << "Day:        " << mtim.string((MVTime::formatTypes)(MVTime::TIME | MVTime::DAY), 6)
         << endl;
    cout << "YMD:        " << mtim.string(MVTime::YMD, 6) << endl;
    cout << "DMY:        " << mtim.string(MVTime::DMY, 6) << endl;
    cout << "Day+DMY:    " << mtim.string((MVTime::formatTypes)(MVTime::DMY | MVTime::DAY), 6)
         << endl;
    cout << "Day+YMD:    " << mtim.string((MVTime::formatTypes)(MVTime::YMD | MVTime::DAY), 6)
         << endl;
    cout << "Weekday:    " << mtim.weekday() << endl;
    cout << "yyyy mm dd: " << mtim.year() << " " << mtim.month() << " " << mtim.monthday() << endl;
    ...
    cout << "Day+YMD:    " << mtim.string((MVTime::formatTypes)(MVTime::YMD | MVTime::DAY), 6)
         << endl;
    cout << "Day (NO_T): "
         << mtim.string((MVTime::formatTypes)(MVTime::TIME | MVTime::DAY | MVTime::NO_TIME), 6)
         << endl;
    cout << "Day+YMD:    "
         << mtim.string((MVTime::formatTypes)(MVTime::YMD | MVTime::DAY | MVTime::NO_TIME), 6)
         << endl;
    cout << "Day+YMD:    " << mtim.string((MVTime::YMD | MVTime::DAY | MVTime::NO_TIME), 6) << endl;
    ...
    MEpoch tm2(Quantity(MeasData::MJD2000 - MeasData::MJDB1950, "d"), tbmref);
    ...
    cout << "Converted " << tm2 << endl << " to " << tmref << endl << " as " << tconv() << endl;
    MEpoch::Ref turef(MEpoch::UTC);
    MEpoch::Convert tconv2(tm2, turef);
    cout << "Converted " << tm2 << endl << " to " << turef << endl << " as " << tconv2() << endl;

    MEpoch::Ref tgsref(MEpoch::UT1);
    MEpoch tm3(Quantity(50082.0, "d"), tgsref);
    MEpoch tm4(Quantity(50082.72315521759259259259, "d"), tgsref);
    MEpoch tm5(Quantity(44238.0, "d"), tgsref);
    MEpoch::Ref tlsref(MEpoch::GMST1);
    MEpoch::Convert tconv3(tm3, tlsref);
    cout << "Converted " << tm3 << endl << " to " << tlsref << endl << " as " << tconv3() << endl;
    ...
    cout << "Converted " << tm3 << endl << " to " << tasref << endl << " as " << tconv5() << endl;
    MEpoch tm7(tconv5());
...

    {
      ...
      MDirection lsr1900(Quantity(270, "deg"), Quantity(30, "deg"),
                         MDirection::Ref(MDirection::BMEAN, b1900));
      cout << "LSR (B1900): " << lsr1900.getValue().getAngle("deg") << endl;
      cout << "LSR (B1950): "
      ...
      cout << "LSR (B1950): " << MDirection::Convert(lsr1900, MDirection::B1950)().getValue()
           << endl;
      cout << "LSR (J2000): " << MDirection::Convert(lsr1900, MDirection::J2000)().getValue()
           << endl;
    ...
    {
      MDirection dirJ2000(Quantity(0, "deg"), Quantity(30, "deg"), MDirection::J2000);
      ...
      cout << "Radial velocity (BARY): " << rvBary << endl
           << "                 (GEO): "
           << MRadialVelocity::Convert(rvBary, MRadialVelocity::GEO)().getValue() << endl;
      MRadialVelocity rvGeo = MRadialVelocity::Convert(rvBary, MRadialVelocity::GEO)();
      rvGeo.set(MRadialVelocity::Ref(MRadialVelocity::GEO, frame));
      cout << "and back: " << MRadialVelocity::Convert(rvGeo, MRadialVelocity::BARY)().getValue()
           << endl;
      MPosition obs(Quantity(0, "m"), Quantity(-289375.79, Unit('"')), Quantity(50, "deg"));
      frame.set(obs);
      ...
      cout << "and 0 (BARY) to LSR: "
           << MRadialVelocity::Convert(rvBary, MRadialVelocity::Ref(MRadialVelocity::LSRK, frame))()
                  .getValue()
           << endl;
      MRadialVelocity rvLSR =
          MRadialVelocity::Convert(rvBary, MRadialVelocity::Ref(MRadialVelocity::LSRK, frame))();
      // The following necessary for errors in Intel chip
      mrvback = MRadialVelocity::Convert(rvLSR, MRadialVelocity::BARY)().getValue();
...

    {
      ...
      MPosition pos(Quantity(10, "m"), Quantity(6.60417, "deg"), Quantity(52.8, "deg"),
                    MPosition::WGS84);
      MeasFrame frame(coord, epo, pos);
      cout << frame << endl;
      cout << MDirection::Convert(coord, MDirection::Ref(MDirection::APP, frame))()
                  .getValue()
                  .getAngle("deg")
           << endl;
      cout << MDirection::Convert(coord, MDirection::Ref(MDirection::APP, frame))().getValue()
           << endl;
      cout << MEpoch::Convert(epo, MEpoch::Ref(MEpoch::LAST, frame))().getValue() << endl;
      MRadialVelocity rv(Quantity(1253, "km/s"),
                         MRadialVelocity::Ref(MRadialVelocity::LSRK, frame));

      cout << MRadialVelocity::Convert(rv, MRadialVelocity::Ref(MRadialVelocity::TOPO, frame))()
                      .getValue() -
                  rv.getValue()
           << endl;
      ...
      cout << MDirection::Convert(coord, MDirection::Ref(MDirection::APP, frame))().getValue()
           << endl;
      rv.set(MRadialVelocity::Ref(MRadialVelocity::BARY, frame));
      Aberration ab2(Aberration::B1950);
      cout << "Aberration: " << ab2(epo.getValue().get()) << endl;
      cout << MRadialVelocity::Convert(rv, MRadialVelocity::Ref(MRadialVelocity::TOPO, frame))()
                      .getValue() -
                  rv.getValue()
           << endl;
...

    {
      ...
      MEpoch tm31(MVEpoch(50272.40590277778), MEpoch::Types(MEpoch::UT1 + MEpoch::RAZE));
  ...
  try {
    ...
    MVDirection j2000vec(-0.373798658, -0.312643465, -0.873228852);
    ...
    cout << "Converted J2000 coordinates " << j2000.getValue() << " to: " << j2000app().getValue()
         << endl;
    ...
    cout << "Converted J2000 to B1950 coordinates " << appj.getValue()
         << " to: " << j2000b1950(appj).getValue() << endl;
    MPosition wsrt(Quantity(16, "m"), Quantity(6.60417, "deg"), Quantity(52.91692, "deg"),
                   MPosition::WGS84);
    MPosition::Convert wsrtitrf(wsrt, MPosition::ITRF);
    MPosition geod(wsrtitrf());

    cout << "Converted geodetic position: " << endl
         << wsrt.getValue().getLength() << ", " << wsrt.getAngle("deg") << endl
         << "to: " << geod.getValue().getLength() << ", " << geod.getAngle("deg") << endl;

    MPosition::Convert wsrtwgs(geod, MPosition::WGS84);
    wsrt = wsrtwgs();

    cout << "Converted geocentric position: " << endl
         << geod.getValue().getLength() << ", " << geod.getAngle("deg") << endl
         << "to: " << wsrt.getValue().getLength() << ", " << wsrt.getAngle("deg") << endl;

    {
      MEpoch tim(MVEpoch(50082), MEpoch::UT1);
      MeasFrame frame(wsrt, tim);
      MDirection appvec(MDirection::Convert(j2000vec, MDirection::Ref(MDirection::APP, frame))());
      ...
      cout << "LAST:      " << MVAngle(d3 * C::circle).string(MVAngle::TIME, 8) << endl;
      cout << "LAST:      " << MVAngle(d3 * C::circle).string(MVAngle::ANGLE, 8) << endl;
      cout << "LAST:      " << MEpoch::Convert(tim, MEpoch::Ref(MEpoch::LAST, frame))() << endl;
      cout << "HA/DEC: "
           << MDirection::Convert(appvec, MDirection::Ref(MDirection::HADEC, frame))().getAngle(
                  "deg")
           << endl;
      MDirection had(MDirection::Convert(appvec, MDirection::Ref(MDirection::HADEC, frame))());
      cout << "Back:   "
           << MDirection::Convert(had, MDirection::Ref(MDirection::APP, frame))().getAngle("deg")
           << endl;
      cout << "Az/El:  "
           << MDirection::Convert(had, MDirection::Ref(MDirection::AZEL, frame))().getAngle("deg")
           << endl;
      MDirection azel(MDirection::Convert(appvec, MDirection::Ref(MDirection::AZEL, frame))());
      cout << "Back:   "
           << MDirection::Convert(azel, MDirection::Ref(MDirection::HADEC, frame))().getAngle("deg")
           << endl;
    };
    {
      ...
      MDirection bappc(Quantity(85.4267, "deg"), Quantity(49.8502, "deg"), appref);
      MDirection::Convert appb1950(bappc, b1950ref);
      MDirection b1950(appb1950());
      MDirection::Convert b1950app(b1950, appref);
      MVDirection mvpole;
      MDirection bappc1(Quantity(85.4267, "deg"), Quantity(50.8502, "deg"), appref);

      cout << "Converted to B1950 coordinates " << bappc.getAngle("deg")
           << " to: " << appb1950().getAngle("deg") << endl;
      cout << "and back to: " << b1950app().getAngle("deg") << endl;
      MDirection apole(b1950app(mvpole));
      cout << "Rotation angle: " << bappc.getValue().positionAngle(apole.getValue(), "deg") << endl;
    }

    MEpoch tbm(Quantity(50927.92931, "d"));
    MPosition pos(MVPosition(-4750915.84032, 2792906.17778, -3200483.75028), MPosition::ITRF);
...

    {
      ...
      for (uInt i = MDirection::J2000; i < MDirection::N_Types; i++) {
        for (uInt j = MDirection::J2000; j < MDirection::N_Types; j++) {
          ...
          if (!allNearAbs(mb0.getValue().getValue() - backw(forw(mb0)).getValue().getValue(), tvec,
                          tp)) {
...

    {
      ...
      for (uInt i = 0; i < MFrequency::N_Types; i++) {
        ...
        try {
          ...
          backw.setOut(r);
          cout << MFrequency::showType(MFrequency::Undefined) << " to " << MFrequency::showType(i)
               << " should not be possible." << endl;
        } catch (const std::exception& x) {
          // expected error
          cout << x.what() << endl;
...

    {
      ...
      for (uInt i = 0; i < MDoppler::N_Types; i++) {
        ...
        for (uInt j = 0; j < MDoppler::N_Types; j++) {
          ...
          if (!nearAbs(mb0.getValue().getValue() - backw(forw(mb0)).getValue().getValue(), tvec(0),
                       tp)) {
