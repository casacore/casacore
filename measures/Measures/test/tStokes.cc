...
int main() {
  try {
    ...
    polint = 5;
    cout << "polint = " << polint << ", Stokes::type(polint) = " << Stokes::type(polint)
         << ",  Stokes::type(Stokes::type(polint)) = " << Stokes::type(Stokes::type(polint)) << endl
         << " --- receptor1 = " << Stokes::receptor1(Stokes::type(polint)).value()
         << " --- receptor2 = " << Stokes::receptor2(Stokes::type(polint)).value() << endl;
    ...
    polstr = "XY";
    cout << "polstr = " << polstr << ", Stokes::type(polstr) = " << Stokes::type(polstr)
         << ", Stokes::type(Stokes::type(polstr)) = " << Stokes::type(Stokes::type(polstr)) << endl
         << " --- receptor1 = " << Stokes::receptor1(Stokes::type(polstr)).value()
         << " --- receptor2 = " << Stokes::receptor2(Stokes::type(polstr)).value() << endl;
