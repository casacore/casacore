...
template <class M>
void ArrayMeasColumn<M>::attach(const Table& tab, const String& columnName) {
...
template <class M>
Array<M> ArrayMeasColumn<M>::convert(rownr_t rownr, const MeasRef<M>& measRef) const {
...
void ArrayMeasColumn<M>::setDescRefCode(uInt refCode, Bool tableMustBeEmpty) {
  ...
  if (tableMustBeEmpty && tab.nrow() != 0) {
    throw(
        AipsError("ArrayMeasColumn::setDescRefCode cannot be done; "
...
void ArrayMeasColumn<M>::setDescOffset(const Measure& offset, Bool tableMustBeEmpty) {
  ...
  if (tableMustBeEmpty && tab.nrow() != 0) {
    throw(
        AipsError("ArrayMeasColumn::setDescOffset cannot be done; "
                  "the table is not empty"));
  }
...
void ArrayMeasColumn<M>::setDescUnits(const Vector<Unit>& units, Bool tableMustBeEmpty) {
  ...
  if (tableMustBeEmpty && tab.nrow() != 0) {
    throw(
        AipsError("ArrayMeasColumn::setDescUnits cannot be done; "
                  "the table is not empty"));
  }
