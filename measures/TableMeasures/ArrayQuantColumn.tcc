...
template <class T>
void ArrayQuantColumn<T>::attach(const Table& tab, const String& columnName) {
  reference(ArrayQuantColumn<T>(tab, columnName));
}

template <class T>
void ArrayQuantColumn<T>::attach(const Table& tab, const String& columnName, const Unit& u) {
...
template <class T>
Array<Quantum<T>> ArrayQuantColumn<T>::operator()(rownr_t rownr, const Unit& u) const {
  Array<Quantum<T>> q;
  get(rownr, q, u);
  return q;
}
...
template <class T>
Array<Quantum<T>> ArrayQuantColumn<T>::operator()(rownr_t rownr, const Vector<Unit>& u) const {
  Array<Quantum<T>> q;
  get(rownr, q, u);
  return q;
}
...
template <class T>
Array<Quantum<T>> ArrayQuantColumn<T>::operator()(rownr_t rownr, const Quantum<T>& other) const {
  Array<Quantum<T>> q;
  get(rownr, q, other);
  return q;
}
