...
void testMain(Bool doExcep) {
  ...
  {
    MEpoch obsTime((MVEpoch(MVTime(1995, 5, 17, (8 + 18. / 60.) / 24.))), MEpoch::UTC);
...

  {
    ...
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "MDirColumn")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "TimeOffset")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "Time1")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "TimeVarOffset")));
    AlwaysAssertExit(!TableMeasDescBase::hasMeasures(TableColumn(tab, "TimeRef")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "MEpochVarStr")));
    AlwaysAssertExit(!TableMeasDescBase::hasMeasures(TableColumn(tab, "TimeRefStr")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "Time1Arr")));
    AlwaysAssertExit(!TableMeasDescBase::hasMeasures(TableColumn(tab, "TimeArrRef")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "Time2Arr")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "Time2ArrOffset")));
    AlwaysAssertExit(!TableMeasDescBase::hasMeasures(TableColumn(tab, "Time2ArrRef")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "Time3Arr")));
    AlwaysAssertExit(!TableMeasDescBase::hasMeasures(TableColumn(tab, "Time3ArrStrRef")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "Time4Arr")));
    AlwaysAssertExit(!TableMeasDescBase::hasMeasures(TableColumn(tab, "Time4StrRef")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "Time4ScaOffset")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "SpareCol1")));
    AlwaysAssertExit(TableMeasDescBase::hasMeasures(TableColumn(tab, "SpareArrOffset")));
    ...
    if (timeCol.measDesc().isRefCodeVariable()) {
      ...
      cout << "The MeasRef for the column is: " << timeCol.getMeasRef() << endl;
    }

    {
      ...
      cout << "Units of Time1Arr: " << arrayCol.measDesc().getUnits()(0).getName() << endl;
      u(0) = "";
      arrayCol.setDescUnits(u);
      cout << "Units of Time1Arr: " << arrayCol.measDesc().getUnits()(0).getName() << endl;
      u(0) = "s";
...
void testRefCodeChg() {
  ...
  // Check if the values are fine.
  {
    ...
    AlwaysAssertExit(check(tmpCol(0), MEpoch(Quantity(0, "d"), MEpoch::Types(0))));
    AlwaysAssertExit(check(tmpCol(1), MEpoch(Quantity(1, "d"), MEpoch::Types(1))));
    AlwaysAssertExit(check(tmpCol(2), MEpoch(Quantity(2, "d"), MEpoch::Types(2))));
    AlwaysAssertExit(check(tmpCol(3), MEpoch(Quantity(3, "d"), MEpoch::Types(8))));
    AlwaysAssertExit(check(tmpCol(4), MEpoch(Quantity(4, "d"), MEpoch::Types(4))));
    AlwaysAssertExit(check(tmpCol(5), MEpoch(Quantity(5, "d"), MEpoch::Types(5))));
  ...
  // Check the remapped values.
  {
    ...
    AlwaysAssertExit(check(tmpCol(1), MEpoch(Quantity(1, "d"), MEpoch::Types(1))));
    AlwaysAssertExit(check(tmpCol(2), MEpoch(Quantity(2, "d"), MEpoch::Types(2))));
    AlwaysAssertExit(check(tmpCol(3), MEpoch(Quantity(3, "d"), MEpoch::Types(5))));
    AlwaysAssertExit(check(tmpCol(4), MEpoch(Quantity(4, "d"), MEpoch::Types(8))));
    AlwaysAssertExit(check(tmpCol(5), MEpoch(Quantity(5, "d"), MEpoch::Types(3))));
    AlwaysAssertExit(check(tmpACol(5), va));
    AlwaysAssertExit(check(tmpBCol(5), vb));
  }
  // Change a value.
  ...
  // Check the values.
  {
    ...
    AlwaysAssertExit(allEQ(refBCol(5), vbi));
    AlwaysAssertExit(check(tmpCol(0), MEpoch(Quantity(0, "d"), MEpoch::Types(0))));
    AlwaysAssertExit(check(tmpCol(1), MEpoch(Quantity(4, "d"), MEpoch::Types(4))));
    AlwaysAssertExit(check(tmpCol(2), MEpoch(Quantity(2, "d"), MEpoch::Types(2))));
    AlwaysAssertExit(check(tmpCol(3), MEpoch(Quantity(3, "d"), MEpoch::Types(5))));
    AlwaysAssertExit(check(tmpCol(4), MEpoch(Quantity(4, "d"), MEpoch::Types(8))));
    AlwaysAssertExit(check(tmpCol(5), MEpoch(Quantity(5, "d"), MEpoch::Types(3))));
