...
// TableExprNode msFieldGramParseCommand (MSSelectableTable *ms, const String&
// command,Vector<Int>&); TableExprNode msFieldGramParseCommand (const MeasurementSet *ms, const
// String& command,Vector<Int>&);
