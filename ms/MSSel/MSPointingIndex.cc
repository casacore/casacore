...
MSPointingIndex::MSPointingIndex() : MSTableIndex() { ; }
...
MSPointingIndex::MSPointingIndex(const MSPointingIndex &other) : MSTableIndex(other) {
  attachIds();
}
...
void MSPointingIndex::attachIds() { antennaId_p.attachToRecord(accessKey(), "ANTENNA_ID"); }
