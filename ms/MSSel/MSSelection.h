...
class MSSelection {
 public:
  ...
  MSSelection(const MeasurementSet& ms, const MSSMode& mode = PARSE_NOW,
              ...
              const String& polnExpr = "", const String& scanExpr = "",
              const String& arrayExpr = "", const String& stateExpr = "",
  ...
  // MSSelectableTable.
  void reset(const MeasurementSet& ms, const MSSMode& mode = PARSE_NOW, const String& timeExpr = "",
             ...
             const String& stateExpr = "", const String& observationExpr = "");

  // Add feedExpr; keep old signature for backwards compatibility
  void reset2(const MeasurementSet& ms, const MSSMode& mode = PARSE_NOW,
              const String& timeExpr = "", const String& antennaExpr = "",
              const String& fieldExpr = "", const String& spwExpr = "",
              const String& uvDistExpr = "", const String& taqlExpr = "",
              const String& polnExpr = "", const String& scanExpr = "",
  ...
  // uses MeasurementSet.
  void reset(MSSelectableTable& msLike, const MSSMode& mode = PARSE_NOW,
             const String& timeExpr = "", const String& antennaExpr = "",
             const String& fieldExpr = "", const String& spwExpr = "",
             const String& uvDistExpr = "", const String& taqlExpr = "",
             const String& polnExpr = "", const String& scanExpr = "", const String& arrayExpr = "",
  ...
  // Add feedExpr; keep old signature for backwards compatibility
  void reset2(MSSelectableTable& msLike, const MSSMode& mode = PARSE_NOW,
              const String& timeExpr = "", const String& antennaExpr = "",
              const String& fieldExpr = "", const String& spwExpr = "",
              const String& uvDistExpr = "", const String& taqlExpr = "",
              const String& polnExpr = "", const String& scanExpr = "",
