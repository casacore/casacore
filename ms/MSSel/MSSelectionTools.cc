...
Bool mssSetData(const MeasurementSet& ms, MeasurementSet& selectedMS, const String& outMSName,
                ...
                const String& stateExpr, const String& obsExpr, MSSelection* mymss) {
  return mssSetData2(ms, selectedMS, outMSName, timeExpr, antennaExpr, fieldExpr, spwExpr,
                     uvDistExpr, taQLExpr, polnExpr, scanExpr, arrayExpr, stateExpr, obsExpr, "",
                     mymss);
}
...
Bool mssSetData2(const MeasurementSet& ms, MeasurementSet& selectedMS, const String& outMSName,
                 ...
                 const String& spwExpr, const String& uvDistExpr, const String& taQLExpr,
                 const String& polnExpr, const String& scanExpr, const String& arrayExpr,
                 const String& stateExpr, const String& obsExpr, const String& feedExpr,
                 MSSelection* mymss) {
  //
  ...
  try {
    mss->reset2(ms, MSSelection::PARSE_NOW, timeExpr, antennaExpr, fieldExpr, spwExpr, uvDistExpr,
                taQLExpr, polnExpr, scanExpr, arrayExpr, stateExpr, obsExpr, feedExpr);
    //
