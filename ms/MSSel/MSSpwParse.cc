...
MSSpwParse::MSSpwParse(const MeasurementSet* ms) : MSParse(ms, "Spw") {
  idList.resize(0);
  ddidList.resize(0);
...
//------------------------------------------------------------------
//
MSSpwParse::MSSpwParse(const MSSpectralWindow& spwSubTable, const MSDataDescription& ddSubTable,
...
//------------------------------------------------------------------
//
const TableExprNode* MSSpwParse::node() { return node_p; }
//
//------------------------------------------------------------------
//
