...
MSWeatherIndex::MSWeatherIndex() : MSTableIndex() { ; }
...
MSWeatherIndex::MSWeatherIndex(const MSWeatherIndex &other) : MSTableIndex(other) { attachIds(); }
...
void MSWeatherIndex::attachIds() { antennaId_p.attachToRecord(accessKey(), "ANTENNA_ID"); }
