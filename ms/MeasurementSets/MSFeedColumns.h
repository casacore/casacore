...
class MSFeedColumns {
 public:
  ...
  ArrayMeasColumn<MDirection>& beamOffsetMeas() { return beamOffsetMeas_p; }
  ...
  const ArrayMeasColumn<MDirection>& beamOffsetMeas() const { return beamOffsetMeas_p; }
  ...
  const ArrayQuantColumn<Double>& receptorAngleQuant() const { return receptorAngleQuant_p; }
