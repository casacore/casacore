...
class MSFieldColumns {
 public:
  ...
  ArrayMeasColumn<MDirection>& phaseDirMeasCol() { return phaseDirMeas_p; }
  ArrayColumn<Double>& referenceDir() { return referenceDir_p; }
  ArrayMeasColumn<MDirection>& referenceDirMeasCol() { return referenceDirMeas_p; }
  ...
  const ArrayMeasColumn<MDirection>& phaseDirMeasCol() const { return phaseDirMeas_p; }
  const ArrayColumn<Double>& referenceDir() const { return referenceDir_p; }
  const ArrayMeasColumn<MDirection>& referenceDirMeasCol() const { return referenceDirMeas_p; }
 ...
 private:
  ...
  // as originEpoch.
  MDirection extractDirMeas(const MDirection& offsetDir, Int index, Double& interTime,
                            MEpoch originEpoch) const;

  void getMJDs(Double& originMJD, Double& interMJD, const Double interTime,
