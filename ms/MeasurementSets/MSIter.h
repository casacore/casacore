...
public:
  ...
  MSIter(const MeasurementSet& ms, const Block<int32_t>& sortColumns,
         double timeInterval=0, bool addDefaultSortColumns=true,
         bool storeSorted=true);

  // Same as above with multiple MSs as input.
  MSIter(const Block<MeasurementSet>& mss, const Block<int32_t>& sortColumns,
         double timeInterval=0, bool addDefaultSortColumns=true,
         bool storeSorted=true);
  ...
  int32_t spectralWindowId() const;
  ...
  int32_t dataDescriptionId() const;
  ...
  const MFrequency& restFrequency(int32_t line=0) const;
  ...
  void getSpwInFreqRange(Block<Vector<int32_t> >& spw,
			 Block<Vector<int32_t> >& start,
			 Block<Vector<int32_t> >& nchan,
  ...
  const MDirection phaseCenter(const int32_t fldID, const double timeStamp) const ;
...
protected:
  ...
  void construct(const Block<int32_t>& sortColumns, bool addDefaultSortColumns);
...
// Determine if the numbers in r1 are a sorted subset of those in r2
  ...
  Table curTable_p;
  int32_t curArrayIdFirst_p, lastArrayId_p, curSourceIdFirst_p;
  mutable String curFieldNameFirst_p;
  String curSourceNameFirst_p;
  mutable int32_t curFieldIdFirst_p;
  int32_t lastFieldId_p;
  ...
  mutable int32_t curDataDescIdFirst_p, curSpectralWindowIdFirst_p,
    curPolarizationIdFirst_p;
  // These variables point to the IDs of the previous iteration.
  int32_t lastDataDescId_p, lastSpectralWindowId_p, lastPolarizationId_p;
  ...
  mutable ScalarColumn<int32_t> colDataDesc_p, colField_p;
  ScalarColumn<int32_t> colArray_p;
...
inline const ScalarColumn<int32_t>& MSIter::colArrayIds() const
{ return colArray_p;}
inline const ScalarColumn<int32_t>& MSIter::colFieldIds() const
{ return colField_p;}
inline const ScalarColumn<int32_t>& MSIter::colDataDescriptionIds() const
{if(curDataDescIdFirst_p==-1) {cacheCurrentDDInfo(); cacheExtraDDInfo();}
  return colDataDesc_p;}
inline int32_t MSIter::arrayId() const {return curArrayIdFirst_p;}
inline int32_t MSIter::fieldId() const {if(curFieldIdFirst_p==-1) setFieldInfo(); return curFieldIdFirst_p;}
inline int32_t MSIter::spectralWindowId() const
{if(curSpectralWindowIdFirst_p==-1) {cacheCurrentDDInfo(); cacheExtraDDInfo();}
  return curSpectralWindowIdFirst_p;}
inline int32_t MSIter::polarizationId() const
{if(curPolarizationIdFirst_p==-1) {cacheCurrentDDInfo(); cacheExtraDDInfo();}
  return curPolarizationIdFirst_p;}
inline int32_t MSIter::dataDescriptionId() const
{if(curDataDescIdFirst_p==-1) {cacheCurrentDDInfo(); cacheExtraDDInfo();}
...
inline int32_t MSIter::polFrame() const
{if(curPolarizationIdFirst_p==-1) {cacheCurrentDDInfo(); cacheExtraDDInfo();}
  return polFrame_p;}
