...
class MSSourceColumns {
 public:
  ...
  ArrayMeasColumn<MFrequency>& restFrequencyMeas() { return restFrequencyMeas_p; }
  ...
  // <group>
  const ScalarColumn<Int>& calibrationGroup() const { return calibrationGroup_p; }
  const ScalarColumn<String>& code() const { return code_p; }
  const ArrayColumn<Double>& direction() const { return direction_p; }
  const ArrayQuantColumn<Double>& directionQuant() const { return directionQuant_p; }
  const ScalarMeasColumn<MDirection>& directionMeas() const { return directionMeas_p; }
  ...
  const ArrayQuantColumn<Double>& properMotionQuant() const { return properMotionQuant_p; }
  ...
  const ArrayQuantColumn<Double>& restFrequencyQuant() const { return restFrequencyQuant_p; }
  const ArrayMeasColumn<MFrequency>& restFrequencyMeas() const { return restFrequencyMeas_p; }
  const ScalarColumn<TableRecord>& sourceModel() const { return sourceModel_p; }
  ...
  const ArrayMeasColumn<MRadialVelocity>& sysvelMeas() const { return sysvelMeas_p; }
