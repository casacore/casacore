...
MSTableStatics(MS::PredefinedColumns,
               MS::PredefinedKeywords) MSTableStatics(MSAntenna::PredefinedColumns,
                                                      MSAntenna::PredefinedKeywords)
    MSTableStatics(MSDataDescription::PredefinedColumns,
                   MSDataDescription::PredefinedKeywords) MSTableStatics(MSFeed::PredefinedColumns,
                                                                         MSFeed::PredefinedKeywords)
        MSTableStatics(MSField::PredefinedColumns, MSField::PredefinedKeywords) MSTableStatics(
            MSFlagCmd::PredefinedColumns,
            MSFlagCmd::PredefinedKeywords) MSTableStatics(MSFreqOffset::PredefinedColumns,
                                                          MSFreqOffset::PredefinedKeywords)
            MSTableStatics(MSHistory::PredefinedColumns, MSHistory::PredefinedKeywords)
                MSTableStatics(MSObservation::PredefinedColumns, MSObservation::PredefinedKeywords)
                    MSTableStatics(MSPointing::PredefinedColumns, MSPointing::PredefinedKeywords)
                        MSTableStatics(MSPolarization::PredefinedColumns,
                                       MSPolarization::PredefinedKeywords)
                            MSTableStatics(MSProcessor::PredefinedColumns,
                                           MSProcessor::PredefinedKeywords)
                                MSTableStatics(MSSource::PredefinedColumns,
                                               MSSource::PredefinedKeywords)
                                    MSTableStatics(MSSpectralWindow::PredefinedColumns,
                                                   MSSpectralWindow::PredefinedKeywords)
                                        MSTableStatics(MSState::PredefinedColumns,
                                                       MSState::PredefinedKeywords)
                                            MSTableStatics(MSSysCal::PredefinedColumns,
                                                           MSSysCal::PredefinedKeywords)
                                                MSTableStatics(MSWeather::PredefinedColumns,
                                                               MSWeather::PredefinedKeywords)
                                                    MSTableStatics(MSDoppler::PredefinedColumns,
                                                                   MSDoppler::PredefinedKeywords)
