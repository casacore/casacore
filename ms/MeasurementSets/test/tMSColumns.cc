...
int main() {
  try {
	...
	MS::addColumnToDesc(td, MS::PredefinedColumns(i));
      ...
      TableDesc tdAntenna;
      for (uint32_t i = 1 ; i<=MSAntenna::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSAntenna::addColumnToDesc(tdAntenna, MSAntenna::PredefinedColumns(i));
      ...
      for (uint32_t i = 1 ; i<=MSDataDescription::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSDataDescription::addColumnToDesc(tddataDescription, MSDataDescription::PredefinedColumns(i));
      ...
      TableDesc tdDoppler;
      for (uint32_t i = 1 ; i<=MSDoppler::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSDoppler::addColumnToDesc(tdDoppler, MSDoppler::PredefinedColumns(i));
      ...
      TableDesc tdFeed;
      for (uint32_t i = 1 ; i<=MSFeed::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSFeed::addColumnToDesc(tdFeed, MSFeed::PredefinedColumns(i));
      ...
      TableDesc tdField;
      for (uint32_t i = 1 ; i<=MSField::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSField::addColumnToDesc(tdField, MSField::PredefinedColumns(i));
      ...
      TableDesc tdFlagCmd;
      for (uint32_t i = 1 ; i<=MSFlagCmd::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSFlagCmd::addColumnToDesc(tdFlagCmd, MSFlagCmd::PredefinedColumns(i));
      ...
      for (uint32_t i = 1 ; i<=MSFreqOffset::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSFreqOffset::addColumnToDesc(tdFreqOffset, MSFreqOffset::PredefinedColumns(i));
      ...
      TableDesc tdHistory;
      for (uint32_t i = 1 ; i<=MSHistory::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSHistory::addColumnToDesc(tdHistory, MSHistory::PredefinedColumns(i));
      ...
      for (uint32_t i = 1 ; i<=MSObservation::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSObservation::addColumnToDesc(tdObservation, MSObservation::PredefinedColumns(i));
      ...
      for (uint32_t i = 1 ; i<=MSPointing::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSPointing::addColumnToDesc(tdPointing, MSPointing::PredefinedColumns(i));
      ...
      for (uint32_t i = 1 ; i<=MSPolarization::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSPolarization::addColumnToDesc(tdPolarization, MSPolarization::PredefinedColumns(i));
      ...
      for (uint32_t i = 1 ; i<=MSProcessor::NUMBER_PREDEFINED_COLUMNS; i++) {
	...
	MSSource::addColumnToDesc(tdSource, MSSource::PredefinedColumns(i));
      ...
      for (uint32_t i = 1 ; i<=MSSpectralWindow::NUMBER_PREDEFINED_COLUMNS; i++) {
	...
	MSState::addColumnToDesc(tdState, MSState::PredefinedColumns(i));
      ...
      TableDesc tdSysCal;
      for (uint32_t i = 1 ; i<=MSSysCal::NUMBER_PREDEFINED_COLUMNS; i++) {
	MSSysCal::addColumnToDesc(tdSysCal, MSSysCal::PredefinedColumns(i));
      ...
      TableDesc tdWeather;
      for (uint32_t i = 1 ; i<=MSWeather::NUMBER_PREDEFINED_COLUMNS; i++) {
