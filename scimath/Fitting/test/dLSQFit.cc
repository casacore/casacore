...
int main() {
  ...
  showdt(lsq1, 1);
  lsq1.solve(sol1);
  std::cout << "Sol: " << sol1[0] << ", " << lsq1.getSD() << ", " << lsq1.getWeightedSD()
            << std::endl;
  ...
  LSQFit lsq3(1);
  {
    ...
    showdt(lsq3, 1);
    lsq3.solve(sol1);
    std::cout << "Sol: " << sol1[0] << ", " << lsq3.getSD() << ", " << lsq3.getWeightedSD()
              << std::endl;
  ...
  LSQFit lsq2(2);
  {
    ...
    showdt(lsq2, 2);
    lsq2.solve(sol1);
    std::cout << "Sol: " << sol1[0] << ", " << lsq2.getSD() << ", " << lsq2.getWeightedSD()
              << std::endl;
    std::cout << "Sol: " << sol1[1] << ", " << lsq2.getSD() << ", " << lsq2.getWeightedSD()
              << std::endl;
