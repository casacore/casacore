...
int main() {
  ...
  printparameters(components);
  cout << "Solution Parameters:";
  printparameters(solution);
  solution = fitgauss.solution();
  cout << "Internal Parameters:";
  printparameters(solution);
  errors = fitgauss.errors();
  cout << "Error in Parameters::";
  printparameters(errors);
  ...
  retryfactors(0, 2) = 2;
  retryfactors(0, 3) = 2;
  retryfactors(0, 4) = 1.1;
  retryfactors(0, 5) = 0;
  retryfactors(1, 0) = 1.5;
  retryfactors(1, 1) = 0;
  retryfactors(1, 2) = 1.5;
  retryfactors(1, 3) = 1.5;
  retryfactors(1, 4) = 1.2;
  retryfactors(1, 5) = 0;
  ...
  if (solution(0, 1) != fitgauss.solution()(0, 1)) fail = 1;
