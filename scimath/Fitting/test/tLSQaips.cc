...
int main() {
  ...
  Complex vcce[M][N] = {{Complex(1, 0), Complex(1, 0), Complex(1, 0)},
                        {Complex(1, 0), Complex(0, -1), Complex(2, 0)},
                        {Complex(1, 0), Complex(-2, 0), Complex(0, 2)},
                        {Complex(1, 0), Complex(1, 0), Complex(1, 0)},
                        {Complex(1, 0), Complex(0, -1), Complex(2, 0)},
                        {Complex(1, 0), Complex(-2, 0), Complex(0, 2)}};
  Complex cob[M] = {Complex(6, 4), Complex(3, 8), Complex(-15, 9),
                    Complex(6, 4), Complex(3, 8), Complex(-15, 9)};
  DComplex vdcce[M][N] = {{DComplex(1, 0), DComplex(1, 0), DComplex(1, 0)},
  ...
  DComplex dcob[M] = {DComplex(6, 4), DComplex(3, 8), DComplex(-15, 9),
  ...
  try {
    ...
    cout << "DComplex Non-linear------------" << endl;
    {
      ...
      while (!lnl.isReady()) {
        for (uInt i = 0; i < n; i++) {
          DComplex A =
              vsol[0] * exp(-(((x[i] - vsol[1]) / vsol[2]) * ((x[i] - vsol[1]) / vsol[2])));
      ...
      cout << "Sol:       " << vsol[0] << ", " << vsol[1] << ", " << vsol[2] << endl;
      cout << "me:        " << mu << ", " << me << endl;
    ...
    cout << "Complex Non-linear------------" << endl;
    {
      ...
      while (!lnl.isReady()) {
        for (uInt i = 0; i < n; i++) {
          Complex A = vsol[0] * exp(-(((x[i] - vsol[1]) / vsol[2]) * ((x[i] - vsol[1]) / vsol[2])));
    ...
    cout << "Non-linear------------" << endl;
    {
      ...
      while (!lnl.isReady()) {
        for (uInt i = 0; i < n; i++) {
          Double A = vsol[0] * exp(-(((x[i] - vsol[1]) / vsol[2]) * ((x[i] - vsol[1]) / vsol[2])));
    ...
    }
    {
      ...
      cout << "Sol:       " << soldit[0] << ", " << soldit[1] << ", " << soldit[2] << endl;
      cout << "me:        " << mu << ", " << me << endl;
