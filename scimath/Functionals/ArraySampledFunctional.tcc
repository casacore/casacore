...
template <class T>
ArraySampledFunctional<T>::ArraySampledFunctional()
    : theRefData(), theEnd(), theLastAxis(0), theNelements(0) {}
...
template <class T>
ArraySampledFunctional<T>::ArraySampledFunctional(ArraySampledFunctional<T> &other)
...
template <class T>
ArraySampledFunctional<T> &ArraySampledFunctional<T>::operator=(ArraySampledFunctional<T> &other) {
  if (this != &other) {
