...
class ChebyshevParam : public Function1D<T> {
 public:
  ...
  ChebyshevParam(const ChebyshevParam<W> &other)
      : Function1D<T>(other),
        def_p(other.getDefault()),
        minx_p(other.getIntervalMin()),
        maxx_p(other.getIntervalMax()),
  ...
  // Chebyshev interval
  void setOutOfIntervalMode(ChebyshevEnums::OutOfIntervalMode mode) { mode_p = mode; }

  // return the behavior of this function when it is evaluated outside of
  // its Chebyshev interval.
  ChebyshevEnums::OutOfIntervalMode getOutOfIntervalMode() const { return mode_p; }
...
class ChebyshevParamModeImpl : public ChebyshevParam<T> {
 public:
  ...
  ChebyshevParamModeImpl(const Vector<T> &coeffs, const T &min, const T &max,
                         typename ChebyshevEnums::OutOfIntervalMode mode = ChebyshevEnums::CONSTANT,
                         const T &defval = T(0))
...
class ChebyshevParamModeImpl_PS<AutoDiff<T>> : public ChebyshevParam<AutoDiff<T>> {
 public:
  ...
  ChebyshevParamModeImpl_PS(
      const Vector<AutoDiff<T>> &coeffs, const AutoDiff<T> &min, const AutoDiff<T> &max,
      typename ChebyshevEnums::OutOfIntervalMode mode = ChebyshevEnums::CONSTANT,
      const AutoDiff<T> &defval = AutoDiff<T>(0))
...
class ChebyshevParamModeImpl_PSA<AutoDiffA<T>> : public ChebyshevParam<AutoDiffA<T>> {
 public:
  ...
  ChebyshevParamModeImpl_PSA(
      const Vector<AutoDiffA<T>> &coeffs, const AutoDiffA<T> &min, const AutoDiffA<T> &max,
      typename ChebyshevEnums::OutOfIntervalMode mode = ChebyshevEnums::CONSTANT,
      const AutoDiffA<T> &defval = AutoDiffA<T>(0))
