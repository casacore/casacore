// # EvenPolynomial2.cc: Even polynomial class specialized for AutoDiff
// # Copyright (C) 2002
...
// # Operators
template <class T>
AutoDiff<T> EvenPolynomial<AutoDiff<T>>::eval(typename Function<AutoDiff<T>>::FunctionArg x) const {
  AutoDiff<T> tmp;
