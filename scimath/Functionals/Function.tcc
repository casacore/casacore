...
template <class T, class U>
U Function<T, U>::operator()(const ArgType &x, const ArgType &y, const ArgType &z) const {
...
template <class T, class U>
Function<typename FunctionTraits<T>::DiffType> *Function<T, U>::cloneAD() const {
  throw(AipsError(String("Function `") + name() + "' has no cloneAD() method"));
}

template <class T, class U>
Function<typename FunctionTraits<T>::BaseType> *Function<T, U>::cloneNonAD() const {
  throw(AipsError(String("Function `") + name() + "' has no cloneNonAD() method"));
}
