...
FunctionOrder<T>::FunctionOrder()
    : int_p(0), double_p(0), string_p(""), function_p(0), scale_p(0), center_p(0), width_p(0) {}

template <class T>
FunctionOrder<T>::FunctionOrder(const FunctionOrder<T> &other)
    : int_p(other.int_p.copy()),
      double_p(other.double_p.copy()),
      string_p(other.string_p),
      function_p(other.function_p.nelements()),
