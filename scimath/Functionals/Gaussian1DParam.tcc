...
// # Constructors
template <class T>
Gaussian1DParam<T>::Gaussian1DParam() : Function1D<T>(3), fwhm2int(T(1.0) / sqrt(log(T(16.0)))) {
...
Gaussian1DParam<T>::Gaussian1DParam(const T &height)
    : Function1D<T>(3), fwhm2int(T(1.0) / sqrt(log(T(16.0)))) {
...
template <class T>
Gaussian1DParam<T>::Gaussian1DParam(const T &height, const T &center, const T &width)
    : Function1D<T>(3), fwhm2int(T(1.0) / sqrt(log(T(16.0)))) {
  param_p[HEIGHT] = height;
  param_p[CENTER] = center;
  param_p[WIDTH] = width;
...
// # Operators
template <class T>
Gaussian1DParam<T> &Gaussian1DParam<T>::operator=(const Gaussian1DParam<T> &other) {
  if (this != &other) {
