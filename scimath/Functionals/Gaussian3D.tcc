...
template <class T>
Gaussian3D<T>::Gaussian3D() : Gaussian3DParam<T>() {}

template <class T>
Gaussian3D<T>::Gaussian3D(T &height, T &xCenter, T &yCenter, T &zCenter, T &xWidth, T &yWidth,
                          T &zWidth, T &theta, T &phi)
    : Gaussian3DParam<T>(height, xCenter, yCenter, zCenter, xWidth, yWidth, zWidth, theta, phi) {}

template <class T>
Gaussian3D<T>::Gaussian3D(T height, const Vector<T> &center, const Vector<T> &width, T theta, T phi)
...
template <class T>
Gaussian3D<T>::Gaussian3D(const Gaussian3D<T> &other) : Gaussian3DParam<T>(other) {}
...
T Gaussian3D<T>::eval(typename Function<T>::FunctionArg x) const {
  ...
  v = param_p[H] * exp(-sq((cosTcosP_p * Nx + sinT_p * Ny - cosTsinP_p * Nz) / Ax) -
