...
template <class T>
KaiserBParam<T>::KaiserBParam() : Function<T>(4) {
...
template <class T>
KaiserBParam<T>::KaiserBParam(const T &kbpar) : Function<T>(4) {
  param_p[HEIGHT] = T(1.0);
  param_p[CENTER] = T(0.0);
  param_p[WIDTH] = T(1.0);
  param_p[KBPAR] = kbpar;
...
template <class T>
KaiserBParam<T>::KaiserBParam(const KaiserBParam<T> &other) : Function<T>(other) {}
