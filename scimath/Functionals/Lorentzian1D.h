...
template <class T>
class Lorentzian1D : public Lorentzian1DParam<T> {
 public:
  // # Enumerations
  ...
  Lorentzian1D(const T &height, const T &center) : Lorentzian1DParam<T>(height, center) {};
  ...
  Lorentzian1D<T> &operator=(const Lorentzian1D<T> &other) {
    Lorentzian1DParam<T>::operator=(other);
    return *this;
  };
...
template <class T>
class Lorentzian1D_PS<AutoDiff<T>> : public Lorentzian1DParam<AutoDiff<T>> {
 public:
  // # Constructors
  //  Constructs one dimensional Lorentzians.
  //  <group>
  Lorentzian1D_PS() : Lorentzian1DParam<AutoDiff<T>>() {};
  explicit Lorentzian1D_PS(const AutoDiff<T> &height) : Lorentzian1DParam<AutoDiff<T>>(height) {};
  ...
  // Copy constructor (deep copy)
  // <group>
  Lorentzian1D_PS(const Lorentzian1D_PS &other) : Lorentzian1DParam<AutoDiff<T>>(other) {};
  template <class W>
  Lorentzian1D_PS(const Lorentzian1D_PS<W> &other) : Lorentzian1DParam<AutoDiff<T>>(other) {}
  // </group>

  // Copy assignment (deep copy)
  Lorentzian1D_PS<AutoDiff<T>> &operator=(const Lorentzian1D_PS<AutoDiff<T>> &other) {
    Lorentzian1DParam<AutoDiff<T>>::operator=(other);
    return *this;
  };
  ...
  //  for deleting this pointer.
  //  <group>
  virtual Function<AutoDiff<T>> *clone() const { return new Lorentzian1D<AutoDiff<T>>(*this); };
  virtual Function<typename FunctionTraits<AutoDiff<T>>::DiffType> *cloneAD() const {
    return new Lorentzian1D<typename FunctionTraits<AutoDiff<T>>::DiffType>(*this);
  };
  virtual Function<typename FunctionTraits<AutoDiff<T>>::BaseType> *cloneNonAD() const {
    return new Lorentzian1D<typename FunctionTraits<AutoDiff<T>>::BaseType>(*this);
  };
  // </group>
