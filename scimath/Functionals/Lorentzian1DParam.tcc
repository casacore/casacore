...
// # Constructors
template <class T>
Lorentzian1DParam<T>::Lorentzian1DParam() : Function1D<T>(3), fwhm2int(T(1.0) / T(2.0)) {
...
Lorentzian1DParam<T>::Lorentzian1DParam(const T &height)
    : Function1D<T>(3), fwhm2int(T(1.0) / T(2.0)) {
...
template <class T>
Lorentzian1DParam<T>::Lorentzian1DParam(const T &height, const T &center, const T &width)
    : Function1D<T>(3), fwhm2int(T(1.0) / T(2.0)) {
  param_p[HEIGHT] = height;
  param_p[CENTER] = center;
  param_p[WIDTH] = width;
...
Lorentzian1DParam<T>::Lorentzian1DParam(const Lorentzian1DParam<T> &other)
    : Function1D<T>(other), fwhm2int(T(1.0) / T(2.0)) {}
...
// # Operators
template <class T>
Lorentzian1DParam<T> &Lorentzian1DParam<T>::operator=(const Lorentzian1DParam<T> &other) {
  if (this != &other) {
