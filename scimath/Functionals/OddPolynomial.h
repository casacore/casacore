...
template <class T>
class OddPolynomial : public OddPolynomialParam<T> {
 public:
  // # Enumerations
  ...
  template <class W>
  OddPolynomial(const OddPolynomial<W> &other) : OddPolynomialParam<T>(other) {}
  OddPolynomial<T> &operator=(const OddPolynomial<T> &other) {
    OddPolynomialParam<T>::operator=(other);
    return *this;
  }
  // </group>
...
template <class T>
class OddPolynomial_PS<AutoDiff<T>> : public OddPolynomialParam<AutoDiff<T>> {
 public:
  // # Constructors
  ...
  template <class W>
  OddPolynomial_PS(const OddPolynomial_PS<W> &other) : OddPolynomialParam<AutoDiff<T>>(other) {}
  // </group>
  // Copy assignment (deep copy)
  OddPolynomial_PS<AutoDiff<T>> &operator=(const OddPolynomial_PS<AutoDiff<T>> &other) {
    OddPolynomialParam<AutoDiff<T>>::operator=(other);
    return *this;
  }
  ...
  //  <group>
  virtual Function<AutoDiff<T>> *clone() const { return new OddPolynomial<AutoDiff<T>>(*this); }
  virtual Function<typename FunctionTraits<AutoDiff<T>>::DiffType> *cloneAD() const {
    return new OddPolynomial<typename FunctionTraits<AutoDiff<T>>::DiffType>(*this);
  }
  virtual Function<typename FunctionTraits<AutoDiff<T>>::BaseType> *cloneNonAD() const {
    return new OddPolynomial<typename FunctionTraits<AutoDiff<T>>::BaseType>(*this);
  }
  // </group>
