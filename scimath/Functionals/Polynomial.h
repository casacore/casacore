...
template <class T>
class Polynomial : public PolynomialParam<T> {
 public:
  // # Enumerations
  ...
  Polynomial<T> &operator=(const Polynomial<T> &other) {
    PolynomialParam<T>::operator=(other);
    return *this;
  }
  // </group>
...
template <class T>
class Polynomial_PS<AutoDiff<T>> : public PolynomialParam<AutoDiff<T>> {
 public:
  // # Constructors
  ...
  // <group>
  Polynomial_PS(const Polynomial_PS<AutoDiff<T>> &other) : PolynomialParam<AutoDiff<T>>(other) {}
  template <class W>
  Polynomial_PS(const Polynomial_PS<W> &other) : PolynomialParam<AutoDiff<T>>(other) {}
  // </group>

  // Copy assignment (deep copy)
  Polynomial_PS<AutoDiff<T>> &operator=(const Polynomial_PS<AutoDiff<T>> &other) {
    PolynomialParam<AutoDiff<T>>::operator=(other);
    return *this;
  }
  ...
  //  <group>
  virtual Function<AutoDiff<T>> *clone() const { return new Polynomial<AutoDiff<T>>(*this); }
  virtual Function<typename FunctionTraits<AutoDiff<T>>::DiffType> *cloneAD() const {
    return new Polynomial<typename FunctionTraits<AutoDiff<T>>::DiffType>(*this);
  }
  virtual Function<typename FunctionTraits<AutoDiff<T>>::BaseType> *cloneNonAD() const {
    return new Polynomial<typename FunctionTraits<AutoDiff<T>>::BaseType>(*this);
  }
  // </group>
