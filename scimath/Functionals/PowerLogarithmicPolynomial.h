...
template <class T>
class PowerLogarithmicPolynomial : public PowerLogarithmicPolynomialParam<T> {
 public:
  ...
  PowerLogarithmicPolynomial(const PowerLogarithmicPolynomial<T> &other)
      : PowerLogarithmicPolynomialParam<T>(other) {}
  template <class W>
  ...
  PowerLogarithmicPolynomial<T> &operator=(const PowerLogarithmicPolynomial<T> &other) {
    PowerLogarithmicPolynomialParam<T>::operator=(other);
    return *this;
  }
  // </group>
...
class PowerLogarithmicPolynomial_PS<AutoDiff<T>>
 ...
 public:
  ...
  PowerLogarithmicPolynomial_PS<AutoDiff<T>> &operator=(
      const PowerLogarithmicPolynomial_PS<AutoDiff<T>> &other) {
    PowerLogarithmicPolynomialParam<AutoDiff<T>>::operator=(other);
    return *this;
  }
  ...
  virtual Function<typename FunctionTraits<AutoDiff<T>>::DiffType> *cloneAD() const {
    return new PowerLogarithmicPolynomial<typename FunctionTraits<AutoDiff<T>>::DiffType>(*this);
  }
  virtual Function<typename FunctionTraits<AutoDiff<T>>::BaseType> *cloneNonAD() const {
    return new PowerLogarithmicPolynomial<typename FunctionTraits<AutoDiff<T>>::BaseType>(*this);
  }
  // </group>
