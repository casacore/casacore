...
template <class T>
PowerLogarithmicPolynomialParam<T>::PowerLogarithmicPolynomialParam() : Function1D<T>(2) {
  setCoefficient(0, 1);
  setCoefficient(1, 1);
}
...
PowerLogarithmicPolynomialParam<T>::PowerLogarithmicPolynomialParam(
    const PowerLogarithmicPolynomialParam<T> &other)
    : Function1D<T>(other) {}
...
template <class T>
PowerLogarithmicPolynomialParam<T> &PowerLogarithmicPolynomialParam<T>::operator=(
    const PowerLogarithmicPolynomialParam<T> &other) {
...
void PowerLogarithmicPolynomialParam<T>::setCoefficients(const Vector<T> &coefficients) {
  if (coefficients.size() < 2) {
    throw AipsError(
        "PowerLogarithmicPolynomialParam<T>::setCoefficients(): Number of coefficients must be at "
        "least 2");
  }
