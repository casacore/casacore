...
template <class T>
SPolynomialParam<T>::SPolynomialParam(const SPolynomialParam<T> &other) : Function<T>(other) {}

template <class T>
SPolynomialParam<T>::~SPolynomialParam() {}

template <class T>
SPolynomialParam<T> &SPolynomialParam<T>::operator=(const SPolynomialParam<T> &other) {
