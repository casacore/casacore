...
void SerialHelper::checkFuncType(const String& ftype) const {
  String thistype;
  if (!getFuncType(thistype)) throw InvalidSerializationError("No functype field defined");
  if (ftype != thistype)
    throw InvalidSerializationError(String("Wrong functype (need ") + ftype + ", found " +
                                    thistype);
}
...
void getArrayVal<Bool>(Bool& val, Int, const Record& gr, const String& name, uInt index) {
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name + " field (need TpBool," +
                                      " found record)");
      break;
  }
}
...
void getArrayVal<Short>(Short& val, Int, const Record& gr, const String& name, uInt index) {
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name + " field (need TpShort," +
                                      " found record)");
      break;
  }
}
...
void getArrayVal<Int>(Int& val, Int, const Record& gr, const String& name, uInt index) {
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name + " field (need TpInt," +
                                      " found record)");
      break;
  }
}
...
void getArrayVal<Float>(Float& val, Int, const Record& gr, const String& name, uInt index) {
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name + " field (need TpFloat," +
                                      " found record)");
      break;
  }
}
...
void getArrayVal<Double>(Double& val, Int, const Record& gr, const String& name, uInt index) {
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name + " field (need TpDouble," +
                                      " found record)");
      break;
  }
}
...
void getArrayVal<Complex>(Complex& val, Int, const Record& gr, const String& name, uInt index) {
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name + " field (need TpComplex," +
                                      " found record)");
      break;
  }
}
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name +
                                      " field (need TpDComplex," + " found record)");
      break;
  }
}
template <>
void getArrayVal<String>(String& val, Int, const Record& gr, const String& name, uInt index) {
  ...
  switch (gr.dataType(RecordFieldId(name))) {
    ...
    default:
      throw InvalidSerializationError(String("Wrong type for ") + name + " field (need TpString," +
                                      " found record)");
      break;
  }
}
...
void getArray<Bool>(Array<Bool>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayBool)
    throw InvalidSerializationError(String("Wrong type for ") + name + " field (need array bool," +
                                    " found record)");
...
void getArray<Short>(Array<Short>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayShort)
    throw InvalidSerializationError(String("Wrong type for ") + name + " field (need array short," +
                                    " found record)");
...
void getArray<Int>(Array<Int>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayInt)
    throw InvalidSerializationError(String("Wrong type for ") + name + " field (need array int," +
                                    " found record)");
...
void getArray<Float>(Array<Float>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayFloat)
    throw InvalidSerializationError(String("Wrong type for ") + name + " field (need array float," +
                                    " found record)");
...
void getArray<Double>(Array<Double>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayDouble)
    throw InvalidSerializationError(String("Wrong type for ") + name +
                                    " field (need array double," + " found record)");
...
void getArray<Complex>(Array<Complex>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayComplex)
    throw InvalidSerializationError(String("Wrong type for ") + name +
                                    " field (need array complex," + " found record)");
...
void getArray<DComplex>(Array<DComplex>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayDComplex)
    throw InvalidSerializationError(String("Wrong type for ") + name +
                                    " field (need array dcomplex," + " found record)");
...
void getArray<String>(Array<String>& val, Int, const Record& gr, const String& name) {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpArrayString)
    throw InvalidSerializationError(String("Wrong type for ") + name +
                                    " field (need array string," + " found record)");
...
void SerialHelper::get(Record& val, const String& name) const {
  ...
  if (gr.dataType(RecordFieldId(name)) != TpRecord)
    throw InvalidSerializationError(String("Wrong type for ") + name + " field (need record," +
                                    " found array)");
