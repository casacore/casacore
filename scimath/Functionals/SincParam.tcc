...
template <class T>
SincParam<T>::SincParam() : Function<T>(3) {
...
template <class T>
SincParam<T>::SincParam(const T &height) : Function<T>(3) {
...
template <class T>
SincParam<T>::SincParam(const T &height, const T &center) : Function<T>(3) {
  param_p[HEIGHT] = height;
...
template <class T>
SincParam<T>::SincParam(const T &height, const T &center, const T &width) : Function<T>(3) {
  param_p[HEIGHT] = height;
  param_p[CENTER] = center;
  param_p[WIDTH] = width;
}
...
template <class T>
SincParam<T>::SincParam(const SincParam<T> &other) : Function<T>(other) {}
