...
template <class T>
class Sinusoid1D : public Sinusoid1DParam<T> {
 public:
  // # Enumerations
  ...
  Sinusoid1D<T> &operator=(const Sinusoid1D<T> &other) {
    Sinusoid1DParam<T>::operator=(other);
    return *this;
  }
...
template <class T>
class Sinusoid1D_PS<AutoDiff<T>> : public Sinusoid1DParam<AutoDiff<T>> {
 public:
  // # Constructors
  //  Constructs one dimensional Sinusoids.
  //  <group>
  Sinusoid1D_PS() : Sinusoid1DParam<AutoDiff<T>>() {}
  explicit Sinusoid1D_PS(const AutoDiff<T> &amplitude) : Sinusoid1DParam<AutoDiff<T>>(amplitude) {}
  ...
  // Copy constructor (deep copy)
  // <group>
  Sinusoid1D_PS(const Sinusoid1D_PS &other) : Sinusoid1DParam<AutoDiff<T>>(other) {}
  template <class W>
  Sinusoid1D_PS(const Sinusoid1D_PS<W> &other) : Sinusoid1DParam<AutoDiff<T>>(other) {}
  // </group>

  // Copy assignment (deep copy)
  Sinusoid1D_PS<AutoDiff<T>> &operator=(const Sinusoid1D_PS<AutoDiff<T>> &other) {
    Sinusoid1DParam<AutoDiff<T>>::operator=(other);
    return *this;
  }
  ...
  //  for deleting this pointer.
  //  <group>
  virtual Function<AutoDiff<T>> *clone() const { return new Sinusoid1D<AutoDiff<T>>(*this); }
  virtual Function<typename FunctionTraits<AutoDiff<T>>::DiffType> *cloneAD() const {
    return new Sinusoid1D<typename FunctionTraits<AutoDiff<T>>::DiffType>(*this);
  }
  virtual Function<typename FunctionTraits<AutoDiff<T>>::BaseType> *cloneNonAD() const {
    return new Sinusoid1D<typename FunctionTraits<AutoDiff<T>>::BaseType>(*this);
  }
  // </group>
