...
template <class T>
UnaryParam<T>::UnaryParam() : Function<T>(3) {
...
template <class T>
UnaryParam<T>::UnaryParam(const T &height) : Function<T>(3) {
...
template <class T>
UnaryParam<T>::UnaryParam(const T &height, const T &center) : Function<T>(3) {
  param_p[HEIGHT] = height;
...
template <class T>
UnaryParam<T>::UnaryParam(const T &height, const T &center, const T &width) : Function<T>(3) {
  param_p[HEIGHT] = height;
  param_p[CENTER] = center;
  param_p[WIDTH] = width;
}
...
template <class T>
UnaryParam<T>::UnaryParam(const UnaryParam<T> &other) : Function<T>(other) {}
