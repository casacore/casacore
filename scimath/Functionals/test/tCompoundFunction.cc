...
int main() {
  ...
  AlwaysAssertExit(allEQ(sumfunc.parameters().getParameters(), f2.parameters().getParameters()) &&
                   allEQ(sumfunc.parameters().getParameters(), f3.parameters().getParameters()));

  //     uInt nFunctions() const { return functions_p.nelements(); }
  AlwaysAssertExit(sumfunc.nFunctions() == 2 && f2.nFunctions() == 2 && f3.nFunctions() == 2);
  ...
  AlwaysAssertExit(sumfunc[0] == 0.0 && sumfunc[1] == 0.0 && sumfunc[2] == 1.0 &&
                   sumfunc[3] == 1.0 && sumfunc[4] == 0.0 && near(sumfunc[5], sqrt(log(16.0))));
