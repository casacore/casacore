...
int main() {
  ...
  AlwaysAssertExit(null.height() == 1.0 && null.center() == 0.0 && null.width() == 1.0);
  ...
  AlwaysAssertExit(gauss1.height() == 4.0 && gauss1.center() == 6.0 && gauss1.width() == 8.0);
  const Gaussian1D<Double> &cgauss1 = gauss1;
  AlwaysAssertExit(cgauss1.height() == 4.0 && cgauss1.center() == 6.0 && cgauss1.width() == 8.0);
  ...
  AlwaysAssertExit(gauss1[Gaussian1D<Double>::WIDTH] == 4.0 &&
                   ...
                   near(gauss1[Gaussian1D<Double>::HEIGHT], 1.0 / 4.0 / sqrt(M_PI / log(16.0))));
  ...
  cout << "AD: " << g1adc << endl << "f(5) = " << g1adc(xvec(0)) << endl;
  Gaussian1D<Double> g1cb(g1adc);
  cout << "Copy back: " << g1cb << endl << "f(5) = " << g1cb(xvec(0)) << endl;
  ...
  Gaussian1D<AutoDiff<Double>> gauss5(AutoDiff<Double>(4.0), AutoDiff<Double>(6.0),
                                      AutoDiff<Double>(8.0));
  AlwaysAssertExit(gauss5.height() == 4.0 && gauss5.center() == 6.0 && gauss5.width() == 8.0);
  const Gaussian1D<AutoDiff<Double>> &cgauss5 = gauss5;
  AlwaysAssertExit(cgauss5.height() == 4.0 && cgauss5.center() == 6.0 && cgauss5.width() == 8.0);
  ...
  AlwaysAssertExit(
      gauss5[Gaussian1D<AutoDiff<Double>>::WIDTH] == 4.0 &&
      gauss5[Gaussian1D<AutoDiff<Double>>::CENTER] == 3.0 &&
      near(gauss5[Gaussian1D<AutoDiff<Double>>::HEIGHT], 1.0 / 4.0 / sqrt(M_PI / log(16.0))));
  ...
  Gaussian1D<AutoDiffA<Double>> gauss6(AutoDiffA<Double>(4.0), AutoDiffA<Double>(6.0),
                                       AutoDiffA<Double>(8.0));
  AlwaysAssertExit(gauss6.height() == 4.0 && gauss6.center() == 6.0 && gauss6.width() == 8.0);
  const Gaussian1D<AutoDiffA<Double>> &cgauss6 = gauss6;
  AlwaysAssertExit(cgauss6.height() == 4.0 && cgauss6.center() == 6.0 && cgauss6.width() == 8.0);
  ...
  AlwaysAssertExit(
      gauss6[Gaussian1D<AutoDiffA<Double>>::WIDTH] == 4.0 &&
      gauss6[Gaussian1D<AutoDiffA<Double>>::CENTER] == 3.0 &&
      near(gauss6[Gaussian1D<AutoDiffA<Double>>::HEIGHT], 1.0 / 4.0 / sqrt(M_PI / log(16.0))));
  ...
  gauss1[1] = 2.0;
  gauss1[2] = 3.0;
  AlwaysAssertExit(gauss1.height() == 1.0 && gauss1.center() == 2.0 && gauss1.width() == 3.0);

  AlwaysAssertExit(
      near(gauss5(5.0).value(), gauss6(AutoDiffA<Double>(5.0)).value()) &&
      allNear(gauss5(5.0).derivatives(), gauss6(AutoDiffA<Double>(5.0)).derivatives(), 1e-13));
  parms = 11.0;
  ...
  AlwaysAssertExit(nearAbs(gauss1(1.0), 1.11238, 1e-5)) Function<Double> *gauss4ptr =
      gauss1.clone();
  cout << "f.clone(1):              " << (*gauss4ptr)(1.0) << endl;
  AlwaysAssertExit(near(gauss1(1.0), (*gauss4ptr)(1.0))) Function<Double> *gauss4a =
      gauss1.cloneNonAD();
  cout << "f.cloneNonAD(1):         " << (*gauss4a)(1.0) << endl;
  AlwaysAssertExit(near(gauss1(1.0), (*gauss4a)(1.0))) Function<AutoDiff<Double>> *gauss4b =
      gauss1.cloneAD();
