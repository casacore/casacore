...
int main() {
  ...
  AlwaysAssertExit(null.order() == 0 && linear.order() == 1 && square.order() == 2 &&
                   null[0] == 0.0f && linear[0] == 0.0f && linear[1] == 1.0f && square[0] == 0.0f &&
                   square[1] == 0.0f && square.coefficient(2) == 1.0f);
  AlwaysAssertExit(null.nparameters() == 1 && square.nparameters() == 3);
  ...
  AlwaysAssertExit(der1.order() == 1 && der1.coefficient(0) == 0.0f && der1.coefficient(1) == 2.0f);
  Polynomial<Float> der2 = tmp1.derivative();
  AlwaysAssertExit(der2.order() == 2 && der2.coefficient(0) == 1.0f &&
                   der2.coefficient(1) == 4.0f && der2.coefficient(2) == 9.0f);
  //	clone()
  //     ~Polynomial();
