...
int main() {
  ...
  AlwaysAssertExit(butt.getCenter() == 0.0 && butt.getPeak() == 1.0);
  AlwaysAssertExit(butt.getMinOrder() == 1.0 && butt.getMaxOrder() == 1.0);
  AlwaysAssertExit(butt.getMinCutoff() == -1.0 && butt.getMaxCutoff() == 1.0);
  ...
  butt.setMode(rec);
  AlwaysAssertExit(butt.getMinOrder() == 2 && butt.getMaxOrder() == 3);
