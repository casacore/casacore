...
int main() {
  ...
  AlwaysAssertExit(s1.amplitude() == 4.0 && s1.period() == 6.0 && s1.x0() == 8.0);
  const Sinusoid1D<Double> &cs1 = s1;
  AlwaysAssertExit(cs1.amplitude() == 4.0 && cs1.period() == 6.0 && cs1.x0() == 8.0);
  s1.setAmplitude(2.0);
  s1.setPeriod(3.0);
  s1.setX0(4.0);
  AlwaysAssertExit(s1[Sinusoid1D<Double>::X0] == 4.0 && s1[Sinusoid1D<Double>::PERIOD] == 3.0 &&
  ...
  AlwaysAssertExit(near(y50, 1.0) && near(y51(0), cos(y1)) &&
  ...
  AlwaysAssertExit(near(y60, 1.0) && near(y61(0), cos(y1)) &&
  ...
  s1[1] = 2.0;
  s1[2] = 3.0;
  AlwaysAssertExit(s1.amplitude() == 1.0 && s1.period() == 2.0 && s1.x0() == 3.0);
  parms = 11.0;
