...
// float & float, double & double and int32_t & int.
// </note>
...
// </dl>
// <group>
static void cffti(int32_t n, float* wsave);
static void cffti(int32_t n, double* wsave);
...
static void cfft2i(const int32_t& n, const int32_t& m, float *& wsave, const int32_t& lensav, int32_t& ier);
// </group>
...
// </dl>
// <group>
static void cfftf(int32_t n, Complex* c, float* wsave);
static void cfftf(int32_t n, DComplex* c, double* wsave);
...
Input Arguments
 ...
 LENWRK  Integer dimension of WORK array.  LENWRK must be at least
         2*L*M.
*/
static void cfft2f (const int32_t& ldim, const int32_t& L, const int32_t& M, Complex*& C, float*& WSAVE, const int32_t& LENSAV,
...
// </dl>
// <group>
static void cfftb(int32_t n, Complex* c, float* wsave);
static void cfftb(int32_t n, DComplex* c, double* wsave);
...
static void cfft2b (const int32_t& LDIM, const int32_t& L, const int32_t& M, Complex* & C, float *& WSAVE, const int32_t& LENSAV,
		    float*& WORK, const int32_t& LENWRK, int32_t& IER);
// </group>
...
// </dl>
// <group>
static void rffti(int32_t n, float* wsave);
static void rffti(int32_t n, double* wsave);
// </group>
...
// </dl>
// <group>
static void rfftf(int32_t n, float* r, float* wsave);
static void rfftf(int32_t n, double* r, double* wsave);
// </group>
...
// </dl>
// <group>
static void rfftb(int32_t n, float* r, float* wsave);
static void rfftb(int32_t n, double* r, double* wsave);
// </group>
...
// </dl>
static void ezffti(int32_t n, float* wsave);
...
// </dl>
static void ezfftf(int32_t n, float* r, float* azero, float* a, float* b, 
	    float* wsave);
...
//                   and i=sqrt(-1)<br>
// </dl>
static void ezfftb(int32_t n, float* r, float* azero, float* a, float* b, 
	    float* wsave);
...
// </dl>
// <group>
static void sinti(int32_t n, float* wsave);
static void sinti(int32_t n, double* wsave);
// </group>
...
// </dl>
// <group>
static void sint(int32_t n, float* x, float* wsave);
static void sint(int32_t n, double* x, double* wsave);
// </group>
...
// </dl>
// <group>
static void costi(int32_t n, float* wsave);
static void costi(int32_t n, double* wsave);
// </group>
...
// </dl>
// <group>
static void cost(int32_t n, float* x, float* wsave);
static void cost(int32_t n, double* x, double* wsave);
// </group>
...
// </dl>
// <group>
static void sinqi(int32_t n, float* wsave);
static void sinqi(int32_t n, double* wsave);
// </group>
...
// </dl>
// <group>
static void sinqf(int32_t n, float* x, float* wsave);
static void sinqf(int32_t n, double* x, double* wsave);
// </group>
...
// </dl>
// <group>
static void sinqb(int32_t n, float* x, float* wsave);
static void sinqb(int32_t n, double* x, double* wsave);
// </group>

// <group>
static void cosqi(int32_t n, float* wsave);
static void cosqi(int32_t n, double* wsave);
// </group>
// <group>
static void cosqf(int32_t n, float* x, float* wsave);
static void cosqf(int32_t n, double* x, double* wsave);
// </group>
// <group>
static void cosqb(int32_t n, float* x, float* wsave);
static void cosqb(int32_t n, double* x, double* wsave);
// </group>
};
