...
// <dt> <src>getValue(T &other, const uint32_t n)</src>
// <dd> Get the <src>n%size()-th</src> value in the argument.
//	For complex numbers the sequence is real, imaginary part.
// <dt> <src>setValue(T &other, const BaseType &val, const uint32_t n)</src>
...
public:
  ...
  static BaseType getValue(const T &, const uint32_t) { return 0; }
  // Set the <src>n%size()-th</src> numeric value
  static void setValue(T &, const BaseType &, const uint32_t) {;}
};
...
public:
  ...
  // Get the <src>n%size()-th</src> numeric value
  static BaseType getValue(const value_type &other, const uint32_t) {
    return other; }
  // Set the <src>n%size()-th</src> numeric value
  static void setValue(value_type &other, const BaseType &val, const uint32_t) {
    other = val; }
};
...
public:
  ...
  // Get the <src>n%size()-th</src> numeric value
  static BaseType getValue(const value_type &other, const uint32_t n) {
    return ((n%2 == 0) ? other.real() : other.imag()); }
  // Set the <src>n%size()-th</src> numeric value
  static void setValue(value_type &other, const BaseType &val, const uint32_t n) {
