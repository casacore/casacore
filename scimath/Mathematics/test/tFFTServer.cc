...
template <class T>
Array<T> shift(const Array<T> &input, const IPosition &input_shape,
...
class R2C1Deven1 {
 public:
  ...
  static Vector<S> expectedResult() { return Vector<S>(5, Complex(1, 0)); }
};
...
class R2C1Dodd2 {
 public:
  static Vector<T> input() { return Vector<T>(9, 1.0f); }
...
class R2C2Deveneven1 {
 public:
  ...
  static Matrix<S> expectedResult() { return Matrix<S>(3, 6, Complex(1, 0)); }
};
template <class T, class S>
class R2C2Deveneven2 {
 public:
  static Matrix<T> input() { return Matrix<T>(4, 6, 1.0f); }
...
class R2C2Devenodd1 {
 public:
  ...
  static Matrix<S> expectedResult() { return Matrix<S>(3, 5, Complex(1, 0)); }
};

template <class T, class S>
class R2C2Devenodd2 {
 public:
  static Matrix<T> input() { return Matrix<T>(4, 5, 1.0f); }
...
class R2C2Doddeven1 {
 public:
  ...
  static Matrix<S> expectedResult() { return Matrix<S>(2, 6, Complex(1, 0)); }
};

template <class T, class S>
class R2C2Doddeven2 {
 public:
  static Matrix<T> input() { return Matrix<T>(3, 6, 1.0f); }
...
class R2C2Doddodd1 {
 public:
  ...
  static Matrix<S> expectedResult() { return Matrix<S>(2, 5, Complex(1, 0)); }
};

template <class T, class S>
class R2C2Doddodd2 {
 public:
  static Matrix<T> input() { return Matrix<T>(3, 5, 1.0f); }
...
class R2C3Deveneveneven1 {
 public:
  ...
  static Cube<S> expectedResult() { return Cube<S>(3, 6, 8, Complex(1, 0)); }
};
template <class T, class S>
class R2C3Deveneveneven2 {
 public:
  static Cube<T> input() { return Cube<T>(4, 6, 8, 1.0f); }
...
class R2C3Doddoddodd1 {
 public:
  ...
  static Cube<S> expectedResult() { return Cube<S>(2, 5, 7, Complex(1, 0)); }
};

template <class T, class S>
class R2C3Doddoddodd2 {
 public:
  static Cube<T> input() { return Cube<T>(3, 5, 7, 1.0f); }
  ...
  static double tolerance() { return 100 * FLT_EPSILON; }
};
...
class R2C4Doddoddoddeven1 {
 public:
  ...
  static Array<S> expectedResult() { return Array<S>(IPosition(4, 2, 5, 7, 4), S(1, 0)); }
};

template <class T, class S>
class R2C4Doddoddoddeven2 {
 public:
  static Array<T> input() { return Array<T>(IPosition(4, 3, 5, 7, 4), T(1.0)); }
  ...
  static double tolerance() { return 500 * FLT_EPSILON; }
};
...
class C2R1Deven1 {
 public:
  ...
  static Vector<T> expectedResult() { return Vector<T>(8, 1.0f); }
};
...
class C2R1Dodd1 {
 public:
  ...
  static Vector<T> expectedResult() { return Vector<T>(9, T(1.0)); }
};
...
class C2R2Deveneven3 {
 public:
  ...
  static Matrix<T> expectedResult() {
    Matrix<T> expectedResult(4, 6, T(0.0));
    expectedResult(0, 0) = expectedResult(0, 1) = expectedResult(0, 2) = expectedResult(0, 4) =
        expectedResult(0, 5) = -1.0f;
    expectedResult(0, 3) = 5.0f;
    expectedResult(1, 0) = expectedResult(1, 1) = expectedResult(1, 2) = expectedResult(1, 4) =
        expectedResult(1, 5) = 1.0f;
    expectedResult(1, 3) = 7.0f;
    expectedResult(2, 0) = expectedResult(2, 1) = expectedResult(2, 2) = expectedResult(2, 4) =
        expectedResult(2, 5) = -1.0f;
    expectedResult(2, 3) = 5.0f;
    expectedResult(3, 0) = expectedResult(3, 1) = expectedResult(3, 2) = expectedResult(3, 4) =
        expectedResult(3, 5) = 1.0f;
...
class Test {
 public:
  Test(FFTServer<TServer, SServer> &server,
       ...
       double epsilon, const Array<T> input, const Array<S> expectedResult) {
    ...
    AlwaysTrue(result.shape().isEqual(expectedResult.shape()), AipsError);
    AlwaysTrue(allNearAbs(result, expectedResult, 2 * epsilon), AipsError);
    ...
    if (input.shape().nelements() == 1) {
      ...
      AlwaysTrue(result.shape().isEqual(expectedResult.shape()), AipsError);
      AlwaysTrue(allNearAbs(result, expectedResult, epsilon), AipsError);
 ...
 public:
  TestFFTShift()  // test the complex->complex fft shift function
  {
    ...
    for (int it = 0; it < iterations; it++) {
      ...
      cout
          << "--- two consecutive leftshifts by 0.5 channels in second axis -----------------------"
          << endl;
      ...
      server.fftshift(inVal, whichAxis, relshift, False);
      server.fftshift(inVal, whichAxis, relshift,
      ...
      cout << "--- right-shift by 1 channel in first axis with flags all not set "
              "-----------------------"
           << endl;
        ...
        for (uInt i = 0; i < 2; i++) {
          for (uInt j = 0; j < 10; j++) {
            ...
            cout << "flag " << i << " " << j << " " << outFlag(IPosition(2, i, j)) << " "
                 << expflagsb(IPosition(2, i, j)) << endl;
            AlwaysAssert((abs(diff.real()) < 2E-5) && (abs(diff.imag()) < 2E-5), AipsError);
      ...
      cout << "--- right-shift by 1 channel in first axis with flags partially set "
              "-----------------------"
           << endl;
      ...
      cout << "--- two consecutive left-shifts by 0.5 channels in first axis with flags not set "
              "-----------"
           << endl;
        ...
        for (uInt i = 0; i < 2; i++) {
          for (uInt j = 0; j < 10; j++) {
            ...
            cout << i << " " << j << " " << outVal(IPosition(2, i, j)) << " "
                 << expectc(IPosition(2, i, j)) << endl;
            cout << "flag " << i << " " << j << " " << outFlag(IPosition(2, i, j)) << " "
                 << expflagsd(IPosition(2, i, j)) << endl;
            AlwaysAssert((abs(diff.real()) < 2E-5) && (abs(diff.imag()) < 2E-5), AipsError);
      ...
      cout << "--- left-shift by 1 channel in first axis with flags partially set -----------"
           << endl;
...

      {
        for (uInt i = 0; i < 2; i++) {
          for (uInt j = 0; j < 10; j++) {
            ...
            cout << "flag " << i << " " << j << " " << outFlag(IPosition(2, i, j)) << " "
                 << expflagsc(IPosition(2, i, j)) << endl;
            AlwaysAssert((abs(diff.real()) < 2E-5) && (abs(diff.imag()) < 2E-5), AipsError);
      ...
      cout << "--- left-shift by 1.5 channels in first axis with flags partially set -----------"
           << endl;
      ...
      cout << "--- left-shift by 0.25 channels in first axis with flags partially set -----------"
           << endl;
      ...
      cout << "--- left-shift by 0.5 channels in first axis with flags partially set -----------"
           << endl;
      ...
      cout << "--- left-shift by 0.55 channels in first axis with flags partially set -----------"
           << endl;
      ...
      cout << "--- left-shift by 0.75 channels in first axis with flags partially set -----------"
           << endl;
      ...
      cout << "--- right-shift by 1 channel in first axis with flags all not set, real data "
              "----------------"
           << endl;
      ...
      cout << "--- right-shift by 1 channel in first axis with flags partially set, real data "
              "----------------"
           << endl;
...
class TestR2C  // real->complex and complex->real
{
 public:
  TestR2C(FFTServer<TServer, SServer> &server, double epsilon = FLT_EPSILON) {
    ...
    AlwaysTrue(allNearAbs(input, input_before, epsilon), AipsError);
...
class TestC2C {
 private:
  void go(FFTServer<TServer, SServer> &server, Bool shifted, double epsilon1, double epsilon2,
          const Array<T> &input, const Array<T> &expected) {
    ...
    // For complex arrays, excersize in-place transform
    {
      ...
      AlwaysTrue(copy.shape().isEqual(expected.shape()), AipsError);
      AlwaysTrue(allNearAbs(copy, expected, epsilon1), AipsError);
      ...
      AlwaysTrue(copy.shape().isEqual(input.shape()), AipsError);
      AlwaysTrue(allNearAbs(copy, input, 2 * epsilon1), AipsError);
    }
 ...
 public:
  TestC2C(FFTServer<TServer, SServer> &server, double epsilon1 = FLT_EPSILON,
    ...
    go(server, True, epsilon1, epsilon2, shift<T>(input, input.shape(), expectedResult.shape()),
