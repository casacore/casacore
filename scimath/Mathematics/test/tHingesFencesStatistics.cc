...
int main() {
    try {
    	...
    	}
    	{
    		...
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    		AlwaysAssert(r.asDouble("rms") == sqrt(eSumSq/eNpts), AipsError);
    		AlwaysAssert(near(r.asDouble("stddev"), sqrt(eVar)), AipsError);
    		AlwaysAssert(r.asDouble("sum") == eSum, AipsError);
    		AlwaysAssert(r.asDouble("sumsq") == eSumSq, AipsError);
    	...
    	}
    	{
    		...
    		AlwaysAssert(r.asuInt("maxDatasetIndex") == 1, AipsError);
    		AlwaysAssert(r.asInt64("maxIndex") == 5, AipsError);
    		AlwaysAssert(r.asDouble("mean") == eSum/eNpts, AipsError);
    		AlwaysAssert(r.asDouble("min") == 6, AipsError);
    		AlwaysAssert(r.asuInt("minDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("minIndex") == 2, AipsError);
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    		AlwaysAssert(r.asDouble("rms") == sqrt(eSumSq/eNpts), AipsError);
    	...
    	}
    	{
    		...
    		AlwaysAssert(! r.asBool("isMasked"), AipsError);
    		AlwaysAssert(! r.asBool("isWeighted"), AipsError);
    		AlwaysAssert(r.asDouble("max") == 15, AipsError);
    		AlwaysAssert(r.asuInt("maxDatasetIndex") == 1, AipsError);
    		AlwaysAssert(r.asInt64("maxIndex") == 0, AipsError);
    		AlwaysAssert(r.asDouble("mean") == eSum/eNpts, AipsError);
    		AlwaysAssert(r.asDouble("min") == 5, AipsError);
    		AlwaysAssert(r.asuInt("minDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("minIndex") == 0, AipsError);
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    		AlwaysAssert(r.asDouble("rms") == sqrt(eSumSq/eNpts), AipsError);
    	...
    	}
    	{
    		...
    		AlwaysAssert(r.asInt64("maxIndex") == 5, AipsError);
    		AlwaysAssert(r.asDouble("mean") == eSum/eNpts, AipsError);
    		AlwaysAssert(r.asDouble("min") == 10, AipsError);
    		AlwaysAssert(r.asuInt("minDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("minIndex") == 3, AipsError);
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    		AlwaysAssert(r.asDouble("rms") == sqrt(eSumSq/eNpts), AipsError);
    		AlwaysAssert(near(r.asDouble("stddev"), sqrt(eVar)), AipsError);
    		AlwaysAssert(r.asDouble("sum") == eSum, AipsError);
    	...
    	}
    	{
    		...
    		AlwaysAssert(r.asuInt("maxDatasetIndex") == 1, AipsError);
    		AlwaysAssert(r.asInt64("maxIndex") == 1, AipsError);
    		AlwaysAssert(r.asDouble("mean") == eSum/eSumWeights, AipsError);
    		AlwaysAssert(r.asDouble("min") == 2, AipsError);
    		AlwaysAssert(r.asuInt("minDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("minIndex") == 1, AipsError);
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    		AlwaysAssert(r.asDouble("rms") == sqrt(eSumSq/eSumWeights), AipsError);
    		AlwaysAssert(near(r.asDouble("stddev"), sqrt(eVar)), AipsError);
    		AlwaysAssert(r.asDouble("sum") == eSum, AipsError);
    		AlwaysAssert(r.asDouble("sumsq") == eSumSq, AipsError);
    		AlwaysAssert(near(r.asDouble("variance"), eVar), AipsError);
    	...
    	}
    	{
    		...
    		AlwaysAssert(r.asuInt("maxDatasetIndex") == 1, AipsError);
    		AlwaysAssert(r.asInt64("maxIndex") == 1, AipsError);
    		AlwaysAssert(near(r.asDouble("mean"), eSum/eSumWeights), AipsError);
    		AlwaysAssert(r.asDouble("min") == 6, AipsError);
    		AlwaysAssert(r.asuInt("minDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("minIndex") == 2, AipsError);
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    	...
    	}
    	{
    		...
    		AlwaysAssert(r.asDouble("min") == -1, AipsError);
    		AlwaysAssert(r.asuInt("minDatasetIndex") == 0, AipsError);
    		AlwaysAssert(r.asInt64("minIndex") == 5, AipsError);
    		AlwaysAssert(r.asDouble("npts") == eNpts, AipsError);
    		AlwaysAssert(r.asDouble("rms") == sqrt(eSumSq/eSumWeights), AipsError);
    		AlwaysAssert(near(r.asDouble("stddev"), sqrt(eVar)), AipsError);
    		AlwaysAssert(r.asDouble("sum") == eSum, AipsError);
