...
int main() {
  try {
    ...
    Float tmp3[5] = {1, 0.193867, 0.00141258, 3.86835e-07, 3.9815e-12};
    ...
    Float tmp4[5] = {1, 0.0807079, 0.142924, 0.0458648, 0.000233285};
    ...
    Float tmp5[5] = {1, 0.315995, 0.00662331, 0.0268752, 0.0072334};
    ...
    Float tmp6[5] = {1, 0.193867, 0.00141258, 3.86835e-07, 3.9815e-12};
    ...
    Float tmp7[4] = {1, 0.573245, 0.0826234, 0};
    ...
    Float tmp8[4] = {1, 0.170902, -0.10605, 0.0468399};
