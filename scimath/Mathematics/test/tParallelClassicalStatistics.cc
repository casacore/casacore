...
int main() {
    try {
        ...
        Double k[] = {1.5, 1, 2, 3, 2.5};
        {
            ...
            AlwaysAssert(near(sd.variance, 0.625), AipsError);
            AlwaysAssert(
        ...
        }
        {
            ...
            ParallelClassicalStatistics<Double, Double*, Bool*> cs1;
            cs1.setData(k, 5);
        ...
        {
            // integer weights
            ParallelClassicalStatistics<Double, vector<Double>::const_iterator, vector<Bool>::const_iterator, vector<Int>::const_iterator> cs;
        ...
        }
        {
            ...
            ParallelClassicalStatistics<Complex, vector<Complex>::const_iterator, vector<Bool>::const_iterator> cs;
        }
        {
            // getMedian()
            ParallelClassicalStatistics<Double, vector<Double>::const_iterator, vector<Bool>::const_iterator> cs;
        ...
        { // large array with all the same values, getMedianAndQuartile()
            ...
            ParallelClassicalStatistics<Double, vector<Float>::const_iterator, vector<Bool>::const_iterator> cs;
