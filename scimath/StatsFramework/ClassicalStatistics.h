...
class ClassicalStatistics : public StatisticsAlgorithm<CASA_STATP> {
 ...
 public:
  ...
  virtual StatisticsData::ALGORITHM algorithm() const { return StatisticsData::CLASSICAL; };
 ...
 protected:
  ...
  // <group>
  inline void _accumulate(StatsData<AccumType>& stats, const AccumType& datum,
