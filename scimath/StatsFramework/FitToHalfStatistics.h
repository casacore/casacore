...
class FitToHalfStatistics : public ConstrainedRangeStatistics<CASA_STATP> {
 public:
  ...
  virtual StatisticsData::ALGORITHM algorithm() const { return StatisticsData::FITTOHALF; };
 ...
 private:
  ...
  void _getMinMax(std::shared_ptr<AccumType>& realMin, std::shared_ptr<AccumType>& realMax,
