...
CASA_STATD
HingesFencesQuantileComputer<CASA_STATP>& HingesFencesQuantileComputer<CASA_STATP>::operator=(
    const HingesFencesQuantileComputer<CASA_STATP>& other) {
  if (this == &other) {
    return *this;
  }
...
CASA_STATD
StatisticsAlgorithmQuantileComputer<CASA_STATP>* HingesFencesQuantileComputer<CASA_STATP>::clone()
    const {
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin, nr,
                                                     dataStride, binDesc, maxLimit);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin, nr,
                                                     dataStride, ranges, isInclude, binDesc,
                                                     maxLimit);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin, nr,
                                                     dataStride, maskBegin, maskStride, binDesc,
                                                     maxLimit);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ConstrainedRangeQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin,
                                                            nr, dataStride, maskBegin, maskStride,
                                                            ranges, isInclude, binDesc, maxLimit);
  } else {
    ClassicalQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin, nr,
                                                     dataStride, maskBegin, maskStride, ranges,
                                                     isInclude, binDesc, maxLimit);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ConstrainedRangeQuantileComputer<CASA_STATP>::_findBins(
        binCounts, sameVal, allSame, dataBegin, weightsBegin, nr, dataStride, binDesc, maxLimit);
  } else {
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ConstrainedRangeQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin,
                                                            weightsBegin, nr, dataStride, ranges,
                                                            isInclude, binDesc, maxLimit);
  } else {
    ClassicalQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin,
                                                     weightsBegin, nr, dataStride, ranges,
                                                     isInclude, binDesc, maxLimit);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ConstrainedRangeQuantileComputer<CASA_STATP>::_findBins(
        binCounts, sameVal, allSame, dataBegin, weightsBegin, nr, dataStride, maskBegin, maskStride,
        ranges, isInclude, binDesc, maxLimit);
  } else {
    ClassicalQuantileComputer<CASA_STATP>::_findBins(
        binCounts, sameVal, allSame, dataBegin, weightsBegin, nr, dataStride, maskBegin, maskStride,
...
void HingesFencesQuantileComputer<CASA_STATP>::_findBins(
  ...
  if (_hasRange) {
    ConstrainedRangeQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin,
                                                            weightsBegin, nr, dataStride, maskBegin,
                                                            maskStride, binDesc, maxLimit);
  } else {
    ClassicalQuantileComputer<CASA_STATP>::_findBins(binCounts, sameVal, allSame, dataBegin,
                                                     weightsBegin, nr, dataStride, maskBegin,
                                                     maskStride, binDesc, maxLimit);
...
void HingesFencesQuantileComputer<CASA_STATP>::_populateArray(DataArray& ary,
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_populateArray(ary, dataBegin, nr, dataStride);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_populateArray(DataArray& ary,
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_populateArray(ary, dataBegin, nr, dataStride, ranges,
                                                          isInclude);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_populateArray(DataArray& ary,
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_populateArray(ary, dataBegin, nr, dataStride, maskBegin,
                                                          maskStride);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_populateArray(DataArray& ary,
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_populateArray(ary, dataBegin, weightsBegin, nr,
                                                          dataStride);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_populateArrays(
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_populateArrays(arys, currentCount, dataBegin, nr,
                                                           dataStride, includeLimits, maxCount);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_populateArrays(
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_populateArrays(arys, currentCount, dataBegin,
                                                           weightsBegin, nr, dataStride, ranges,
                                                           isInclude, includeLimits, maxCount);
  }
}
...
void HingesFencesQuantileComputer<CASA_STATP>::_populateArrays(
  ...
  if (_hasRange) {
    ...
    ClassicalQuantileComputer<CASA_STATP>::_populateArrays(arys, currentCount, dataBegin,
                                                           weightsBegin, nr, dataStride, maskBegin,
                                                           maskStride, includeLimits, maxCount);
  }
}
...
Bool HingesFencesQuantileComputer<CASA_STATP>::_populateTestArray(DataArray& ary,
  ...
  if (_hasRange) {
    ...
    return ClassicalQuantileComputer<CASA_STATP>::_populateTestArray(ary, dataBegin, nr, dataStride,
                                                                     maxElements);
  }
}
...
Bool HingesFencesQuantileComputer<CASA_STATP>::_populateTestArray(
  ...
  if (_hasRange) {
    ...
    return ClassicalQuantileComputer<CASA_STATP>::_populateTestArray(ary, dataBegin, weightsBegin,
                                                                     nr, dataStride, maxElements);
  }
}
