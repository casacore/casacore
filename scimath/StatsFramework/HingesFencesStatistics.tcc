...
CASA_STATD
HingesFencesStatistics<CASA_STATP>& HingesFencesStatistics<CASA_STATP>::operator=(
    const HingesFencesStatistics<CASA_STATP>& other) {
  if (this == &other) {
    return *this;
  }
...
void HingesFencesStatistics<CASA_STATP>::_accumNpts(uInt64& npts, const DataIterator& dataBegin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_accumNpts(npts, dataBegin, nr, dataStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_accumNpts(uInt64& npts, const DataIterator& dataBegin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_accumNpts(npts, dataBegin, nr, dataStride, ranges, isInclude);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_accumNpts(uInt64& npts, const DataIterator& dataBegin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_accumNpts(npts, dataBegin, nr, dataStride, maskBegin,
                                                maskStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_accumNpts(uInt64& npts, const DataIterator& dataBegin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_accumNpts(npts, dataBegin, weightsBegin, nr, dataStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_minMax(std::shared_ptr<AccumType>& mymin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_minMax(mymin, mymax, dataBegin, nr, dataStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_minMax(std::shared_ptr<AccumType>& mymin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_minMax(mymin, mymax, dataBegin, nr, dataStride, ranges,
                                             isInclude);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_minMax(std::shared_ptr<AccumType>& mymin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_minMax(mymin, mymax, dataBegin, nr, dataStride, maskBegin,
                                             maskStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_minMax(std::shared_ptr<AccumType>& mymin,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_minMax(mymin, mymax, dataBegin, weightsBegin, nr, dataStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_minMaxNpts(uInt64& npts,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_minMaxNpts(npts, mymin, mymax, dataBegin, nr, dataStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_minMaxNpts(uInt64& npts,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_minMaxNpts(npts, mymin, mymax, dataBegin, weightsBegin, nr,
                                                 dataStride);
  }
}
...
void HingesFencesStatistics<CASA_STATP>::_unweightedStats(StatsData<AccumType>& stats,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_unweightedStats(stats, ngood, location, dataBegin, nr,
                                                      dataStride);
  }
}
...
CASA_STATD
void HingesFencesStatistics<CASA_STATP>::_weightedStats(StatsData<AccumType>& stats,
  ...
  if (_hasRange) {
    ...
    ClassicalStatistics<CASA_STATP>::_weightedStats(stats, location, dataBegin, weightsBegin, nr,
                                                    dataStride);
  }
}
