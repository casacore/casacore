...
CASA_STATD StatisticsAlgorithmQuantileComputer<CASA_STATP>::StatisticsAlgorithmQuantileComputer(
    ...
    : _sortedArray(other._sortedArray),
      ...
      _medAbsDevMed(other._medAbsDevMed ? new AccumType(*other._medAbsDevMed) : nullptr) {}

CASA_STATD StatisticsAlgorithmQuantileComputer<CASA_STATP>& StatisticsAlgorithmQuantileComputer<
    CASA_STATP>::operator=(const StatisticsAlgorithmQuantileComputer<CASA_STATP>& other) {
  if (this == &other) {
    return *this;
  }
  _sortedArray = other._sortedArray;
  ...
  _medAbsDevMed.reset(other._medAbsDevMed ? new AccumType(*other._medAbsDevMed) : nullptr);
  return *this;
}

CASA_STATD
void StatisticsAlgorithmQuantileComputer<CASA_STATP>::deleteSortedArray() { _sortedArray.clear(); }
