...
int main() {
  try {
    ...
    }
    {
      ...
      AlwaysAssert(sd.sumsq == 0, AipsError);
      AlwaysAssert(sd.variance == 0, AipsError);
      AlwaysAssert(bw.getStatistic(StatisticsData::NPTS) == 6, AipsError);
      AlwaysAssert(near(bw.getStatistic(StatisticsData::MEAN), expMean, eps), AipsError);
      AlwaysAssert(near(bw.getStatistic(StatisticsData::STDDEV), expStdev, eps), AipsError);
    }
    {
      ...
      AlwaysAssert(sd.sumsq == 0, AipsError);
      AlwaysAssert(sd.variance == 0, AipsError);
      AlwaysAssert(bw.getStatistic(StatisticsData::NPTS) == 3, AipsError);
      AlwaysAssert(near(bw.getStatistic(StatisticsData::MEAN), expMean, eps), AipsError);
      AlwaysAssert(near(bw.getStatistic(StatisticsData::STDDEV), expStdev, eps), AipsError);
    }
    {
      ...
      AlwaysAssert(sd.sumsq == 0, AipsError);
      AlwaysAssert(sd.variance == 0, AipsError);
      AlwaysAssert(bw1->getStatistic(StatisticsData::NPTS) == 3, AipsError);
      AlwaysAssert(near(bw1->getStatistic(StatisticsData::MEAN), expMean, eps), AipsError);
      AlwaysAssert(near(bw1->getStatistic(StatisticsData::STDDEV), expStdev, eps), AipsError);
    }
    {
    ...
    }
    {
      ...
      AlwaysAssert(sd.sumsq == 0, AipsError);
      AlwaysAssert(sd.variance == 0, AipsError);
      AlwaysAssert(bw.getStatistic(StatisticsData::NPTS) == 7, AipsError);
      AlwaysAssert(near(bw.getStatistic(StatisticsData::MEAN), expMean, eps), AipsError);
      AlwaysAssert(near(bw.getStatistic(StatisticsData::STDDEV), expStdev, eps), AipsError);
    }
    {
