...
int main() {
  ...
  try {
    ...
    // thereof).
    {
      ...
      AlwaysAssert(rec.asBool("isMasked") == stats.masked, AipsError);
      AlwaysAssert(rec.asBool("isWeighted") == stats.weighted, AipsError);
      AlwaysAssert(rec.asInt64("maxDatasetIndex") == stats.maxpos.first, AipsError);
      AlwaysAssert(rec.asInt64("maxIndex") == stats.maxpos.second, AipsError);
      AlwaysAssert(rec.asInt64("minDatasetIndex") == stats.minpos.first, AipsError);
      AlwaysAssert(rec.asInt64("minIndex") == stats.minpos.second, AipsError);
      AlwaysAssert(
          rec.asDouble(StatisticsData::toString(StatisticsData::SUMWEIGHTS)) == stats.sumweights,
          AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::MEAN)) == stats.mean,
                   AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::NPTS)) == stats.npts,
                   AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::RMS)) == stats.rms,
                   AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::STDDEV)) == stats.stddev,
                   AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::SUM)) == stats.sum,
                   AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::SUMSQ)) == stats.sumsq,
                   AipsError);
      AlwaysAssert(
          rec.asDouble(StatisticsData::toString(StatisticsData::VARIANCE)) == stats.variance,
          AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::MAX)) == *stats.max,
                   AipsError);
      AlwaysAssert(rec.asDouble(StatisticsData::toString(StatisticsData::MIN)) == *stats.min,
                   AipsError);
    }
    {
