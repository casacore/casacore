...
DEFINE_GETPUT_SLICE_TYPE_V(Bool)
DEFINE_GETPUT_SLICE_TYPE_V(uChar)
DEFINE_GETPUT_SLICE_TYPE_V(Short)
DEFINE_GETPUT_SLICE_TYPE_V(uShort)
DEFINE_GETPUT_SLICE_TYPE_V(Int)
DEFINE_GETPUT_SLICE_TYPE_V(uInt)
DEFINE_GETPUT_SLICE_TYPE_V(float)
DEFINE_GETPUT_SLICE_TYPE_V(double)
DEFINE_GETPUT_SLICE_TYPE_V(Complex)
DEFINE_GETPUT_SLICE_TYPE_V(DComplex)
