...
template <class VirtualType, class StoredType>
DataManagerColumn* BaseMappedArrayEngine<VirtualType, StoredType>::makeIndArrColumn(
  ...
  if (virtualName_p.empty()) {
    ...
    throw(DataManInvOper("BaseMappedArrayEngine with virtual column " + virtualName_p +
...
void BaseMappedArrayEngine<VirtualType, StoredType>::create64(rownr_t initialNrrow) {
  ...
  makeTableColumn(virtualName_p).rwKeywordSet().define("_BaseMappedArrayEngine_Name", storedName_p);
...
void BaseMappedArrayEngine<VirtualType, StoredType>::prepare1() {
  ...
  // # virtual column.
  if ((!arrayIsFixed_p) &&
      ((column_p->columnDesc().options() & ColumnDesc::FixedShape) == ColumnDesc::FixedShape)) {
    throw(DataManInvOper("BaseMappedArrayEngine: virtual column " + virtualName_p +
                         " is FixedShape, but stored " + storedName_p + " is not"));
  }
}
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::addRowInit(rownr_t startRow, rownr_t nrrow) {
  if (arrayIsFixed_p &&
      ((column_p->columnDesc().options() & ColumnDesc::FixedShape) != ColumnDesc::FixedShape)) {
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::setShape(rownr_t rownr,
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::getArray(rownr_t rownr,
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::putArray(rownr_t rownr,
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::getSlice(rownr_t rownr, const Slicer& slicer,
                                                              Array<VirtualType>& array) {
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::putSlice(rownr_t rownr, const Slicer& slicer,
                                                              const Array<VirtualType>& array) {
  Array<StoredType> target(getStoredShape(rownr, array.shape()));
  mapOnPut(array, target);
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::getArrayColumn(Array<VirtualType>& array) {
  Array<StoredType> target(getStoredShape(0, array.shape()));
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::getColumnSlice(const Slicer& slicer,
                                                                    Array<VirtualType>& array) {
  Array<StoredType> target(getStoredShape(0, array.shape()));
...
template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::mapOnGet(Array<VirtualType>&,
                                                              const Array<StoredType>&) {
  throw DataManInvOper(
      "BaseMappedArrayEngine::mapOnGet not implemented "
      "for column " +
      virtualName());
}

template <class VirtualType, class StoredType>
void BaseMappedArrayEngine<VirtualType, StoredType>::mapOnPut(const Array<VirtualType>&,
                                                              Array<StoredType>&) {
  throw DataManInvOper(
      "BaseMappedArrayEngine::mapOnPut not implemented "
      "for column " +
      virtualName());
}
