...
class BitFlagsEngine : public BaseMappedArrayEngine<Bool, StoredType> {
 ...
 public:
  ...
  BitFlagsEngine(const String& virtualColumnName, const String& storedColumnName,
                 StoredType readMask = StoredType(0xffffffff), StoredType writeMask = 1);
  ...
  // The keywords are stored in a subrecord of keyword FLAGSETS.
  BitFlagsEngine(const String& virtualColumnName, const String& storedColumnName,
                 const Array<String>& readMaskKeys, const Array<String>& writeMaskKeys);
