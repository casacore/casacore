...
class DataManager {
 ...
 public:
  ...
  std::shared_ptr<MultiFileBase> multiFile() { return multiFile_p; }
  ...
  DataManagerColumn* createScalarColumn(const String& columnName, int dataType,
                                        const String& dataTypeId);
  // Create a direct array column.
  DataManagerColumn* createDirArrColumn(const String& columnName, int dataType,
                                        const String& dataTypeId);
  // Create an indirect array column.
  DataManagerColumn* createIndArrColumn(const String& columnName, int dataType,
                                        const String& dataTypeId);
  // </group>
 ...
 private:
  ...
  void checkDataType(const DataManagerColumn* colPtr, const String& columnName, int dataType,
 ...
 public:
  ...
  DataManager* getClone() const { return clone_p; }

  // Set the pointer to the clone.
  void setClone(DataManager* clone) const { clone_p = clone; }
