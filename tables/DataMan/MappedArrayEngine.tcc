...
template <class S, class T>
MappedArrayEngine<S, T>::MappedArrayEngine(const Record& spec) : BaseMappedArrayEngine<S, T>() {
...
template <class S, class T>
DataManager* MappedArrayEngine<S, T>::makeObject(const String&, const Record& spec) {
