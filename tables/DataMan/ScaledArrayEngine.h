...
class ScaledArrayEngine : public BaseMappedArrayEngine<VirtualType, StoredType> {
 ...
 public:
  ...
  ScaledArrayEngine(const String& virtualColumnName, const String& storedColumnName,
