...

{
  ...
  if (!shape_p.isEqual(other.shape_p)) {
    throw(DataManInternalError("StManIndArray::copyData shapes not conforming"));
  }
  switch (dataType) {
    case TpBool:
      ios.copyArrayBool(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                        shape_p.product());
      break;
    case TpUChar:
      ios.copyArrayuChar(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                         shape_p.product());
      break;
    case TpShort:
      ios.copyArrayShort(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                         shape_p.product());
      break;
    case TpUShort:
      ios.copyArrayuShort(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                          shape_p.product());
      break;
    case TpInt:
      ios.copyArrayInt(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                       shape_p.product());
      break;
    case TpUInt:
      ios.copyArrayuInt(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                        shape_p.product());
      break;
    case TpInt64:
      ios.copyArrayInt64(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                         shape_p.product());
      break;
    case TpFloat:
      ios.copyArrayFloat(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                         shape_p.product());
      break;
    case TpDouble:
      ios.copyArrayDouble(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                          shape_p.product());
      break;
    case TpComplex:
      ios.copyArrayComplex(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                           shape_p.product());
      break;
    case TpDComplex:
      ios.copyArrayDComplex(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                            shape_p.product());
      break;
    case TpString:
      ios.copyArrayString(fileOffset_p + arrOffset_p, other.fileOffset_p + other.arrOffset_p,
                          shape_p.product());
      break;
    default:
...
void StIndArray::checkShape(const IPosition& userArrayShape,
  ...
  if (!userArrayShape.isEqual(tableArrayShape)) {
    throw(DataManInternalError("StManIndArray::get/put shapes not conforming"));
  }
}
...
void StIndArray::getArrayV(StManArrayFile& ios, ArrayBase& arr, DataType dtype) {
  ...
  switch (dtype) {
    ...
    case TpFloat:
      ...
      break;
    case TpDouble:
      ios.get(fileOffset_p + arrOffset_p, 0, shape_p.product(), static_cast<double*>(value));
      break;
    case TpComplex:
      ios.get(fileOffset_p + arrOffset_p, 0, shape_p.product(), static_cast<Complex*>(value));
      break;
    case TpDComplex:
      ios.get(fileOffset_p + arrOffset_p, 0, shape_p.product(), static_cast<DComplex*>(value));
      break;
    case TpString:
      ios.get(fileOffset_p + arrOffset_p, 0, shape_p.product(), static_cast<String*>(value));
      break;
    default:
...
void StIndArray::putArrayV(StManArrayFile& ios, const ArrayBase& arr, DataType dtype) {
  ...
  switch (dtype) {
    ...
    case TpFloat:
      ...
      break;
    case TpDouble:
      ios.put(fileOffset_p + arrOffset_p, 0, shape_p.product(), static_cast<const double*>(value));
      break;
    case TpComplex:
      ios.put(fileOffset_p + arrOffset_p, 0, shape_p.product(), static_cast<const Complex*>(value));
      break;
    case TpDComplex:
      ...
      break;
    case TpString:
      ios.put(fileOffset_p + arrOffset_p, 0, shape_p.product(), static_cast<const String*>(value));
      break;
    default:
...
void StIndArray::getSliceV(StManArrayFile& ios, const Slicer& ns, ArrayBase& arr, DataType dtype) {
  ...
  switch (dtype) {
    case TpBool:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecBoolV);
      break;
    case TpUChar:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecuCharV);
      break;
    case TpShort:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecShortV);
      break;
    case TpUShort:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecuShortV);
      break;
    case TpInt:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecIntV);
      break;
    case TpUInt:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecuIntV);
      break;
    case TpInt64:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecInt64V);
      break;
    case TpFloat:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecfloatV);
      break;
    case TpDouble:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecdoubleV);
      break;
    case TpComplex:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecComplexV);
      break;
    case TpDComplex:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecDComplexV);
      break;
    case TpString:
      getSliceData(ios, ns, value, arr.shape(), &StIndArray::getVecStringV);
      break;
    default:
      const void* cvalue = value;
      arr.freeVStorage(cvalue, deleteIt);
...
void StIndArray::putSliceV(StManArrayFile& ios, const Slicer& ns, const ArrayBase& arr,
  ...
  switch (dtype) {
    case TpBool:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecBoolV);
      break;
    case TpUChar:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecuCharV);
      break;
    case TpShort:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecShortV);
      break;
    case TpUShort:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecuShortV);
      break;
    case TpInt:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecIntV);
      break;
    case TpUInt:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecuIntV);
      break;
    case TpInt64:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecInt64V);
      break;
    case TpFloat:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecfloatV);
      break;
    case TpDouble:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecdoubleV);
      break;
    case TpComplex:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecComplexV);
      break;
    case TpDComplex:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecDComplexV);
      break;
    case TpString:
      putSliceData(ios, ns, value, arr.shape(), &StIndArray::putVecStringV);
      break;
    default:
      arr.freeVStorage(value, deleteIt);
...
void StIndArray::getSliceData(StManArrayFile& ios, const Slicer& ns, void* value,
  ...
  if (ndim == 1) {
    ...
    while (!iter.pastEnd()) {
      ...
      offset += blc(0);
      getVec(ios, fileOffset, offset, leng, inc(0), count, value);
      count += leng;
      iter.next();
    }
  }
...
void StIndArray::putSliceData(StManArrayFile& ios, const Slicer& ns, const void* value,
  ...
  if (ndim == 1) {
    ...
    while (!iter.pastEnd()) {
      ...
      offset += blc(0);
      putVec(ios, fileOffset, offset, leng, inc(0), count, value);
      count += leng;
      iter.next();
    }
  }
