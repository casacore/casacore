...
TSMColumn::TSMColumn(TiledStMan* stman, int dataType, const String& columnName)
...
int TSMColumn::dataType() const { return dtype_p; }

void TSMColumn::setShapeColumn(const IPosition& shape) { columnShape_p = shape; }
