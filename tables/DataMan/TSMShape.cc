...
TSMShape::TSMShape() : data_p(), size_p(0) {}
...
TSMShape::TSMShape(const TSMShape& other) : data_p(other.data_p), size_p(other.size_p) {}
...
size_t TSMShape::offset(const IPosition& position, const IPosition& origin) const {
...
IPosition TSMShape::offsetIncrement(const IPosition& subShape, const IPosition& stride) const {
