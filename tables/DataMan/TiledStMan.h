...
class TiledStMan : public DataManager {
 ...
 protected:
  ...
  void checkCoordinates(const Block<TSMColumn*>& coordColSet, const IPosition& cubeShape,
  ...
  TSMCube* makeHypercube(const IPosition& cubeShape, const IPosition& tileShape,
                         const Record& values);
