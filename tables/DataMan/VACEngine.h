...
template <class T>
class VACEngine : public VirtualColumnEngine, public VirtualArrayColumn<T> {
 ...
 public:
  ...
  const String& sourceColumnName() const { return sourceName_p; }
 ...
 private:
  ...
  // correct column.
  DataManagerColumn* makeDirArrColumn(const String& columnName, int dataType,
