...
//      ScalarColumn<int32_t>     colx;       // used by put
//      ScalarColumn<int32_t>   rocolx;     // used by get
...
//   td.addColumn (ScalarColumnDesc<int32_t>("xTarget"));
//   td.addColumn (ScalarColumnDesc<int32_t>("yTarget"));
