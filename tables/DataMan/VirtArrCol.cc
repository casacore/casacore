...
void VirtualArrayColumnBase::getScalarColumnV(ArrayBase&) {
  throw DataManInvOper(
      "VirtualArrayColumn::getScalarColumnV not possible"
      " for column " +
      columnName());
}
void VirtualArrayColumnBase::putScalarColumnV(const ArrayBase&) {
  throw DataManInvOper(
      "VirtualArrayColumn::putScalarColumnV not possible"
      " for column " +
      columnName());
}
void VirtualArrayColumnBase::getScalarColumnCellsV(const RefRows&, ArrayBase&) {
  throw DataManInvOper(
      "VirtualArrayColumn::getScalarColumnCellsV not possible"
      " for column " +
      columnName());
}
void VirtualArrayColumnBase::putScalarColumnCellsV(const RefRows&, const ArrayBase&) {
  throw DataManInvOper(
      "VirtualArrayColumn::putScalarColumnCellsV not possible"
      " for column " +
      columnName());
}
...
void VirtualArrayColumnBase::setShapeColumn(const IPosition&) {
  throw DataManInvOper(
      "VirtualArrayColumn::setShapeColumn not possible"
      " for column " +
      columnName());
}
void VirtualArrayColumnBase::setShape(rownr_t, const IPosition&) {
  throw DataManInvOper(
      "VirtualArrayColumn::setShape not possible"
      " for column " +
      columnName());
}
...
IPosition VirtualArrayColumnBase::shape(rownr_t) {
  throw DataManInvOper(
      "VirtualArrayColumn::shape not possible"
      " for column " +
      columnName());
  return IPosition(0);
}
