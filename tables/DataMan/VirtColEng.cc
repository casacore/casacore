...
Bool VirtualColumnEngine::isStorageManager() const { return False; }

Bool VirtualColumnEngine::canAddRow() const { return True; }
void VirtualColumnEngine::addRow64(rownr_t) {}
Bool VirtualColumnEngine::canRemoveRow() const { return True; }
void VirtualColumnEngine::removeRow64(rownr_t) {}

// # Create, open, prepare and close do nothing unless implemented in the
//  derived class.
Bool VirtualColumnEngine::flush(AipsIO&, Bool) { return False; }
void VirtualColumnEngine::create64(rownr_t) {}
rownr_t VirtualColumnEngine::open64(rownr_t nrow, AipsIO&) { return nrow; }
rownr_t VirtualColumnEngine::resync64(rownr_t nrow) { return nrow; }
...
// # an indirect array.
DataManagerColumn* VirtualColumnEngine::makeDirArrColumn(const String& columnName, int dataType,
