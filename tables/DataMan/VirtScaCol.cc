...
void VirtualScalarColumnBase::getArrayV(rownr_t, ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::getArrayV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::putArrayV(rownr_t, const ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::putArrayV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::getArrayColumnV(ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::getArrayColumnV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::putArrayColumnV(const ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::putArrayColumnV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::getArrayColumnCellsV(const RefRows&, ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::getArrayColumnCellsV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::putArrayColumnCellsV(const RefRows&, const ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::putArrayColumnCellsV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::getSliceV(rownr_t, const Slicer&, ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::getSliceV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::putSliceV(rownr_t, const Slicer&, const ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::putSliceV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::getColumnSliceV(const Slicer&, ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::getColumnSliceV not possible"
      " for column " +
      columnName());
}
...
void VirtualScalarColumnBase::putColumnSliceV(const Slicer&, const ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::putColumnSliceV not possible"
      " for column " +
      columnName());
}

void VirtualScalarColumnBase::getColumnSliceCellsV(const RefRows&, const Slicer&, ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::getColumnSliceCellsV not possible"
      " for column " +
      columnName());
}

void VirtualScalarColumnBase::putColumnSliceCellsV(const RefRows&, const Slicer&,
                                                   const ArrayBase&) {
  throw DataManInvOper(
      "VirtualScalarColumn::putColumnSliceCellsV not possible"
      " for column " +
      columnName());
}
