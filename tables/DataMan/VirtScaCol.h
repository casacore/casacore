...
class VirtualScalarColumn : public VirtualScalarColumnBase {
 ...
 private:
  ...
  void getComplex(rownr_t rownr, Complex* dataPtr) override {
    getVirtualScalar(this, rownr, dataPtr);
  }
  void getDComplex(rownr_t rownr, DComplex* dataPtr) override {
    getVirtualScalar(this, rownr, dataPtr);
  }
  void getString(rownr_t rownr, String* dataPtr) override {
    getVirtualScalar(this, rownr, dataPtr);
  }
  ...
  void putdouble(rownr_t rownr, const double* dataPtr) override {
    putVirtualScalar(this, rownr, dataPtr);
  }
  void putComplex(rownr_t rownr, const Complex* dataPtr) override {
    putVirtualScalar(this, rownr, dataPtr);
  }
  void putDComplex(rownr_t rownr, const DComplex* dataPtr) override {
    putVirtualScalar(this, rownr, dataPtr);
  }
  void putString(rownr_t rownr, const String* dataPtr) override {
    putVirtualScalar(this, rownr, dataPtr);
  }
