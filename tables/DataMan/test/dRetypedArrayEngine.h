...
class RetypedArrayEx1 {
 public:
  ...
  static String dataTypeId() { return "RetypedArrayEx1"; }
  static IPosition shape() { return IPosition(1, 2); }
  ...
  int operator==(const RetypedArrayEx1& that) const { return x_p == that.x_p && y_p == that.y_p; }
...
class RetypedArrayEx2 {
 public:
  ...
  RetypedArrayEx2(const RetypedArrayEx2& that)
  ...
  static String dataTypeId() { return "RetypedArrayEx2"; }
  static IPosition shape() { return IPosition(1, 4); }
  int operator==(const RetypedArrayEx2& that) const {
    return I_p == that.I_p && Q_p == that.Q_p && U_p == that.U_p && V_p == that.V_p;
  }
  ...
  class CopyInfo {
   public:
    ...
    ~CopyInfo();
    void set(void* out, const Array<DComplex>& in, const IPosition& sourceElementShape);
  ...
  static void get(void* copyInfo, Array<DComplex>& out, const void* in, const IPosition& shape) {
    ((CopyInfo*)copyInfo)->get(out, in, shape);
  }

  void setElem(const DComplex* data, const IPosition& shape, const void* mask);
  void getElem(DComplex* data, const IPosition& shape, const void* mask) const;
