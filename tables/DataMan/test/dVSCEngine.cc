...
template void objcopy<VSCExample>(VSCExample *, VSCExample const *, uint32_t);
template void objcopy<VSCExample>(VSCExample *, VSCExample const *, uint32_t, uint32_t, uint32_t);
template void objset<VSCExample>(VSCExample *, VSCExample, uint32_t);
template void objset<VSCExample>(VSCExample *, VSCExample, uint32_t, uint32_t);
template void objmove<VSCExample>(VSCExample *, VSCExample const *, uint32_t);
