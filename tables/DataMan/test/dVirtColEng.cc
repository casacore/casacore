...
DummyVirtualEngine::DummyVirtualEngine() : data1_p(this, 1.0), data2_p(this, 1.0) {}

DummyVirtualEngine::DummyVirtualEngine(double scale1, double scale2)
    : data1_p(this, scale1), data2_p(this, scale2) {}
...
DataManagerColumn* DummyVirtualEngine::makeScalarColumn(const String&, int, const String&) {
  return &data1_p;
}

DataManagerColumn* DummyVirtualEngine::makeIndArrColumn(const String&, int, const String&) {
  return &data2_p;
}
...
void DummyVirtualEngine::registerClass() {
  DataManager::registerCtor("DummyVirtualEngine", DummyVirtualEngine::makeObject);
}
...
DummyVirtualScalar::~DummyVirtualScalar() { delete column_p; }
...
DummyVirtualArray::~DummyVirtualArray() { delete column_p; }
