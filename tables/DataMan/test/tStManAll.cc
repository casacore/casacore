...
template <typename T>
Array<T> makeArray(const IPosition& shape, T value, T incr) {
  Array<T> arr(shape);
...
template <typename T>
void writeRows(Table& tab, const String& name, const Array<T>* values) {
  ScalarColumn<T> s1(tab, name + "s1");
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void checkRows(Table& tab, const String& name, const Array<T>* values) {
  ScalarColumn<T> s1(tab, name + "s1");
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void writeColumns(Table& tab, const String& name, Array<T>* values) {
  ScalarColumn<T> s1(tab, name + "s1");
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void checkColumns(Table& tab, const String& name, const Array<T>* values) {
  ScalarColumn<T> s1(tab, name + "s1");
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void writeRange(Table& tab, const String& name, Array<T>* values) {
  ScalarColumn<T> s1(tab, name + "s1");
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void checkRange(Table& tab, const String& name, const Array<T>* values) {
  ScalarColumn<T> s1(tab, name + "s1");
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void writeRowSlice(Table& tab, const String& name, Array<T>* values) {
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void checkRowSlice(Table& tab, const String& name, const Array<T>* values) {
  ScalarColumn<T> s1(tab, name + "s1");
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
...
template <typename T>
void writeColumnSlice(Table& tab, const String& name, Array<T>* values) {
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
  ...
  Slicer slicer3(IPosition(2, 0), (values[3].shape() - 1).getFirst(2), IPosition(2, 1, 1),
                 Slicer::endIsLast);
  Slicer aslicer1(IPosition(3, 0), values[1].shape() - 1, IPosition(3, 2, 3, 1), Slicer::endIsLast);
  Slicer aslicer2(IPosition(3, 0), values[2].shape() - 1, IPosition(3, 1, 2, 1), Slicer::endIsLast);
  Slicer aslicer3(IPosition(3, 0), values[3].shape() - 1, IPosition(3, 1, 1, 1), Slicer::endIsLast);
...
template <typename T>
void checkColumnSlice(Table& tab, const String& name, const Array<T>* values) {
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
  Slicer slicer1(IPosition(2, 0), (values[1].shape() - 1).getFirst(2), IPosition(2, 2, 3),
...
template <typename T>
void writeRangeSlice(Table& tab, const String& name, const Array<T>* values) {
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
  uInt start = 1;
...
template <typename T>
void checkRangeSlice(Table& tab, const String& name, const Array<T>* values) {
  ArrayColumn<T> a1(tab, name + "a1");
  ArrayColumn<T> a2(tab, name + "a2");
  ArrayColumn<T> a3(tab, name + "a3");
  uInt start = 1;
...
template <typename T>
void checkAll(Table& tab, const String& name, const Array<T>* values) {
