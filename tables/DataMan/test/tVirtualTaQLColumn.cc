  ...
  for (i = 0; i < 10; i++) {
    ...
    if (abval != i || acval != i + 1 || Int(adval) != i + 2 || aeval != i + 3 || afval != str ||
      ...
      cout << "error in row " << i << ": " << abval << ", " << acval << ", " << adval << ", "
           << aeval << ", " << afval << ", " << agval << ", " << acalcval << ", " << acalc3val
           << endl;
    }
    ...
    if (acalc2val != Complex(agval) + max(arrval)) {
      cout << "error in acalc2val in row " << i << ": " << acalc2val << endl;
    }
    ...
    if (acalc4val != acalcval + acalc3val + mean(arrval)) {
      cout << "error in acalc4val in row " << i << ": " << acalc4val << endl;
    }
