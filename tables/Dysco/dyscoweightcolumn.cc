...
void DyscoWeightColumn::Prepare(DyscoDistribution distribution, Normalization normalization,
...
void DyscoWeightColumn::decode(TimeBlockBuffer<data_t> *buffer, const unsigned int *data,
                               size_t blockRow, size_t /*a1*/, size_t /*a2*/) {
  _encoder->Decode(*buffer, data, blockRow);
}

void DyscoWeightColumn::encode(ThreadDataBase * /*threadData*/, TimeBlockBuffer<data_t> *buffer,
