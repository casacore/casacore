...
class DyscoWeightColumn final : public ThreadedDyscoColumn<float> {
 public:
   ...
   * new column.
   */
  DyscoWeightColumn(DyscoStMan *parent, int dtype) : ThreadedDyscoColumn(parent, dtype) {}
 ...
 protected:
  ...
  virtual std::unique_ptr<ThreadDataBase> initializeEncodeThread() override { return nullptr; }
  ...
  virtual size_t metaDataFloatCount(size_t /*nRows*/, size_t /*nPolarizations*/,
                                    size_t /*nChannels*/, size_t /*nAntennae*/) const override {
