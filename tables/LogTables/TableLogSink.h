...
inline const ScalarColumn<String>& TableLogSink::roObjectID() const { return id_p; }
inline ScalarColumn<String>& TableLogSink::objectID() { return id_p; }
inline const ScalarColumn<String>& TableLogSink::roMessage() const { return message_p; }
...
inline LogSink TableLogSink::makeSink(LogMessage::Priority filter, const String& fileName) {
