...
{                                                                            // 2
  ...
  log_sink_p.post(                                      // 17
      logMessage.priority(LogMessage::NORMAL)
          .line(__LINE__)
          .                    // 19
...
void DataClass::set(Int toWhat) {
  ...
  log_sink_p.post(logMessage.priority(LogMessage::NORMAL)
                      .line(__LINE__)
                      .                                      // 5
...
int main() {
  ...
  LogSink logger = TableLogSink::makeSink("dLogging2_tmp_messages");  // 2
                                                                      // 3
