...
TableExprNodeConstDComplex::TableExprNodeConstDComplex(const DComplex& val)
    : TableExprNodeBinary(NTComplex, VTScalar, OtLiteral, Constant), value_p(val) {}
DComplex TableExprNodeConstDComplex::getDComplex(const TableExprId&) { return value_p; }

TableExprNodeConstString::TableExprNodeConstString(const String& val)
    : TableExprNodeBinary(NTString, VTScalar, OtLiteral, Constant), value_p(val) {}
String TableExprNodeConstString::getString(const TableExprId&) { return value_p; }

TableExprNodeConstRegex::TableExprNodeConstRegex(const TaqlRegex& val)
    : TableExprNodeBinary(NTRegex, VTScalar, OtLiteral, Constant), value_p(val) {}
TaqlRegex TableExprNodeConstRegex::getRegex(const TableExprId&) { return value_p; }
...
TableExprNodeColumn::TableExprNodeColumn(const TableExprInfo& tableInfo, const String& name)
...
TableExprInfo TableExprNodeColumn::getTableInfo() const { return tableInfo_p; }
...
TableExprInfo TableExprNodeRowid::getTableInfo() const { return tableInfo_p; }
