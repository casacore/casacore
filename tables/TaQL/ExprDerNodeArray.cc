...
MArray<DComplex> TableExprNodeArrayConstInt::getArrayDComplex(const TableExprId&) {
  MArray<DComplex> arr;
  arr.fill(value_p);
  return arr;
}
...
TableExprNodeArrayConstDComplex::TableExprNodeArrayConstDComplex(const Array<DComplex>& val)
    : TableExprNodeArray(NTComplex, OtLiteral, val.shape()), value_p(val) {}
TableExprNodeArrayConstDComplex::TableExprNodeArrayConstDComplex(const Array<Complex>& val)
...
TableExprNodeArrayConstDComplex::TableExprNodeArrayConstDComplex(const MArray<DComplex>& val)
    : TableExprNodeArray(NTComplex, OtLiteral, val.shape()), value_p(val) {}
TableExprNodeArrayConstDComplex::TableExprNodeArrayConstDComplex(const MArray<Complex>& val)
    : TableExprNodeArray(NTComplex, OtLiteral, val.shape()) {
  value_p.fill(val);
}
...
MArray<DComplex> TableExprNodeArrayConstDComplex::getArrayDComplex(const TableExprId&) {
  return value_p;
}

TableExprNodeArrayConstString::TableExprNodeArrayConstString(const Array<String>& val)
    : TableExprNodeArray(NTString, OtLiteral, val.shape()), value_p(val) {}
TableExprNodeArrayConstString::TableExprNodeArrayConstString(const MArray<String>& val)
    : TableExprNodeArray(NTString, OtLiteral, val.shape()), value_p(val) {}
TableExprNodeArrayConstString::~TableExprNodeArrayConstString() {}
MArray<String> TableExprNodeArrayConstString::getArrayString(const TableExprId&) { return value_p; }

TableExprNodeArrayConstDate::TableExprNodeArrayConstDate(const Array<MVTime>& val)
...
MArray<MVTime> TableExprNodeArrayConstDate::getArrayDate(const TableExprId&) { return value_p; }
