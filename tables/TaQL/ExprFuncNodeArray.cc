...
MArray<T> TEFMASKrepl(const MArray<T>& arr, const TENShPtr& operand2, const TableExprId& id,
  ...
  if (operand2->valueType() == TableExprNodeRep::VTScalar) {
    ...
    if (!arr.shape().isEqual(arr2.shape())) {
      throw TableInvExpr(
          "TableExprFuncNodeArray::get<T>, array shapes "
...
template <typename T>
MArray<T> TableExprFuncNodeArray::TEFResize(const MArray<T>& arr, const TableExprId& id) {
...
TableExprFuncNodeArray::TableExprFuncNodeArray(TableExprFuncNode::FunctionType ftype,
...
const IPosition& TableExprFuncNodeArray::getDiagonalArg(const TableExprId& id,
  ...
  if (shp.size() > 0) {
    ...
    if (shp[ipos_p[0]] != shp[ipos_p[0] + 1]) {
      throw TableInvExpr("Diagonals axis " + std::to_string(ipos_p[0]) + " and " +
                         std::to_string(ipos_p[0] + 1) + " should have equal length");
    }
  ...
  switch (funcType()) {
    ...
    case TableExprFuncNode::near2FUNC:
      if (argDataType() == NTDouble) {
        if (operands()[0]->valueType() == VTScalar) {
          return near(operands()[0]->getDouble(id), operands()[1]->getArrayDouble(id), 1.0e-13);
        } else if (operands()[1]->valueType() == VTScalar) {
          return near(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id), 1.0e-13);
        } else {
          return near(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id),
                      1.0e-13);
        }
      }
      if (operands()[0]->valueType() == VTScalar) {
        return near(operands()[0]->getDComplex(id), operands()[1]->getArrayDComplex(id), 1.0e-13);
      } else if (operands()[1]->valueType() == VTScalar) {
        return near(operands()[0]->getArrayDComplex(id), operands()[1]->getDComplex(id), 1.0e-13);
      } else {
        return near(operands()[0]->getArrayDComplex(id), operands()[1]->getArrayDComplex(id),
                    1.0e-13);
      }
    case TableExprFuncNode::near3FUNC:
      if (argDataType() == NTDouble) {
        if (operands()[0]->valueType() == VTScalar) {
          return near(operands()[0]->getDouble(id), operands()[1]->getArrayDouble(id),
                      operands()[2]->getDouble(id));
        } else if (operands()[1]->valueType() == VTScalar) {
          return near(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id),
                      operands()[2]->getDouble(id));
        } else {
          return near(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id),
                      operands()[2]->getDouble(id));
      ...
      if (operands()[0]->valueType() == VTScalar) {
        return near(operands()[0]->getDComplex(id), operands()[1]->getArrayDComplex(id),
                    operands()[2]->getDouble(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return near(operands()[0]->getArrayDComplex(id), operands()[1]->getDComplex(id),
                    operands()[2]->getDouble(id));
      } else {
        return near(operands()[0]->getArrayDComplex(id), operands()[1]->getArrayDComplex(id),
                    operands()[2]->getDouble(id));
    ...
    case TableExprFuncNode::nearabs2FUNC:
      if (argDataType() == NTDouble) {
        if (operands()[0]->valueType() == VTScalar) {
          return nearAbs(operands()[0]->getDouble(id), operands()[1]->getArrayDouble(id), 1.0e-13);
        } else if (operands()[1]->valueType() == VTScalar) {
          return nearAbs(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id), 1.0e-13);
        } else {
          return nearAbs(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id),
                         1.0e-13);
        }
      }
      if (operands()[0]->valueType() == VTScalar) {
        return nearAbs(operands()[0]->getDComplex(id), operands()[1]->getArrayDComplex(id),
                       1.0e-13);
      } else if (operands()[1]->valueType() == VTScalar) {
        return nearAbs(operands()[0]->getArrayDComplex(id), operands()[1]->getDComplex(id),
                       1.0e-13);
      } else {
        return nearAbs(operands()[0]->getArrayDComplex(id), operands()[1]->getArrayDComplex(id),
                       1.0e-13);
      }
    case TableExprFuncNode::nearabs3FUNC:
      if (argDataType() == NTDouble) {
        if (operands()[0]->valueType() == VTScalar) {
          return nearAbs(operands()[0]->getDouble(id), operands()[1]->getArrayDouble(id),
                         operands()[2]->getDouble(id));
        } else if (operands()[1]->valueType() == VTScalar) {
          return nearAbs(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id),
                         operands()[2]->getDouble(id));
        } else {
          return nearAbs(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id),
                         operands()[2]->getDouble(id));
    ...
    case TableExprFuncNode::arrmaskFUNC: {
      ...
      switch (operands()[0]->dataType()) {
        ...
        default:
          throw TableInvExpr(
              "TableExprFuncNodeArray::getArrayBool, "
  ...
  switch (funcType()) {
    ...
    case TableExprFuncNode::weekFUNC: {
      ...
      switch (funcType()) {
        ...
        default:
          throw TableInvExpr(
              "TableExprFuncNodeArray::getArrayInt, "
    ...
    case TableExprFuncNode::minFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return min(operands()[1]->getArrayInt(id), operands()[0]->getInt(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return min(operands()[0]->getArrayInt(id), operands()[1]->getInt(id));
      } else {
        return min(operands()[0]->getArrayInt(id), operands()[1]->getArrayInt(id));
      }
    case TableExprFuncNode::maxFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return max(operands()[1]->getArrayInt(id), operands()[0]->getInt(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return max(operands()[0]->getArrayInt(id), operands()[1]->getInt(id));
      } else {
        return max(operands()[0]->getArrayInt(id), operands()[1]->getArrayInt(id));
      }
    case TableExprFuncNode::fmodFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return operands()[0]->getInt(id) % operands()[1]->getArrayInt(id);
      } else if (operands()[1]->valueType() == VTScalar) {
        return operands()[0]->getArrayInt(id) % operands()[1]->getInt(id);
      } else {
...
MArray<Double> TableExprFuncNodeArray::getArrayDouble(const TableExprId& id) {
  ...
  switch (funcType()) {
    ...
    case TableExprFuncNode::powFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return pow(operands()[0]->getDouble(id), operands()[1]->getArrayDouble(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return pow(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id));
      } else {
        return pow(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id));
      }
    case TableExprFuncNode::minFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return min(operands()[1]->getArrayDouble(id), operands()[0]->getDouble(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return min(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id));
      } else {
        return min(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id));
      }
    case TableExprFuncNode::maxFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return max(operands()[1]->getArrayDouble(id), operands()[0]->getDouble(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return max(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id));
      } else {
        return max(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id));
      }
    case TableExprFuncNode::atan2FUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return atan2(operands()[0]->getDouble(id), operands()[1]->getArrayDouble(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return atan2(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id));
      } else {
        return atan2(operands()[0]->getArrayDouble(id), operands()[1]->getArrayDouble(id));
      }
    case TableExprFuncNode::fmodFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return fmod(operands()[0]->getDouble(id), operands()[1]->getArrayDouble(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return fmod(operands()[0]->getArrayDouble(id), operands()[1]->getDouble(id));
      } else {
...
MArray<DComplex> TableExprFuncNodeArray::getArrayDComplex(const TableExprId& id) {
  ...
  switch (funcType()) {
    ...
    case TableExprFuncNode::powFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return casacore::pow(operands()[0]->getDComplex(id), operands()[1]->getArrayDComplex(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        if (operands()[1]->dataType() == NTDouble) {
          return casacore::pow(operands()[0]->getArrayDComplex(id), operands()[1]->getDouble(id));
        } else {
          return casacore::pow(operands()[0]->getArrayDComplex(id), operands()[1]->getDComplex(id));
        }
      } else {
        return pow(operands()[0]->getArrayDComplex(id), operands()[1]->getArrayDComplex(id));
      }
    case TableExprFuncNode::minFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return min(operands()[0]->getDComplex(id), operands()[1]->getArrayDComplex(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return min(operands()[0]->getArrayDComplex(id), operands()[1]->getDComplex(id));
      } else {
        return min(operands()[0]->getArrayDComplex(id), operands()[1]->getArrayDComplex(id));
      }
    case TableExprFuncNode::maxFUNC:
      if (operands()[0]->valueType() == VTScalar) {
        return max(operands()[0]->getDComplex(id), operands()[1]->getArrayDComplex(id));
      } else if (operands()[1]->valueType() == VTScalar) {
        return max(operands()[0]->getArrayDComplex(id), operands()[1]->getDComplex(id));
      } else {
        return max(operands()[0]->getArrayDComplex(id), operands()[1]->getArrayDComplex(id));
      }
    case TableExprFuncNode::asinFUNC:
    ...
    case TableExprFuncNode::complexFUNC: {
      if (operands().size() == 1) {
        ...
        Array<String>::const_iterator in = values.array().begin();
        for (Array<DComplex>::contiter out = res.cbegin(); out != res.cend(); ++out, ++in) {
      ...
      return MArray<DComplex>(makeComplex(arr1.array(), arr2.array()), arr1.combineMask(arr2));
    }
    case TableExprFuncNode::iifFUNC:
    ...
    case TableExprFuncNode::nullarrayFUNC:
      return MArray<DComplex>();
    case TableExprFuncNode::marrayFUNC:
      return MArray<DComplex>(operands()[0]->getDComplexAS(id), operands()[1]->getBoolAS(id));
    case TableExprFuncNode::arrdataFUNC: {
  ...
  throw TableInvExpr(
      "TableExprFuncNodeArray::getArrayDComplex, "
      "unknown function " +
      std::to_string(funcType()));
}
  ...
  switch (funcType()) {
    ...
    case TableExprFuncNode::replaceFUNC: {
      ...
      switch (funcType()) {
        ...
        default:
          throw TableInvExpr(
              "TableExprFuncNodeArray::getArrayString, "
    ...
    case TableExprFuncNode::stringFUNC: {
      ...
      if (operands()[0]->dataType() == NTBool) {
        ...
        for (Array<String>::iterator resIter = res.begin(); resIter != iterEnd;
             ++resIter, ++arrIter) {
          *resIter = TableExprFuncNode::stringValue(*arrIter, fmt, width, prec, mvFormat,
                                                    operands()[0]->unit());
        }
        return MArray<String>(res, arr);
      } else if (operands()[0]->dataType() == NTComplex) {
        ...
        for (Array<String>::iterator resIter = res.begin(); resIter != iterEnd;
             ++resIter, ++arrIter) {
          *resIter = TableExprFuncNode::stringValue(*arrIter, fmt, width, prec);
        }
        return MArray<String>(res, arr);
      } else if (operands()[0]->dataType() == NTDate) {
        std::pair<int, int> mvFormat = TableExprFuncNode::getMVFormat(fmt);
        ...
        for (Array<String>::iterator resIter = res.begin(); resIter != iterEnd;
             ++resIter, ++arrIter) {
          *resIter = TableExprFuncNode::stringValue(*arrIter, fmt, width, mvFormat);
        }
        return MArray<String>(res, arr);
      } else {
    ...
    case TableExprFuncNode::marrayFUNC:
      return MArray<String>(operands()[0]->getStringAS(id), operands()[1]->getBoolAS(id));
    case TableExprFuncNode::arrdataFUNC: {
...
MArray<MVTime> TableExprFuncNodeArray::getArrayDate(const TableExprId& id) {
  switch (funcType()) {
    ...
    case TableExprFuncNode::marrayFUNC:
      return MArray<MVTime>(operands()[0]->getDateAS(id), operands()[1]->getBoolAS(id));
    case TableExprFuncNode::arrdataFUNC: {
  ...
  throw TableInvExpr(
      "TableExprFuncNodeArray::getArrayDate, "
      "unknown function " +
      std::to_string(funcType()));
}
