...
TableExprGroupFirst::TableExprGroupFirst(TableExprNodeRep* node) : TableExprGroupFuncBase(node) {}
...
TableExprGroupLast::TableExprGroupLast(TableExprNodeRep* node) : TableExprGroupFirst(node) {}
TableExprGroupLast::~TableExprGroupLast() {}
void TableExprGroupLast::apply(const TableExprId& id) { itsId = id; }

TableExprGroupExprId::TableExprGroupExprId(TableExprNodeRep* node) : TableExprGroupFuncBase(node) {
...
void TableExprGroupFuncSet::add(const std::shared_ptr<TableExprGroupFuncBase>& func) {
