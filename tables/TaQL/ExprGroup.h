...
class TableExprGroupKey {
 public:
  ...
  explicit TableExprGroupKey(TableExprNodeRep::NodeDataType dtype) : itsDT(dtype) {}

  // Get the data type.
  TableExprNodeRep::NodeDataType dataType() const { return itsDT; }
...
class TableExprGroupKeySet {
 public:
  ...
  void addKey(TableExprNodeRep::NodeDataType dtype) { itsKeys.push_back(TableExprGroupKey(dtype)); }
...
class TableExprGroupResult {
 public:
  ...
  explicit TableExprGroupResult(const vector<std::shared_ptr<TableExprGroupFuncSet>>& funcSets);
  // Create from the possible set of immediate aggregate functions
...
class TableExprGroupFuncDate : public TableExprGroupFuncBase {
 public:
  explicit TableExprGroupFuncDate(TableExprNodeRep* node, const MVTime& initValue = MVTime())
      : TableExprGroupFuncBase(node), itsValue(initValue) {}
...
class TableExprGroupFuncString : public TableExprGroupFuncBase {
 public:
  explicit TableExprGroupFuncString(TableExprNodeRep* node, const String& initValue = String())
      : TableExprGroupFuncBase(node), itsValue(initValue) {}
...
class TableExprGroupFuncArrayDComplex : public TableExprGroupFuncBase {
 public:
  explicit TableExprGroupFuncArrayDComplex(TableExprNodeRep* node) : TableExprGroupFuncBase(node) {}
...
class TableExprGroupFuncArrayDate : public TableExprGroupFuncBase {
 public:
  explicit TableExprGroupFuncArrayDate(TableExprNodeRep* node) : TableExprGroupFuncBase(node) {}
...
class TableExprGroupFuncArrayString : public TableExprGroupFuncBase {
 public:
  explicit TableExprGroupFuncArrayString(TableExprNodeRep* node) : TableExprGroupFuncBase(node) {}
...
class TableExprGroupFuncSet {
 public:
  ...
  const vector<std::shared_ptr<TableExprGroupFuncBase>>& getFuncs() const { return itsFuncs; }

  // Get the TableExprId.
  const TableExprId& getId() const { return itsId; }
