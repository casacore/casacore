// # ExprLogicNodeArray.cc: Nodes representing logical array operators in table select expression
// tree # Copyright (C) 1997,1998,1999,2000,2001 # Associated Universities, Inc. Washington DC, USA.
// #
...
TableExprNodeArrayINInt::TableExprNodeArrayINInt(const TableExprNodeRep& node)
...
TableExprNodeArrayINDouble::TableExprNodeArrayINDouble(const TableExprNodeRep& node)
    : TableExprNodeArray(node, NTBool, OtIN) {}
...
TableExprNodeArrayINString::TableExprNodeArrayINString(const TableExprNodeRep& node)
    : TableExprNodeArray(node, NTBool, OtIN) {}
...
TableExprNodeArrayINDate::TableExprNodeArrayINDate(const TableExprNodeRep& node)
    : TableExprNodeArray(node, NTBool, OtIN) {}
