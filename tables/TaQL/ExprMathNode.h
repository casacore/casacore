// # ExprMathNode.h: Nodes representing scalar mathematical operators in table select expression
// tree # Copyright (C) 1994,1995,1996,1997,1999,2000 # Associated Universities, Inc. Washington DC,
// USA.
// #
