// # ExprMathNodeArray.cc: Nodes representing mathematical array operators in table select
// expression tree # Copyright (C) 1997,1998,1999,2000 # Associated Universities, Inc. Washington
// DC, USA.
// #
...
TableExprNodeArrayPlus::TableExprNodeArrayPlus(NodeDataType dt, const TableExprNodeRep& node)
...
TableExprNodeArrayPlusDComplex::TableExprNodeArrayPlusDComplex(const TableExprNodeRep& node)
    : TableExprNodeArrayPlus(NTComplex, node) {}
TableExprNodeArrayPlusDComplex::~TableExprNodeArrayPlusDComplex() {}
MArray<DComplex> TableExprNodeArrayPlusDComplex::getArrayDComplex(const TableExprId& id) {
  switch (argtype_p) {
    case ArrSca:
...
TableExprNodeArrayPlusString::TableExprNodeArrayPlusString(const TableExprNodeRep& node)
    : TableExprNodeArrayPlus(NTString, node) {}
TableExprNodeArrayPlusString::~TableExprNodeArrayPlusString() {}
MArray<String> TableExprNodeArrayPlusString::getArrayString(const TableExprId& id) {
  switch (argtype_p) {
    case ArrSca:
...
TableExprNodeArrayPlusDate::TableExprNodeArrayPlusDate(const TableExprNodeRep& node)
...
TableExprNodeArrayMinus::TableExprNodeArrayMinus(NodeDataType dt, const TableExprNodeRep& node)
...
TableExprNodeArrayMinusDComplex::TableExprNodeArrayMinusDComplex(const TableExprNodeRep& node)
    : TableExprNodeArrayMinus(NTComplex, node) {}
TableExprNodeArrayMinusDComplex::~TableExprNodeArrayMinusDComplex() {}
MArray<DComplex> TableExprNodeArrayMinusDComplex::getArrayDComplex(const TableExprId& id) {
  switch (argtype_p) {
    case ArrSca:
      return lnode_p->getArrayDComplex(id) - rnode_p->getDComplex(id);
    case ScaArr:
...
TableExprNodeArrayMinusDate::TableExprNodeArrayMinusDate(const TableExprNodeRep& node)
...
TableExprNodeArrayTimes::TableExprNodeArrayTimes(NodeDataType dt, const TableExprNodeRep& node)
...
TableExprNodeArrayTimesDComplex::TableExprNodeArrayTimesDComplex(const TableExprNodeRep& node)
    : TableExprNodeArrayTimes(NTComplex, node) {}
TableExprNodeArrayTimesDComplex::~TableExprNodeArrayTimesDComplex() {}
MArray<DComplex> TableExprNodeArrayTimesDComplex::getArrayDComplex(const TableExprId& id) {
  switch (argtype_p) {
    case ArrSca:
      return lnode_p->getArrayDComplex(id) * rnode_p->getDComplex(id);
    case ScaArr:
...
TableExprNodeArrayDivide::TableExprNodeArrayDivide(NodeDataType dt, const TableExprNodeRep& node)
...
TableExprNodeArrayDivideDComplex::TableExprNodeArrayDivideDComplex(const TableExprNodeRep& node)
    : TableExprNodeArrayDivide(NTComplex, node) {}
TableExprNodeArrayDivideDComplex::~TableExprNodeArrayDivideDComplex() {}
MArray<DComplex> TableExprNodeArrayDivideDComplex::getArrayDComplex(const TableExprId& id) {
  switch (argtype_p) {
    case ArrSca:
      return lnode_p->getArrayDComplex(id) / rnode_p->getDComplex(id);
    case ScaArr:
...
TableExprNodeArrayModulo::TableExprNodeArrayModulo(NodeDataType dt, const TableExprNodeRep& node)
    : TableExprNodeArray(node, dt, OtModulo) {}
TableExprNodeArrayModulo::~TableExprNodeArrayModulo() {}
void TableExprNodeArrayModulo::handleUnits() { TableExprNodeBinary::handleUnits(); }
