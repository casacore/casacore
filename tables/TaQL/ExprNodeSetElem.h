...
class TableExprNodeSetElemBase : public TableExprNodeRep {
 public:
  ...
  // value was not given.
  // <group>
  const TENShPtr& start() const { return itsStart; }
  const TENShPtr& end() const { return itsEnd; }
  const TENShPtr& increment() const { return itsIncr; }
  // </group>
...
class TableExprNodeSetElemDiscrete : public TableExprNodeSetElemBase {
 ...
 private:
  // Construct an element from the given parts and take over their pointers.
  // It is used by evaluate to construct an element in a rather cheap way.
  TableExprNodeSetElemDiscrete(const TableExprNodeSetElemDiscrete& that, const TENShPtr& start,
...
class TableExprNodeSetElemCont : public TableExprNodeSetElemBase {
 public:
  ...
  // Construct an element from the given parts and take over their pointers.
  // It is used by evaluate to construct an element in a rather cheap way.
  TableExprNodeSetElemCont(const TableExprNodeSetElemCont& that, const TENShPtr& start,
                           const TENShPtr& end);
...
class TableExprNodeSetElem : public TableExprNodeRep {
 public:
  ...
  // value was not given.
  // <group>
  const TENShPtr& start() const { return itsElem->start(); }
  const TENShPtr& end() const { return itsElem->end(); }
  const TENShPtr& increment() const { return itsElem->increment(); }
  // </group>
