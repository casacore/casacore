...
TableExprUDFNode::TableExprUDFNode(const std::shared_ptr<UDFBase>& udf,
                                   const TableExprInfo& tabInfo, const TableExprNodeSet& source)
...
TableExprInfo TableExprUDFNode::getTableInfo() const { return itsTableInfo; }

void TableExprUDFNode::disableApplySelection() { itsUDF->disableApplySelection(); }
...
MVTime TableExprUDFNode::getDate(const TableExprId& id) { return itsUDF->getDate(id); }
