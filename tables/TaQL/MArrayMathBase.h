...
inline bool compareAllMasked(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2,
...
inline bool compareAllLeftMasked(InputIterator1 first1, InputIterator1 last1, T left,
                                 MaskIterator mask1, CompareOperator op) {
...
// (see ArrayMath.h).
template <typename InputIterator1, typename T, typename MaskIterator, typename CompareOperator>
inline bool compareAllRightMasked(InputIterator1 first1, InputIterator1 last1, T right,
                                  MaskIterator mask1, CompareOperator op) {
  for (; first1 != last1; ++first1, ++mask1) {
    if (!*mask1) {
...
template <typename InputIterator1, typename InputIterator2, typename MaskIterator,
          typename CompareOperator>
inline bool compareAnyMasked(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2,
                             MaskIterator mask1, MaskIterator mask2, CompareOperator op) {
  for (; first1 != last1; ++first1, ++first2, ++mask1, ++mask2) {
    if (!*mask1 && !*mask2) {
...
// (see ArrayMath.h).
template <typename InputIterator1, typename T, typename MaskIterator, typename CompareOperator>
inline bool compareAnyLeftMasked(InputIterator1 first1, InputIterator1 last1, T left,
                                 MaskIterator mask1, CompareOperator op) {
  for (; first1 != last1; ++first1, ++mask1) {
    if (!*mask1) {
...
// (see ArrayMath.h).
template <typename InputIterator1, typename T, typename MaskIterator, typename CompareOperator>
inline bool compareAnyRightMasked(InputIterator1 first1, InputIterator1 last1, T right,
                                  MaskIterator mask1, CompareOperator op) {
  for (; first1 != last1; ++first1, ++mask1) {
    if (!*mask1) {
