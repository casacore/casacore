...
inline String recordGramRemoveEscapes(const String& in) { return tableGramRemoveEscapes(in); }

// A function to remove quotes from a quoted string.
inline String recordGramRemoveQuotes(const String& in) { return tableGramRemoveQuotes(in); }
...
class RecordGram {
 public:
  ...
  static void setNodePtr(TableExprNode* nodePtr) { theirNodePtr = nodePtr; }
 ...
 private:
  ...
  // Add a token to the list of tokens to be deleted.
  static void addToken(void* ptr, Token type) { theirTokens[ptr] = type; }
  // Remove a token from the list of tokens to be deleted.
  static void removeToken(void* ptr) { theirTokens.erase(ptr); }
