...
class TaQLJoin : public TaQLJoinBase {
 public:
  ...
  static std::shared_ptr<TaQLJoinBase> createRecursive(const std::vector<TableExprNode>& mainNodes,
  ...
  template <typename T>
  static std::shared_ptr<TaQLJoinBase> makeOptDiscrete(TableExprNodeRep& node,
  ...
  // Thereafter createRecursive is called for the next level.
  template <typename T>
  static std::shared_ptr<TaQLJoinBase> makeOptInterval(const TableExprNodeSet& set,
                                                       const std::vector<TableExprNode>& mainNodes,
                                                       const std::vector<TableExprNode>& joinNodes,
                                                       const std::vector<rownr_t>& rows,
                                                       size_t level);
