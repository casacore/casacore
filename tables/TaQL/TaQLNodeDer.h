...
class TaQLUnaryNodeRep : public TaQLNodeRep {
 public:
  // Do not change the values of this enum, as objects might be persistent.
  enum Type { U_MINUS = 0, U_NOT = 1, U_EXISTS = 2, U_NOTEXISTS = 3, U_BITNOT = 4 };
...
class TaQLMultiNodeRep : public TaQLNodeRep {
 public:
  ...
  void add(const TaQLNode& node) { itsNodes.push_back(node); }
  const std::vector<TaQLNode>& getNodes() const { return itsNodes; }
  virtual TaQLNodeResult visit(TaQLNodeVisitor&) const override;
  virtual void show(std::ostream& os) const override;
  virtual void save(AipsIO& aio) const override;
...
class TaQLColNodeRep : public TaQLNodeRep {
 public:
  TaQLColNodeRep(const TaQLNode& expr, const String& name, const String& nameMask,
                 const String& dtype);
  virtual TaQLNodeResult visit(TaQLNodeVisitor&) const override;
  virtual void show(std::ostream& os) const override;
  virtual void save(AipsIO& aio) const override;
...
class TaQLGroupNodeRep : public TaQLNodeRep {
 public:
  // Do not change the values of this enum, as objects might be persistent.
  enum Type { Normal = 0, Rollup = 1 };  // # in the future type Cube could be added
...
class TaQLSortKeyNodeRep : public TaQLNodeRep {
 public:
  // Do not change the values of this enum, as objects might be persistent.
  enum Type { Ascending = 0, Descending = 1, None = 2 };
...
class TaQLUpdExprNodeRep : public TaQLNodeRep {
 public:
  ...
  TaQLUpdExprNodeRep(const String& name, const String& nameMask, const TaQLMultiNode& indices,
                     const TaQLNode& expr);
  TaQLUpdExprNodeRep(const String& name, const String& nameMask, const TaQLMultiNode& indices1,
                     const TaQLMultiNode& indices2, const TaQLNode& expr);
  virtual TaQLNodeResult visit(TaQLNodeVisitor&) const override;
  virtual void show(std::ostream& os) const override;
  virtual void save(AipsIO& aio) const override;
  static TaQLNode restore(AipsIO& aio);
...
class TaQLSelectNodeRep : public TaQLQueryNodeRep {
 public:
  TaQLSelectNodeRep(const TaQLNode& columns, const TaQLMultiNode& withTables, const TaQLNode& where,
                    const TaQLNode& groupby, const TaQLNode& having, const TaQLNode& sort,
                    const TaQLNode& limitoff, const TaQLNode& giving, const TaQLMultiNode& dminfo);
  TaQLSelectNodeRep(const TaQLNode& columns, const TaQLMultiNode& withTables,
                    const TaQLMultiNode& fromTables, const TaQLMultiNode& joins,
                    const TaQLNode& where, const TaQLNode& groupby, const TaQLNode& having,
                    const TaQLNode& sort, const TaQLNode& limitoff, const TaQLNode& giving,
...
class TaQLCountNodeRep : public TaQLQueryNodeRep {
 public:
  TaQLCountNodeRep(const TaQLMultiNode& with, const TaQLNode& columns, const TaQLMultiNode& tables,
...
class TaQLUpdateNodeRep : public TaQLNodeRep {
 public:
  TaQLUpdateNodeRep(const TaQLMultiNode& with, const TaQLMultiNode& tables,
                    const TaQLMultiNode& update, const TaQLMultiNode& from, const TaQLNode& where,
...
class TaQLInsertNodeRep : public TaQLNodeRep {
 public:
  TaQLInsertNodeRep(const TaQLMultiNode& with, const TaQLMultiNode& tables,
                    const TaQLMultiNode& columns, const TaQLNode& values, const TaQLNode& limit);
  TaQLInsertNodeRep(const TaQLMultiNode& with, const TaQLMultiNode& tables,
...
class TaQLDeleteNodeRep : public TaQLNodeRep {
 public:
  TaQLDeleteNodeRep(const TaQLMultiNode& with, const TaQLMultiNode& tables, const TaQLNode& where,
                    const TaQLNode& sort, const TaQLNode& limitoff);
  virtual TaQLNodeResult visit(TaQLNodeVisitor&) const override;
  virtual void show(std::ostream& os) const override;
  virtual void save(AipsIO& aio) const override;
...
class TaQLCreTabNodeRep : public TaQLQueryNodeRep {
 public:
  TaQLCreTabNodeRep(const TaQLMultiNode& with, const TaQLNode& giving,
                    const TaQLMultiNode& likeDrop, const TaQLMultiNode& cols, const TaQLNode& limit,
                    const TaQLMultiNode& dminfo);
  virtual TaQLNodeResult visit(TaQLNodeVisitor&) const override;
  virtual void showDerived(std::ostream& os) const override;
  virtual void save(AipsIO& aio) const override;
...
class TaQLColSpecNodeRep : public TaQLNodeRep {
 public:
  TaQLColSpecNodeRep(const String& name, const String& likeCol, const String& dtype,
...
class TaQLAltTabNodeRep : public TaQLQueryNodeRep {
 public:
  TaQLAltTabNodeRep(const TaQLMultiNode& with, const TaQLNode& table, const TaQLMultiNode& from,
...
class TaQLConcTabNodeRep : public TaQLQueryNodeRep {
 public:
  TaQLConcTabNodeRep(const String& tableName, const TaQLMultiNode& tables,
