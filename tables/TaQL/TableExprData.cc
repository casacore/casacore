...
Double TableExprData::getDouble(const Block<Int>& fieldNrs) const { return getInt(fieldNrs); }
...
Array<DComplex> TableExprData::getArrayDComplex(const Block<Int>& fieldNrs) const {
