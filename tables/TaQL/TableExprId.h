...
inline TableExprId::TableExprId() : type_p(0), row_p(-1) {}

inline TableExprId::TableExprId(rownr_t rowNumber) : type_p(0), row_p(rowNumber) {}

inline TableExprId::TableExprId(const RecordInterface& record) : type_p(-1), record_p(&record) {}
...
inline const TableExprData& TableExprId::data() const { return *data_p; }

inline void TableExprId::setRownr(rownr_t rownr) { row_p = rownr; }
