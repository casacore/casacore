...
class TableParseFunc {
 public:
  ...
  // in the synopsis.
  static TableExprNode makeFuncNode(TableParseQuery*, const String& name,
                                    const TableExprNodeSet& arguments,
                                    const Vector<int>& ignoreFuncs, const TableExprInfo& tabInfo,
                                    const TaQLStyle&);
  ...
  static TableExprNode makeUDFNode(TableParseQuery*, const String& name,
                                   const TableExprNodeSet& arguments, const TableExprInfo& tabInfo,
                                   const TaQLStyle&);
