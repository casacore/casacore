...
class TableParseProject {
 public:
  ...
  Record& dminfo() { return dminfo_p; }

  // Get the table description.
  const TableDesc& tableDesc() const { return *tableDesc_p; }

  // Get the projected column names.
  const Block<String>& getColumnNames() const { return columnNames_p; }
  ...
  void setDMInfo(const Record& dminfo) { dminfo_p = dminfo; }
