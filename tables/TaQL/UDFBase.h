...
class UDFBase {
 public:
  ...
  // Get the attributes.
  const Record& getAttributes() const { return itsAttributes; }
 ...
 protected:
  // Get the operands.
  std::vector<TENShPtr>& operands() { return itsOperands; }
 ...
 public:
  ...
  // Get the data type.
  TableExprNodeRep::NodeDataType dataType() const { return itsDataType; }
