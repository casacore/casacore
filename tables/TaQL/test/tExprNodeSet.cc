...
void doSlicer() {
  {
    Slicer sl(IPosition(2, 1, 2), IPosition(2, 10, 12), IPosition(2, 2, 3), Slicer::endIsLast);
  ...
  {
    Slicer sl(IPosition(2, Slicer::MimicSource, 2), IPosition(2, 10, Slicer::MimicSource),
              Slicer::endIsLast);
