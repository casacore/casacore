...
template <typename T>
void doTestOrig(TableExprNodeSet& orig, TableExprNodeSetOptBase& set, const Vector<T>& testVec) {
  TableExprId id(0);
  for (T v : testVec) {
...
void doStringContSet() {
  ...
  {
    // Test closed-closed intervals
    TableExprNodeSetOptContSet<String, std::less_equal<String>, std::less_equal<String>> set(
        TableExprNodeSet(), st, end, std::less_equal<String>(), std::less_equal<String>(), "CC");
    set.show(cout, 2);
    // Vectors of test values and expected index.
  ...
  {
    // Test closed-open intervals
    TableExprNodeSetOptContSet<String, std::less_equal<String>, std::less<String>> set(
        TableExprNodeSet(), st, end, std::less_equal<String>(), std::less<String>(), "CO");
    set.show(cout, 2);
    // Vectors of test values and expected index.
    Vector<String> vec({"a0", "a1", "a3", "a5", "a6"});
  ...
  {
    // Test open-closed intervals
    TableExprNodeSetOptContSet<String, std::less<String>, std::less_equal<String>> set(
        TableExprNodeSet(), st, end, std::less<String>(), std::less_equal<String>(), "OC");
    set.show(cout, 2);
    // Vectors of test values and expected index.
    Vector<String> vec({"a0", "a1", "a3", "a5", "a6"});
  ...
  {
    // Test open-open intervals
    TableExprNodeSetOptContSet<String, std::less<String>, std::less<String>> set(
        TableExprNodeSet(), st, end, std::less<String>(), std::less<String>(), "OO");
    set.show(cout, 2);
    // Vectors of test values and expected index.
    Vector<String> vec({"a0", "a1", "a3", "a5", "a6"});
