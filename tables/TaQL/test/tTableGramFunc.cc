...
int checkScaBool(const String& func, const String& arg, Bool expResult) {
  ...
  try {
    ...
    if (node.dataType() != TpBool) {
      ...
      cout << " expected data type Bool, found " << ValType::getTypeStr(node.dataType()) << endl;
      return 1;
    }
    if (node.getBool(0) != expResult || node.unit().getName() != "") {
      cout << "Bool error in evaluating: " + comm << endl;
      cout << " expected " << expResult << endl;
      cout << " found    " << node.getBool(0) << ' ' << node.unit().getName() << endl;
      return 1;
    }
...
int checkScaInt(const String& func, const String& arg, Int expResult) {
  ...
  try {
    ...
    if (node.dataType() != TpInt64) {
      ...
      cout << " expected data type Int, found " << ValType::getTypeStr(node.dataType()) << endl;
      return 1;
    }
    if (node.getInt(0) != expResult || node.unit().getName() != "") {
      cout << "Int error in evaluating: " + comm << endl;
      cout << " expected " << expResult << endl;
      cout << " found    " << node.getInt(0) << ' ' << node.unit().getName() << endl;
      return 1;
    }
  } catch (const std::exception& x) {
    cout << x.what() << endl;
...
int checkScaDouble(const String& func, const String& arg, Double expResult,
  ...
  try {
    ...
    if (node.dataType() != TpDouble) {
      ...
      cout << " expected data type Double, found " << ValType::getTypeStr(node.dataType()) << endl;
      return 1;
    }
...
int checkScaDComplex(const String& func, const String& arg, DComplex expResult) {
  ...
  try {
    ...
    if (node.dataType() != TpDComplex) {
      ...
      cout << " expected data type DComplex, found " << ValType::getTypeStr(node.dataType())
           << endl;
      return 1;
    }
    if (!near(node.getDComplex(0), expResult) || node.unit().getName() != "") {
      cout << "DComplex error in evaluating: " + comm << endl;
      cout << " expected " << expResult << endl;
      cout << " found    " << node.getDComplex(0) << ' ' << node.unit().getName() << endl;
      return 1;
    }
  } catch (const std::exception& x) {
    cout << x.what() << endl;
...
int checkScaDateTime(const String& func, const String& arg, MVTime expResult) {
  ...
  try {
    ...
    if (node.dataType() != TpQuantity) {
      ...
      cout << " expected data type Quantity, found " << ValType::getTypeStr(node.dataType())
           << endl;
      return 1;
    }
    if (!(node.getDate(0) == expResult) || node.unit().getName() != "") {
      ...
      cout << "DateTime error in evaluating: " + comm << endl;
      cout << " expected " << expResult << endl;
      cout << " found    " << node.getDate(0) << ' ' << node.unit().getName() << endl;
      return 1;
    }
  } catch (const std::exception& x) {
    cout << x.what() << endl;
...
int checkScaString(const String& func, const String& arg, String expResult) {
  ...
  try {
    ...
    if (node.dataType() != TpString) {
      ...
      cout << " expected data type String, found " << ValType::getTypeStr(node.dataType()) << endl;
      return 1;
    }
    if (node.getString(0) != expResult || node.unit().getName() != "") {
      cout << "String error in evaluating: " + comm << endl;
      cout << " expected " << expResult << endl;
      cout << " found    " << node.getString(0) << ' ' << node.unit().getName() << endl;
      return 1;
    }
  } catch (const std::exception& x) {
    cout << x.what() << endl;
...
int checkArrBool(const String& func, const String& arg, const String& expResult) {
  ...
  try {
    ...
    if (node1.dataType() != TpBool) {
      ...
      cout << " expected data type Bool, found " << ValType::getTypeStr(node1.dataType()) << endl;
      return 1;
    }
...
int checkArrInt(const String& func, const String& arg, const String& expResult) {
  ...
  try {
    ...
    if (node1.dataType() != TpInt64) {
      ...
      cout << " expected data type Int, found " << ValType::getTypeStr(node1.dataType()) << endl;
      return 1;
    }
...
int checkArrDouble(const String& func, const String& arg, const String& expResult) {
  ...
  try {
    ...
    if (node1.dataType() != TpDouble) {
      ...
      cout << " expected data type Double, found " << ValType::getTypeStr(node1.dataType()) << endl;
      return 1;
    }
...
int checkArrDComplex(const String& func, const String& arg, const String& expResult) {
  ...
  try {
    ...
    if (node1.dataType() != TpDComplex) {
      ...
      cout << " expected data type DComplex, found " << ValType::getTypeStr(node1.dataType())
           << endl;
      return 1;
    }
...
int checkArrString(const String& func, const String& arg, const String& expResult) {
  ...
  try {
    ...
    if (node1.dataType() != TpString) {
      ...
      cout << " expected data type String, found " << ValType::getTypeStr(node1.dataType()) << endl;
      return 1;
    }
...
int checkArrInt2(const String& func, const String& arg1, const String& arg2, const String& arg3) {
  // Check an array function with 2 arguments by comparing with its scalar counterpart.
  int nfail = 0;
  // arr-arr
  nfail += checkArrInt(
      func, '[' + arg1 + ',' + arg2 + "],[" + arg2 + ',' + arg3 + ']',
      '[' + func + '(' + arg1 + ',' + arg2 + ")," + func + '(' + arg2 + ',' + arg3 + ")]");
  // sca-arr
  nfail += checkArrInt(
      func, arg1 + ",[" + arg2 + ',' + arg3 + ']',
      '[' + func + '(' + arg1 + ',' + arg2 + ")," + func + '(' + arg1 + ',' + arg3 + ")]");
  // arr-sca
  nfail += checkArrInt(
      func, '[' + arg1 + ',' + arg2 + "]," + arg3,
      '[' + func + '(' + arg1 + ',' + arg3 + ")," + func + '(' + arg2 + ',' + arg3 + ")]");
  return nfail;
}
...
int checkExcp(const String& func, const String& arg, const String& msgPart = String()) {
  ntest++;
  String comm = "using style python calc " + func + '(' + arg + ')';
  try {
    tableCommand(comm);
...
int testScaDComplex() {
  ...
  nfail +=
      checkScaDComplex("cube", "1.4+1i", DComplex(1.4, 1) * DComplex(1.4, 1) * DComplex(1.4, 1));
...
int testArrString() {
  ...
  int nfail = 0;
  nfail += checkArrString("hdms", "[3d2m4.16,-3h2m4.16]", "['00h12m08.277', '-045d31m02.400']");
  return nfail;
}
...
int testMaskedArr() {
  ...
  // Check with a mask.
  nfail +=
      checkArrInt("arraydata", "marray([[1,2,3],[4,5,6]],[[T,F,F],[F,T,F]])", "[[1,2,3],[4,5,6]]");
  ...
  nfail += checkArrInt("arraydata", "replacemasked([[1,2,3],[4,5,6]][[[T,F,F],[F,T,F]]], 10)",
                       "[[10,2,3],[4,10,6]]");
  nfail += checkArrInt(
      "arraydata", "replacemasked([[1,2,3],[4,5,6]][[[T,F,F],[F,T,F]]], [[-1,-2,-3],[-4,-5,-6]])",
      "[[-1,2,3],[4,-5,6]]");
  nfail += checkArrInt("arraydata", "replaceunmasked([[1,2,3],[4,5,6]][[[T,F,F],[F,T,F]]], 10)",
                       "[[1,10,10],[10,5,10]]");
  nfail += checkArrInt(
      "arraydata", "replaceunmasked([[1,2,3],[4,5,6]][[[T,F,F],[F,T,F]]], [[-1,-2,-3],[-4,-5,-6]])",
      "[[1,-2,-3],[-4,5,-6]]");
  ...
  nfail += checkArrInt("arraydata", "replacemasked([[1,2,3],[4,5,6]], 10)", "[[1,2,3],[4,5,6]]");
  nfail += checkArrInt("arraydata", "replacemasked([[1,2,3],[4,5,6]], [[-1,-2,-3],[-4,-5,-6]])",
                       "[[1,2,3],[4,5,6]]");
  nfail +=
      checkArrInt("arraydata", "replaceunmasked([[1,2,3],[4,5,6]], 10)", "[[10,10,10],[10,10,10]]");
