...
BOOST_AUTO_TEST_CASE(split_name) {
  ...
  result = splitName(short_hand, column_name, field_names, "First::Second", kCheckError, true,
                     kAllowNoKey);
  BOOST_CHECK(result);
  BOOST_CHECK_EQUAL(short_hand, "");
  ...
  result =
      splitName(short_hand, column_name, field_names, "A::B.c", kCheckError, true, kAllowNoKey);
  BOOST_CHECK(result);
  BOOST_CHECK_EQUAL(short_hand, "");
  BOOST_CHECK_EQUAL(column_name, "A");
  ...
  result =
      splitName(short_hand, column_name, field_names, "A.b::C.D.E", kCheckError, true, kAllowNoKey);
  BOOST_CHECK(result);
  BOOST_CHECK_EQUAL(short_hand, "A");
  BOOST_CHECK_EQUAL(column_name, "b");
  ...
  result =
      splitName(short_hand, column_name, field_names, "::A.Bc", kCheckError, true, kAllowNoKey);
  BOOST_CHECK(result);
  BOOST_CHECK_EQUAL(short_hand, "");
  BOOST_CHECK_EQUAL(column_name, "");
  BOOST_REQUIRE_EQUAL(field_names.size(), 2);
  ...
  result =
      splitName(short_hand, column_name, field_names, "::A.Bc", kCheckError, false, kAllowNoKey);
  BOOST_CHECK(result);
  BOOST_CHECK_EQUAL(short_hand, "");
  BOOST_CHECK_EQUAL(column_name, "");
  BOOST_REQUIRE_EQUAL(field_names.size(), 2);
  ...
  result = splitName(short_hand, column_name, field_names, "Shorthand.Column::Field1.Field2.Field3",
                     kCheckError, true, kAllowNoKey);
  BOOST_CHECK(result);
  ...
  BOOST_CHECK_THROW(
      splitName(short_hand, column_name, field_names, "", kCheckError, true, kAllowNoKey),
      std::exception);
  BOOST_CHECK_THROW(
      splitName(short_hand, column_name, field_names, "", kCheckError, false, kAllowNoKey),
      std::exception);
  BOOST_CHECK_THROW(splitName(short_hand, column_name, field_names, "S.C::Field1..Field2",
                              kCheckError, true, kAllowNoKey),
                    std::exception);
