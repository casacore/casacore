...
ArrayColumnDescBase::ArrayColumnDescBase(const ArrayColumnDescBase& that) : BaseColumnDesc(that) {}

ArrayColumnDescBase::~ArrayColumnDescBase() {}

ArrayColumnDescBase& ArrayColumnDescBase::operator=(const ArrayColumnDescBase& that) {
  BaseColumnDesc::operator=(that);
  return *this;
}

// # Return the class name.
String ArrayColumnDescBase::className() const { return "ArrayColumnDesc<" + dataTypeId(); }
