...
template <class T>
ArrayColumnDesc<T>::ArrayColumnDesc(const ArrayColumnDesc<T>& that) : ArrayColumnDescBase(that) {}
...
template <class T>
ArrayColumnDesc<T>& ArrayColumnDesc<T>::operator=(const ArrayColumnDesc<T>& that) {
