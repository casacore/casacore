...
template <class T>
ArrayColumn<T>::ArrayColumn() : ArrayColumnBase() {}
...
template <class T>
ArrayColumn<T>::ArrayColumn(const TableColumn& column) : ArrayColumnBase(column) {
  checkDataType();
}

template <class T>
ArrayColumn<T>::ArrayColumn(const ArrayColumn<T>& that) : ArrayColumnBase(that) {}
...
template <class T>
Array<T> ArrayColumn<T>::getSlice(rownr_t rownr, const Slicer& arraySection) const {
  Array<T> arr;
...
template <class T>
Array<T> ArrayColumn<T>::getSlice(rownr_t rownr, const Vector<Vector<Slice>>& arraySlices) const {
  Array<T> arr;
...
template <class T>
Array<T> ArrayColumn<T>::getColumn(const Vector<Vector<Slice>>& arraySlices) const {
  Array<T> arr;
...
template <class T>
Array<T> ArrayColumn<T>::getColumnRange(const Slicer& rowRange, const Slicer& arraySection) const {
  Array<T> arr;
...
template <class T>
Array<T> ArrayColumn<T>::getColumnCells(const RefRows& rownrs, const Slicer& arraySection) const {
  Array<T> arr;
...
template <class T>
void ArrayColumn<T>::setShape(rownr_t rownr, const IPosition& shape, const IPosition& tileShape) {
...
template <class T>
void ArrayColumn<T>::putSlice(rownr_t rownr, const Slicer& arraySection, const Array<T>& arr) {
  acbPutSlice(rownr, arraySection, arr);
}

template <class T>
void ArrayColumn<T>::putSlice(rownr_t rownr, const Vector<Vector<Slice>>& arraySlices,
                              const Array<T>& arr) {
  acbPutSlice(rownr, arraySlices, arr);
}

template <class T>
void ArrayColumn<T>::putColumnCells(const RefRows& rows, const Vector<Vector<Slice>>& arraySlices,
                                    const Array<T>& source) {
  acbPutColumnCells(rows, arraySlices, source);
}

template <typename T>
void ArrayColumn<T>::putColumnCells(const RefRows& rows, const ColumnSlicer& columnSlicer,
                                    const Array<T>& source) {
...
template <class T>
void ArrayColumn<T>::putColumn(const Vector<Vector<Slice>>& arraySlices, const Array<T>& arr) {
  acbPutColumn(arraySlices, arr);
}

template <class T>
void ArrayColumn<T>::putColumnRange(const Slicer& rowRange, const Array<T>& arr) {
  acbPutColumnRange(rowRange, arr);
}

template <class T>
void ArrayColumn<T>::putColumnCells(const RefRows& rownrs, const Array<T>& arr) {
  acbPutColumnCells(rownrs, arr);
}

template <class T>
void ArrayColumn<T>::putColumnRange(const Slicer& rowRange, const Slicer& arraySection,
                                    const Array<T>& arr) {
  acbPutColumnRange(rowRange, arraySection, arr);
}

template <class T>
void ArrayColumn<T>::putColumnCells(const RefRows& rownrs, const Slicer& arraySection,
                                    const Array<T>& arr) {
