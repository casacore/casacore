...
class GetCellSlices : public BaseSlicesFunctor {
 public:
  GetCellSlices(const ArrayColumnBase& col, rownr_t rownr) : itsCol(col), itsRow(rownr) {}
...
class PutCellSlices : public BaseSlicesFunctor {
 public:
  PutCellSlices(ArrayColumnBase& col, rownr_t rownr) : itsCol(col), itsRow(rownr) {}
  virtual void apply(const Slicer& slicer, ArrayBase& arr) {
...
class PutColumnSlices : public BaseSlicesFunctor {
 public:
  PutColumnSlices(ArrayColumnBase& col) : itsCol(col) {}
  virtual void apply(const Slicer& slicer, ArrayBase& arr) { itsCol.acbPutColumn(slicer, arr); }
