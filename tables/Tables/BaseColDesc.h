...
class BaseColumnDesc {
 ...
 public:
  ...
  // <group>
  TableRecord& rwKeywordSet() { return *keySetPtr_p; }
  const TableRecord& keywordSet() const { return *keySetPtr_p; }
  // </group>
  ...
  const String& name() const { return colName_p; }
  ...
  const String& dataTypeId() const { return dtypeId_p; }

  // Get the type name of the default data manager.
  const String& dataManagerType() const { return dataManType_p; }

  // Get the type name of the default data manager.
  // (allowing it to be changed)
  String& dataManagerType() { return dataManType_p; }

  // Get the data manager group.
  const String& dataManagerGroup() const { return dataManGroup_p; }
  ...
  const TableDesc* tableDesc() const { return ((BaseColumnDesc*)this)->tableDesc(); }
 ...
 public:
  ...
  void setName(const String& name) { colName_p = name; }
};
