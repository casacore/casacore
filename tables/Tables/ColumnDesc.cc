...
const String& ColumnDesc::name() const { return colPtr_p->name(); }
...
void ColumnDesc::show() const { show(cout); }
...
// # Register a mapping.
void ColumnDesc::registerCtor(const String& name, ColumnDesc::ColumnDescCtor* func) {
