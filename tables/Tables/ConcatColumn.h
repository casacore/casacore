...
class ConcatColumn : public BaseColumn {
 ...
 private:
  ...
  typedef void AccessRowsFunc(BaseColumn* col, const RefRows& rows, const Slicer*,
                              ArrayBase& array);
  ...
  void accessRows(const RefRows& rownrs, const Slicer* ns, ArrayBase& dataPtr,
  ...
  static void getRowsSlicePart(BaseColumn* col, const RefRows& rows, const Slicer*,
                               ArrayBase& array);
  static void putRowsSlicePart(BaseColumn* col, const RefRows& rows, const Slicer*,
                               ArrayBase& array);
  // </group>
