...
class ConcatTable : public BaseTable {
 public:
  ...
  ConcatTable(const Block<String>& tableNames, const Block<String>& subTables,
  ...
  ConcatTable(AipsIO&, const String& name, rownr_t nrrow, int option, const TableLock& lockOptions,
              const TSMOption& tsmOption);
 ...
 private:
  ...
  void openTables(const Block<String>& tableNames, int option, const TableLock& lockOptions,
                  const TSMOption& tsmOption);
