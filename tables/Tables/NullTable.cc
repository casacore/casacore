...
const TableLock& NullTable::lockOptions() const { throw makeError("lockOptions"); }
...
TableDesc NullTable::actualTableDesc() const { throw makeError("actualTableDesc"); }

Record NullTable::dataManagerInfo() const { throw makeError("dataManagerInfo"); }

TableRecord& NullTable::keywordSet() { throw makeError("keywordSet"); }
...
Vector<rownr_t> NullTable::rowNumbers() const { throw makeError("rowNumbers"); }
...
void NullTable::renameSubTables(const String&, const String&) {
