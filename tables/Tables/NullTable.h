...
public:
  ...
  virtual bool lock (FileLocker::LockType, uint32_t nattempts) override;
  virtual void unlock() override;
  virtual void flush (bool fsync, bool recursive) override;
  virtual void resync() override;
  virtual uint32_t getModifyCounter() const override;
  ...
  virtual BaseColumn* getColumn (uint32_t columnIndex) const override;
