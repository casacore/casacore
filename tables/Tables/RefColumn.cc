...
RefColumn::RefColumn(const BaseColumnDesc* bcdp, RefTable* reftab, BaseColumn* bcp)
    : BaseColumn(bcdp), refTabPtr_p(reftab), colPtr_p(bcp) {}
...
rownr_t RefColumn::nrow() const { return refTabPtr_p->nrow(); }
...
void RefColumn::setShape(rownr_t rownr, const IPosition& shape, const IPosition& tileShape) {
...
void RefColumn::getColumnSlice(const Slicer& ns, ArrayBase& data) const {
  colPtr_p->getColumnSliceCells(refTabPtr_p->rowNumbers(), ns, data);
}
void RefColumn::getScalarColumnCells(const RefRows& rownrs, ArrayBase& data) const {
  colPtr_p->getScalarColumnCells(rownrs.convert(refTabPtr_p->rowNumbers()), data);
}
void RefColumn::getArrayColumnCells(const RefRows& rownrs, ArrayBase& data) const {
  colPtr_p->getArrayColumnCells(rownrs.convert(refTabPtr_p->rowNumbers()), data);
}
void RefColumn::getColumnSliceCells(const RefRows& rownrs, const Slicer& ns,
                                    ArrayBase& data) const {
  colPtr_p->getColumnSliceCells(rownrs.convert(refTabPtr_p->rowNumbers()), ns, data);
}
...
void RefColumn::putColumnSlice(const Slicer& ns, const ArrayBase& data) {
  colPtr_p->putColumnSliceCells(refTabPtr_p->rowNumbers(), ns, data);
}
void RefColumn::putScalarColumnCells(const RefRows& rownrs, const ArrayBase& data) {
  colPtr_p->putScalarColumnCells(rownrs.convert(refTabPtr_p->rowNumbers()), data);
}
void RefColumn::putArrayColumnCells(const RefRows& rownrs, const ArrayBase& data) {
  colPtr_p->putArrayColumnCells(rownrs.convert(refTabPtr_p->rowNumbers()), data);
}
void RefColumn::putColumnSliceCells(const RefRows& rownrs, const Slicer& ns,
                                    const ArrayBase& data) {
  colPtr_p->putColumnSliceCells(rownrs.convert(refTabPtr_p->rowNumbers()), ns, data);
}
...
void RefColumn::allocIterBuf(void*& lastVal, void*& curVal, std::shared_ptr<BaseCompare>& cmpObj) {
