...
class RefTable : public BaseTable {
 public:
  ...
  RefTable(AipsIO&, const String& name, rownr_t nrrow, int option, const TableLock& lockOptions,
...
inline rownr_t RefTable::rootRownr(rownr_t rnr) const { return rowStorage_p[rnr]; }
