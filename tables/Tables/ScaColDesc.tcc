...
template <class T>
ScalarColumnDesc<T>::ScalarColumnDesc(const String& name, const String& comment,
...
ScalarColumnDesc<T>::ScalarColumnDesc(const ScalarColumnDesc<T>& that)
    : BaseColumnDesc(that), defaultVal_p(that.defaultVal_p) {}
...
template <class T>
ScalarColumnDesc<T>& ScalarColumnDesc<T>::operator=(const ScalarColumnDesc<T>& that) {
