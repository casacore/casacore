...
ScalarRecordColumnDesc& ScalarRecordColumnDesc::operator=(const ScalarRecordColumnDesc& that) {
  BaseColumnDesc::operator=(that);
  return *this;
}

// Clone this column description to another.
BaseColumnDesc* ScalarRecordColumnDesc::clone() const { return new ScalarRecordColumnDesc(*this); }

// Return the class name.
String ScalarRecordColumnDesc::className() const { return "ScalarRecordColumnDesc"; }
