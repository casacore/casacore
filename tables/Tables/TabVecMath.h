...
template <class T>
inline void operator+=(TableVector<T>& left, const TableVector<T>& right);
...
template <class T>
inline TableVector<T> operator+(const TableVector<T>& left, const TableVector<T>& right);
...
template <class T>
inline TableVector<T> operator+(const TableVector<T>& left, const T& right);
...
// in a new table vector.
template <class T>
inline TableVector<T> operator+(const T& left, const TableVector<T>& right);
// Subtract a scalar from each element in the table vector storing result
// in a new table vector.
template <class T>
inline TableVector<T> operator-(const T& left, const TableVector<T>& right);
...
template <class T>
inline TableVector<T> cos(const TableVector<T>&);
template <class T>
inline TableVector<T> cosh(const TableVector<T>&);
template <class T>
inline TableVector<T> exp(const TableVector<T>&);
template <class T>
inline TableVector<T> log(const TableVector<T>&);
template <class T>
inline TableVector<T> log10(const TableVector<T>&);
template <class T>
inline TableVector<T> pow(const TableVector<T>& value, const TableVector<T>& exponent);
template <class T>
inline TableVector<T> sin(const TableVector<T>&);
template <class T>
inline TableVector<T> sinh(const TableVector<T>&);
template <class T>
inline TableVector<T> sqrt(const TableVector<T>&);
// </group>
...
template <class T>
inline TableVector<T> acos(const TableVector<T>&);
template <class T>
inline TableVector<T> asin(const TableVector<T>&);
template <class T>
inline TableVector<T> atan(const TableVector<T>&);
template <class T>
inline TableVector<T> atan2(const TableVector<T>& y, const TableVector<T>& x);
template <class T>
inline TableVector<T> ceil(const TableVector<T>&);
template <class T>
inline TableVector<T> fabs(const TableVector<T>&);
template <class T>
inline TableVector<T> floor(const TableVector<T>&);
template <class T>
inline TableVector<T> fmod(const TableVector<T>& value, const TableVector<T>& modulo);
template <class T>
inline TableVector<T> pow(const TableVector<T>& value, const double& exponent);
template <class T>
inline TableVector<T> tan(const TableVector<T>&);
template <class T>
inline TableVector<T> tanh(const TableVector<T>&);
// </group>
...
template <class T>
inline T sum(const TableVector<T>&);
...
// </note>
template <class T>
inline T product(const TableVector<T>&);
// </group>
...
template <class T>
inline T innerProduct(const TableVector<T>& left, const TableVector<T>& right);

// The norm of a table vector.
template <class T>
inline T norm(const TableVector<T>&);

// The cross product of 2 table vectors containing 3 elements.
template <class T>
inline TableVector<T> crossProduct(const TableVector<T>& left, const TableVector<T>& right);
// </group>
...
#define TABVECMATHOPER(NAME, OP, OPA)                                                   \
  template <class T>                                                                    \
  inline TableVector<T> aips_name2(operato, OP)(const TableVector<T>& tv, const T& v) { \
    return TableVector<T>(aips_name2(tabVecRepvalr, NAME)(tv.tabVec(), v));             \
  }                                                                                     \
  template <class T>                                                                    \
  inline TableVector<T> aips_name2(operato, OP)(const T& v, const TableVector<T>& tv) { \
    return TableVector<T>(aips_name2(tabVecRepvall, NAME)(v, tv.tabVec()));             \
  }                                                                                     \
  template <class T>                                                                    \
  inline TableVector<T> aips_name2(operato, OP)(const TableVector<T>& l,                \
                                                const TableVector<T>& r) {              \
    return TableVector<T>(aips_name2(tabVecReptv, NAME)(l.tabVec(), r.tabVec()));       \
  }                                                                                     \
  template <class T>                                                                    \
  inline void aips_name2(operato, OPA)(TableVector<T> & tv, const T& v) {               \
    aips_name2(tabVecRepvalass, NAME)(tv.tabVec(), v);                                  \
  }                                                                                     \
  template <class T>                                                                    \
  inline void aips_name2(operato, OPA)(TableVector<T> & l, const TableVector<T>& r) {   \
...
#define TABVECMATHFUNC(NAME)                                         \
  template <class T>                                                 \
  inline TableVector<T> NAME(const TableVector<T>& tv) {             \
    return TableVector<T>(aips_name2(tabVecRep, NAME)(tv.tabVec())); \
  }
#define TABVECMATHFUNC2(NAME)                                                    \
  template <class T>                                                             \
  inline TableVector<T> NAME(const TableVector<T>& l, const TableVector<T>& r) { \
    return TableVector<T>(aips_name2(tabVecRep, NAME)(l.tabVec(), r.tabVec()));  \
  }
...
template <class T>
inline TableVector<T> pow(const TableVector<T>& tv, const double& exp) {
  return TableVector<T>(tabVecReppowd(tv.tabVec(), exp));
}

template <class T>
inline T sum(const TableVector<T>& tv) {
  return tabVecRepsum(tv.tabVec());
}
template <class T>
inline T product(const TableVector<T>& tv) {
  return tabVecRepproduct(tv.tabVec());
}

template <class T>
inline void minMax(T& min, T& max, const TableVector<T>& tv) {
  tabVecRepminmax(min, max, tv.tabVec());
}
template <class T>
inline T min(const TableVector<T>& tv) {
  T Min, Max;
  tabVecRepminmax(Min, Max, tv.tabVec());
  return Min;
}
template <class T>
inline T max(const TableVector<T>& tv) {
  T Min, Max;
  tabVecRepminmax(Min, Max, tv.tabVec());
  return Max;
}
...
template <class T>
inline void indgen(TableVector<T>& tv, T start, T inc) {
  tabVecRepindgen(tv.tabVec(), start, inc);
}
template <class T>
inline void indgen(TableVector<T>& tv, T start) {
  tabVecRepindgen(tv.tabVec(), start, T(1));
}
template <class T>
inline void indgen(TableVector<T>& tv) {
  tabVecRepindgen(tv.tabVec(), T(0), T(1));
}

template <class T>
inline T innerProduct(const TableVector<T>& l, const TableVector<T>& r) {
  return tabVecRepinnerproduct(l.tabVec(), r.tabVec());
}
template <class T>
inline T norm(const TableVector<T>& tv) {
  return tabVecRepnorm(tv.tabVec());
}
template <class T>
inline TableVector<T> crossProduct(const TableVector<T>& l, const TableVector<T>& r) {
