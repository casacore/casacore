...
class TableCopy {
 public:
  ...
  static void cloneColumn(const Table& fromTable, const String& fromColumn, Table& toTable,
                          const String& newColumn, const String& dataManagerName = String(),
                          const Record& newdmInfo = Record());

  // Cloning as above, but the data type is set to the template parameter.
  template <typename T>
  static void cloneColumnTyped(const Table& fromTable, const String& fromColumn, Table& toTable,
                               const String& newColumn, const String& dataManagerName = String(),
                               const Record& newdmInfo = Record());
 ...
 private:
  static void doCloneColumn(const Table& fromTable, const String& fromColumn, Table& toTable,
                            const ColumnDesc& newColumn, const String& dataManagerName,
