...
TableIterator::~TableIterator() { delete tabIterPtr_p; }
...
void TableIterator::next() { subTable_p = Table(tabIterPtr_p->next()); }

void TableIterator::copyState(const TableIterator& other) {
