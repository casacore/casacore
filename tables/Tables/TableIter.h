...
class TableIterator {
 public:
  ...
  TableIterator(const Table&, const Block<String>& columnNames, Order = Ascending,
                Option = ParSort);
...
inline void TableIterator::operator++() { next(); }

inline void TableIterator::operator++(int) { next(); }
