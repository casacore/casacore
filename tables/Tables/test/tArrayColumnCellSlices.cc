...
void readCellSlices() {
...

  {
    ...
    dataSlicer(0) =
        new Slicer(IPosition(2, 0, 0), IPosition(2, nCorrelations, nChannels), IPosition(2, 1));
    destinationSlicer(0) =
        new Slicer(IPosition(2, 0), IPosition(2, nCorrelations, nChannels), IPosition(2, 1));
...

  {
    ...
    dataSlicer(1) =
        new Slicer(IPosition(2, 0, n1), IPosition(2, nCorrelations, n2), IPosition(2, 1, 1));
    destinationSlicer(1) =
        new Slicer(IPosition(2, 0, n1), IPosition(2, nCorrelations, n2), IPosition(2, 1, 1));
...

  {
    ...
    destinationSlicer(0) =
        new Slicer(IPosition(2, 0, 0), IPosition(2, n1, nChannels), IPosition(2, 1, 1));

    dataSlicer(1) =
        new Slicer(IPosition(2, n1, 0), IPosition(2, n2, nChannels), IPosition(2, 1, 1));
    destinationSlicer(1) =
        new Slicer(IPosition(2, n1, 0), IPosition(2, n2, nChannels), IPosition(2, 1, 1));
...

  {
    ...
    dataSlicer(1) =
        new Slicer(IPosition(2, 0, 1), IPosition(2, nCorrelations, nChannels1), IPosition(2, 1, 2));
    destinationSlicer(1) =
        new Slicer(IPosition(2, 0, 1), IPosition(2, nCorrelations, nChannels1), IPosition(2, 1, 2));
...

  {
    ...
    dataSlicer(1) =
        new Slicer(IPosition(2, 1, 0), IPosition(2, nCorrelations1, nChannels), IPosition(2, 2, 1));
    destinationSlicer(1) =
        new Slicer(IPosition(2, 1, 0), IPosition(2, nCorrelations1, nChannels), IPosition(2, 2, 1));
