...
void a(const String& dir) {
  cout << ">>>" << endl;
  String formStr =
      readAsciiTable(dir + "tReadAsciiTable.in_tab", "", "tReadAsciiTable_tmp.data_tab");
  cout << "<<<" << endl;
...
void aa(const String& dir) {
  cout << ">>>" << endl;
  String formStr;
  Table tab = readAsciiTable(formStr, Table::Plain, dir + "tReadAsciiTable.in_tab", "",
...
void ab(const String& dir) {
  cout << ">>>" << endl;
  String formStr;
  Table tab = readAsciiTable(formStr, Table::Memory, dir + "tReadAsciiTable.in_tab", "", "");
...
void a2(const String& dir, const String& commentMarker, Int firstLine, Int lastLine) {
  ...
  types[6] = "A";
  String formStr =
      readAsciiTable(dir + "tReadAsciiTable.in_tah", "", "tReadAsciiTable_tmp.data_tah", names,
                     types, ' ', commentMarker, firstLine, lastLine);
  cout << "<<<" << endl;
  cout << "Input format: [" << formStr << ']' << endl;
  Table tab("tReadAsciiTable_tmp.data_tah");
  cout << endl;
...
void b(const String& dir, const String& suffix, Char separator, const String& commentMarker,
  ...
  String formStr =
      readAsciiTable(dir + "tReadAsciiTable.in_tkh" + suffix,
                     dir + "tReadAsciiTable.in_tkd" + suffix, "tReadAsciiTable_tmp",
                     "tReadAsciiTable_tmp.data_tk", separator, commentMarker, firstLine, lastLine);
  cout << "<<<" << endl;
  cout << "Input format: [" << formStr << ']' << endl;
  cout << endl;
