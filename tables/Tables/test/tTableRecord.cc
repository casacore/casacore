...
void doIt(Bool doExcp) {
  ...
  TableRecord record(rd, RecordInterface::Variable, nameCallBack, &extraArgument);
  ...
  AlwaysAssertExit(record.nfields() == rd.nfields() && record.nfields() == 22);
  ...
  *subref = 9.0;
  ...
  TableRecord& subrec1 = record.rwSubRecord(record.fieldNumber("SubRecord1"));
